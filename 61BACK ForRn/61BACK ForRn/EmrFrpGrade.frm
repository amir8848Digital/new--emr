...
Begin VB.Form EmrFrpGrade 
   ...
   Begin VB.Frame fra_nkeys 
      ...
      Begin TabDlg.SSTab TAB_REP 
         ...
         TabPicture(0)   =   "EmrFrpGrade.frx":0000
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "fra_tabrep(0)"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "&Group Sort"
         TabPicture(1)   =   "EmrFrpGrade.frx":001C
   ...
   End
End
Attribute VB_Name = "EmrFrpGrade"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Rep As New EmrRepGrade
...
'  GRP_REP.Add "Sub Ctg", "RmSCtg", "", "RmSCtg", "hRmSCtg", "", "", "", "(Select PDesc From Param Where PTyp= 'RMSCTG' and PMCd = RmCtg and PSCd= RmSCtg) "
    GRP_REP.Add "Grade RmCd", "GrRmCd", "", "GrRmCd", "hGrRmCd", "", "", "", "RmDesc"
    GRP_REP.Add "Grade Type", "GrTyp", "", "GrTyp", "hGrTyp", "", "", "", "(Select PDesc From Param Where PTyp= 'GRDTYP' and PMCd = GrTyp) "
    GRP_REP.Add "Grade RmCtg", "GrRmCtg", "", "GrRmCtg", "hGrRmCtg", "", "", "", "(Select PDesc from Param Where  PTyp = 'GrdRMCTG' And PmCD = GrTyp And PSCD = GrRmCtg) "
    GRP_REP.Add "Grade Code", "GrCd", "", "GrCd", "hGrCd", "", "", "", "(Select PDesc from Param Where  PTyp = 'GrdCd' And PmCD = GrTyp And PSCD = GrCd) "
    GRP_REP.Add "RmId", "GrRmId", "", "GrRmId", "hGrRmId", "", "", "", "(Select PDesc from Param Where  PTyp = 'RmId' And PmCD = GrRmCtg And PSCD = GrRmId) "
    GRP_REP.Add "Customer", "GrCmCd", "", "GrCmCd", "hGrCmCd", "", "", "", "(Select CmName from CustMst Where  CmCtg = 'C' And CmCD = GrCmCd) "
End Sub
...
'  GrTyp, GrCmCd, GrCD, GrRmCtg, GrRmId, GrRmCd, RmIntQly From Grade
'  Join RmMst Rm on RmCd = GrRmCd And RmZ = 'N' where 1= 2
'*** Report Sql ***
...
' Date:   20/01/2004
  wSqlStrg = "Select " + grpflds + ", " + _
             "GrTyp, GrCmCd, GrCD, GrRmCtg, GrRmId, GrRmCd, RmIntQly From Grade" + _
            " Join RmMst Rm on " + IIF(gs_Partition = ctCurrPrtn, " RmPrtKey='" + ctCurrPrtn + "' and ", "") + " RmCd = GrRmCd And RmZ = 'N' "
' ###########################################  Manoj  ###########################################

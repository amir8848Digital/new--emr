...
' **** Zubin 211 **** '
    ...
    'pg.11- additional amount fields added and invhd linked
    wSqlStrg = "Select TTc, Tyy, TChr, TNo, TDt, TFrRmLoc, TToRmLoc, TFrBLoc, TDesc, Td.TdSr, " + _
               "Td.TdBYy, Td.TdBChr, Td.TdBNo, DmCd, DmCtg, BOdTc, BOdYy, BOdChr, BOdNo, " + _
               "BOdSr, Td.TdBDc, Td.TdBQty, Td.TdPtQty, Td.TdBGrWt, " + _
               ...
               "IsNull(Rm.TdRmQty, 0) as TdRmQty, IsNull(Rm.TdRmWt, 0.0) as TdRmWt, " + _
               ...
               "IsNull(Rm.TdDesc, '') as qRmDesc, " + _
               "(Select LocTyp from Loc where LocCoCd ='" + adc("UoCoCdFr") + "' and " + _
    ...
    wJoinWhr = "From Txn Join Txnd Td on Td.TdTIdNo=TdTIdNo and Td.TdCoCd= TCoCd and Td.TdTc= TTc and Td.TdYy= TYy " + _
  ...
  Case "BV", "REJ"
    ...
    wSqlStrg = "Select TTc, TYy, TChr, TNo, TDt, TdSr, TdBYy, TdBChr, TdBNo, TDesc, DmCd, DmCtg, " + _
               ...
               "TdByWrk as qBagByWrk, " + _
               "InAmtDesc1, InAmtDesc2, InAmtDesc3, InAmtDesc4, InAmtDesc5, InAmtDesc6, InAmtDesc7 ,InAmtDesc8, InAmtDesc9, InAmtDesc10, " + _
               "InAmtDesc11, InAmtDesc12, InAmt1Per, InAmt2Per, InAmt3Per, InAmt4Per, InAmt5Per, InAmt6Per, InAmt8Per, InAmt9Per, InAmt10Per, InAmt11Per, " + _
               "InAmt1, InAmt2, InAmt3, InAmt4, InAmt5, InAmt6, InAmt7, InAmt8, InAmt9, InAmt10, InAmt11, InAmt12, InGstCd, InBaseAmt "
    wJoinWhr = "From Txn Join Txnd Td on Td.TdTIdNo=TIdNo and Td.TdCoCd= TCoCd and Td.TdTc= TTc and Td.TdYy= TYy " + _
               "and Td.TdChr= TChr and Td.TdNo= TNo and Td.TdSrNo= 0 " + IIF(gs_Partition = ctCurrPrtn, " and Td.TdPrtKey=TPrtKey ", "") + _
               "Join Bag on BIdNo=Td.TdBIdNo and BCoCd= Td.TdCoCd and BYy= Td.TdBYy and BChr= Td.TdBChr and " + _
               "BNo= Td.TdBNo " + IIF(gs_Partition = ctCurrPrtn, " and BPrtKey=Td.TdPrtKey ", "") + " Join DsgMst on  DmIdNo=BDmIdNo and DmTcTyp= BOdDmTcTyp and DmCd= BOdDmCd and DmSz='' " + IIF(gs_Partition = ctCurrPrtn, " and DmPrtKey=BPrtKey ", "") + _
               "Left Outer Join InvHd On InCoCd= TCoCd  and InTc=TTc and InYY=TYy  and InChr=TChr  and InNo=TNo " + _
  ...
  End If
  '*********Geeta************Emr207***
  'vk.3b-if user entered any Report heading in frp that will appear in report otherwise follows old behaviour
  If adc("UoRepHead") <> "" Then
    mRep.TxtHead.SetText adc("UoRepHead")
  Else
    'vk.3b-Report heading change for Purchase and sales was done in dsr, now that is disabled and writtern here
    Dim wHeading As String
    wHeading = IIF(adc("UoTTcFr") = "PR", "Purchase", "Sales") + " Voucher Printing"
    mRep.TxtHead.SetText IIF(adc("UoTTcFr") = "PR" Or adc("UoTTcFr") = "SA", wHeading, ws_FrmCaption)    '****** Sachin 2.14.0
  End If
...
'  GRP_REP.SetFormula mRep, "wRmSz", "If {rdo.qRmSzDesc} <> '' Then {rdo.qRmSzDesc} "
  ...
  GRP_REP.SetFormula mRep, "wRmCdFontSz", GetRmcdFontSz("{rdo.TdRmCd}", 7)

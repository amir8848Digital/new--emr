...
Begin VB.Form EmrFrpDtTbl 
   ...
   Begin VB.Frame fra_nkeys 
      ...
      Begin TabDlg.SSTab TAB_REP 
         ...
         TabPicture(0)   =   "EmrFrpDtTbl.frx":0000
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "fra_tabrep(0)"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "&Group Sort"
         TabPicture(1)   =   "EmrFrpDtTbl.frx":001C
         ...
         Begin VB.Frame fra_tabrep 
            ...
            Begin MwfCtl.MWCTL_MED atxt 
               ...
               Left            =   4320
               TabIndex        =   2
               ToolTipText     =   "Enter Date Tag Selection"
               Top             =   990
               Width           =   7950
               _ExtentX        =   14023
               _ExtentY        =   503
            ...
            Begin MwfCtl.MWCTL_MED atxt 
               ...
               Left            =   1275
               TabIndex        =   0
               ToolTipText     =   "Enter From Date Tag"
               Top             =   990
               Width           =   1305
               _ExtentX        =   2302
               _ExtentY        =   503
   ...
   End
End
Attribute VB_Name = "EmrFrpDtTbl"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Rep As New EmrRepDtTbl
...
On Error GoTo RepErr
  ...
  'DtTag, DtDt, DtVal, DtCurCd1, DtCurCd2 From DtTbl where 1= 2
  '*** Report Sql ***
  ...
  'IG.183 -Day & Description of the day fields are added
  '53 DtCoCd added
  wSqlStrg = "Select " + grpflds + ", " + _
             "DtTag, DtDt, DtVal, DtCurCd1, DtCurCd2, DtDay, DtDesc, DtCoCd From DtTbl " + wCnd

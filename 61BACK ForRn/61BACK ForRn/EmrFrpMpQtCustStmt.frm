...
Begin VB.Form EmrFrpMpQtCustStmt 
   ...
   Begin VB.Frame fra_nkeys 
      ...
      Begin TabDlg.SSTab TAB_REP 
         ...
         TabPicture(0)   =   "EmrFrpMpQtCustStmt.frx":0000
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "fra_tabrep(0)"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "&Group&Sort"
         TabPicture(1)   =   "EmrFrpMpQtCustStmt.frx":001C
   ...
   End
End
Attribute VB_Name = "EmrFrpMpQtCustStmt"
...
' **** Zubin 211 **** '
      ...
      wCommStr = "Select InCoCd, InYy, InTc, InChr, InNo, max(InCmCd) as InCmCd, max(a.CmName) as InvCmName, " + _
               ...
               "max(IdVaCtg) as IdVaCtg," + qRmCtgDesc + "," + qDmCtgDesc + "," + qDmSalCtgDesc + "," + qDmColDesc + "," + qVaCtgDesc + "," + _

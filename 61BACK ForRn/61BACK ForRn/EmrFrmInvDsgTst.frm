...
Begin VB.Form EmrFrmInvDsgTst 
   ...
   Begin VB.Frame FRA_NKEYS 
      ...
      Begin VB.Frame FraNKeyAll 
         ...
         Begin MwfCtl.MWCTL_FLX GrdID 
            ...
            datatype12      =   2
            mask12          =   "########0.00"
            recalcon12      =   $"EmrFrmInvDsgTst.frx":0000
            ...
            datatype13      =   2
            mask13          =   "########0.00"
            recalcon13      =   $"EmrFrmInvDsgTst.frx":00A5
         ...
         Begin MwfCtl.MWCTL_FLX GrdIR 
            ...
            datafld2        =   "IrRmCd"
            datatype2       =   4
            recalcparent2   =   $"EmrFrmInvDsgTst.frx":016C
            maxlength2      =   16
   ...
   End
End
Attribute VB_Name = "EmrFrmInvDsgTst"
...
'  ReDim mArr_Cv(7), mArr_Ed(7)
  ...
  ReDim mArr_Cv(12), mArr_Ed(12)      ' ***** Manali 3.6.0 - 29/10/09 - Refresh Metal Rate
' Manoj 2.10.0
  ...
  'Tst eInv added
  Case Is = UCase("InDsg"), UCase("eInv")
...
''          End If
    ...
    Case Is = UCase("IdILabAsWt") '****** Sachin 2.13.0 - 26-05-2006 ******
      ...
      For i = 1 To GrdIL.Rows - 1
      ' ******** Manali - 18/05/09 - "DHC" and "CHC" excluded
        If Not (GrdIL.Value(i, "iLMCd") = ctDHCLMCd Or GrdIL.Value(i, "iLMCd") = ctGHCLMCd Or GrdIL.Value(i, "iLMCd") = ctCHCLMCd Or GrdIL.Value(i, "iLMCd") = ctCDWLMCd) And Not GrdIL.IsDel(i) Then
...
'          Dim wLaborSubLogic As String
    ...
    Case Is = UCase("IdZLabAsWt") '****** Sachin 2.13.0 - 26-05-2006 ******
      ...
      For i = 1 To GrdIL.Rows - 1
      ' ******** Manali - 18/05/09 - "DHC" and "CHC" excluded
        If Not (GrdIL.Value(i, "iLMCd") = ctDHCLMCd Or GrdIL.Value(i, "iLMCd") = ctGHCLMCd Or GrdIL.Value(i, "iLMCd") = ctCHCLMCd Or GrdIL.Value(i, "iLMCd") = ctCDWLMCd) And Not GrdIL.IsDel(i) And GrdIL.Value(i, "ilQw") = "W" Then
          If UCase(ms_IdTcTyp) = UCase(ctInTcTyp) Then
            ' **** Manali 3.03 - 05/07/08 - Om Lk Up fields passed if not blank
...
'  'tst end
  With GrdIR
    ...
    Case Is = UCase("IrRmIRt")
      ...
      .Value(RowNum, "IrRmIRt") = .Value(RowNum, "IrRmIRt") 'tst new line
'      'tst start
...
'        'tst end
    ...
    Case Is = UCase("IrSetAVal")    '*** recalc on IrSetSCd, IrSetARt, IrRmQty
      ...
      .Value(RowNum, "IrSetAVal") = .Value(RowNum, "IrSetAVal")   'tst new line
         'tst start
    ...
    Case Is = UCase("IrSetIRt")
      If (.Mode = fgmnorm Or .Mode = fgmCopy) And (UCase(ms_IdTcTyp) = UCase(ctCTBTcTyp)) Then
        ...
        '*** (Jen 2.13)
.Value(RowNum, "IrSetIRt") = .Value(RowNum, "IrSetIRt") 'tst new line
        'tst start
    ...
    Case Is = UCase("IrSetIVal")    '*** recalc on IrSetSCd, IrSetIRt, IrRmQty
      ' **** Manali 3.03 - 05/07/08 - Om Lk Up fields passed if not blank
      If .Mode = fgmnorm Or .Mode = fgmCopy Then _
      .Value(RowNum, "IrSetIVal") = .Value(RowNum, "IrSetIVal")   'tst new line
         'tst start
    ...
    Case Is = UCase("IrSetZVal")    '*** recalc on IrSetSCd, IrSetZRt, IrRmQty
      If .Mode = fgmnorm Or .Mode = fgmCopy Then
        If UCase(ms_IdTcTyp) = UCase(ctInTcTyp) Then
          ' **** Manali 3.03 - 05/07/08 - Om Lk Up fields passed if not blank
.Value(RowNum, "IrSetZVal") = .Value(RowNum, "IrSetZVal")   'tst new line
          'tst start
    ...
    Case Is = UCase("IrRmZPureRt")    '*** recalc on IrRmCd,IrRmZRt,IrRmZVal
      'If (.Mode = fgmnorm Or .Mode = fgmCopy) And UCase(ms_IdTcTyp) = UCase(ctInTcTyp) Then
      If (.Mode = fgmnorm Or .Mode = fgmCopy) And UCase(ms_IdTcTyp) = UCase(ctInTcTyp) Then
      .Value(RowNum, "IrRmZPureRt") = .Value(RowNum, "IrRmZPureRt")   'tst new line
'      'tst start
'        '****** Sachin 3.02 - Current Partition
...
'  End If
  ...
  With GrdIL
    ...
    Case Is = UCase("iLAVal")     '*** recalc of iLAVal on iLMCd,iLSCd,iLARt,iLQw,iLQty
      ...
      If .Mode = fgmnorm Or .Mode = fgmCopy Then
      .Value(RowNum, "iLAVal") = .Value(RowNum, "iLAVal") 'tst new line
      'tst start
    ...
    Case Is = UCase("iLiRt")
      ...
      If (UCase(ms_IdTcTyp) = UCase(ctCTBTcTyp)) Then
        If (.Mode = fgmnorm Or .Mode = fgmCopy) And UCase(SourceName) = UCase("GrdIL") Then
          .Value(RowNum, "iLiRt") = .Value(RowNum, "iLiRt")   'tst new line
          'tst start
...
'tst end
    ...
    Case Is = UCase("iLiVal")     '*** recalc of iLiVal on iLMCd,iLSCd,iLiRt,iLQw,iLQty
      ...
      If .Mode = fgmnorm Or .Mode = fgmCopy Then
      .Value(RowNum, "iLiVal") = .Value(RowNum, "iLiVal") 'tst new line
...
'
'
''           .Value(RowNum, "iLiVal") = .Value(RowNum, "iLiRt") * GetDCRmVal("IrRmIWt", , ctCDWLMCd)
'
'        Else
'          .Value(RowNum, "iLiVal") = GetLabVal(wCmCd, .Value(RowNum, "ilMCd"), _
'                                     .Value(RowNum, "ilSCd"), .Value(RowNum, "iLiRt"), _
    ...
    Case Is = UCase("iLZRt")
      ...
      Else
        If UCase(SourceName) = UCase("GrdIL") Then
          If .Mode = fgmnorm Or .Mode = fgmCopy Then
          .Value(RowNum, "iLZRt") = .Value(RowNum, "iLZRt") 'tst  new line
          'tst start
...
'tst end
    ...
    Case Is = UCase("iLZVal")     '*** recalc of iLiVal on iLMCd,iLSCd,iLZRt,iLQw,iLQty
      ...
      .Value(RowNum, "iLZVal") = .Value(RowNum, "iLZVal") 'tst new line
      'tst start
'        If .Value(RowNum, "ilMCd") = ctAddLMCd Then
...
'                                     GrdID.Value(GrdID.Row, "IdQty")
'
''            .Value(RowNum, "iLZVal") = .Value(RowNum, "iLZRt") * GetDCRmVal("IrRmZWt", , ctCDWLMCd)
'          End If
'
'        Else
'          If .Mode = fgmnorm Or .Mode = fgmCopy Then
...
'        ' ***** Manali 3.03 - 05/07/08
  ...
  ElseIf UCase(ms_IdTcTyp) = UCase(ctCTBTcTyp) Then
    ...
    wStr = "Select (case when max(isnull(qOrRmCd, ''))= '' then '' else 'Y' end) as qOrRmExists, " + _
           ...
           " and OrChr= '" + GrdID.Value(GrdID.Row, "IdExpOdChr") + "' and OrNo = " + CStr(GrdID.Value(GrdID.Row, "IdExpOdNo")) + _
           " and OrSr= " + CStr(GrdID.Value(GrdID.Row, "IdExpOdSr")) + " and OrPrtKey='" + ctCurrPrtn + "' group by " + _
           "OrRmCd, " + ws_OrLn + " ,OrSetSCd, OrSetSalRt) Or2 On qOrRmCd= FrRmCd and qOrln1= FrRmSz /*and qOrln2 =FrRmSz2 and qOrLn3 = FrRmSz3 */ " + _
           " Join RmMst on FrRmCd= RmCd and FrPrtKey=RmPrtKey " + _
           "where IfCoCd = '" + gs_CoCd + "' and IfTc= '" + ADC("wIdTc") + "' " + _
           "and IfYy= '" + ADC("wIdYy") + "' and IfChr= '" + ADC("wIdChr") + "' and " + _
           "IfNo = " + CStr(ADC("wIdNo")) + " and IfSr = " + CStr(GrdID.Value(GrdID.Row, "IdSr")) + " and IfPrtKey='" + ctCurrPrtn + "' " + _
...
'          .Value(wRmRow, "IrRmIRt") = IIF(ms_RtFrInvCust = "Y", _
          ...
          '*** (Jen 2.13) Remove 'Local Inv' Check
'          'tst start
'           If mIGldRtEqOrd = "M" Then
'            Dim wf_BaseLmeOrd As Double
'            Dim wf_baselmeinv As Double
'                     wf_BaseLmeOrd = moCn.GetFldVal("Select (case '" + "G" + "' when 'G' then OmLmgSal " + _
'                          "when 'P' then OmLmpSal when 'S' then OmLmsSal when 'L' then OmLmlSal else 0 end) from OrdMst where " + _
'                          "OmCoCd= '" + gs_CoCd + "' and OmTc= '" + GrdID.Value(GrdID.Row, "IdExpOdTc") + "' " + _
'                          "and OmYy= '" + GrdID.Value(GrdID.Row, "IdExpOdYy") + "' " + _
'                          "and OmChr= '" + GrdID.Value(GrdID.Row, "IdExpOdChr") + "' " + _
...
'
'          ' **** Manali 3.03 - 21/06/08 - Pd Mod - 'L' included
'                    wf_baselmeinv = moCn.GetFldVal("Select (case '" + "G" + "' when 'G' then " + CStr(ADC("wIdLmgSal")) + " " + _
'                          "when 'P' then " + CStr(ADC("wIdLmpSal")) + " when 'S' then " + CStr(ADC("wIdLmsSal")) + " " + _
'                          "when 'L' then " + CStr(ADC("wIdLmlSal")) + " else 0 end) ")
'
'
'              Dim wIrRmRt As Double
'              If (wf_BaseLmeOrd > wf_baselmeinv) Then
''                        .Value(wRmRow, "IrRmIRt") = IIF(ms_RtFrInvCust = "Y", _
'                                        GetGldRt(ADC("wIdCmCd"), wf_BaseLmeOrd, _
'                                            wRsRmDet!qirrmcd, .Value(wRmRow, "IrAlySalRt"), "DM", GrdID.Value(GrdID.Row, "IdDmCd"), "S", "C", , ADC("wIdCmCurCd"), "", ""), _
...
'
'
'              .Value(wRmRow, "IrRmIRt") = IIF(wIrRmRt < .Value(wRmRow, "IrRmIRt"), wRsRmDet!qIrRmIRt, wIrRmRt)
'              .Value(wRmRow, "IrRmZRt") = .Value(wRmRow, "IrRmIRt")
'            End If
'           End If
'            'tst end
...
'         '   Dim wf_BaseLmeOrd As Double
'         '   Dim wf_baselmeinv As Double
'                     wf_BaseLmeOrd = moCn.GetFldVal("Select (case '" + "P" + "' when 'G' then OmLmgSal " + _
'                          "when 'P' then OmLmpSal when 'S' then OmLmsSal when 'L' then OmLmlSal else 0 end) from OrdMst where " + _
'                          "OmCoCd= '" + gs_CoCd + "' and OmTc= '" + GrdID.Value(GrdID.Row, "IdExpOdTc") + "' " + _
'                          "and OmYy= '" + GrdID.Value(GrdID.Row, "IdExpOdYy") + "' " + _
'                          "and OmChr= '" + GrdID.Value(GrdID.Row, "IdExpOdChr") + "' " + _
...
'
'          ' **** Manali 3.03 - 21/06/08 - Pd Mod - 'L' included
'                    wf_baselmeinv = moCn.GetFldVal("Select (case '" + "P" + "' when 'G' then " + CStr(ADC("wIdLmgSal")) + " " + _
'                          "when 'P' then " + CStr(ADC("wIdLmpSal")) + " when 'S' then " + CStr(ADC("wIdLmsSal")) + " " + _
'                          "when 'L' then " + CStr(ADC("wIdLmlSal")) + " else 0 end) ")
'
'
...
'        '    Dim wf_BaseLmeOrd As Double
'        '    Dim wf_baselmeinv As Double
'                     wf_BaseLmeOrd = moCn.GetFldVal("Select (case '" + "S" + "' when 'G' then OmLmgSal " + _
'                          "when 'P' then OmLmpSal when 'S' then OmLmsSal when 'L' then OmLmlSal else 0 end) from OrdMst where " + _
'                          "OmCoCd= '" + gs_CoCd + "' and OmTc= '" + GrdID.Value(GrdID.Row, "IdExpOdTc") + "' " + _
'                          "and OmYy= '" + GrdID.Value(GrdID.Row, "IdExpOdYy") + "' " + _
'                          "and OmChr= '" + GrdID.Value(GrdID.Row, "IdExpOdChr") + "' " + _
...
'
'          ' **** Manali 3.03 - 21/06/08 - Pd Mod - 'L' included
'                    wf_baselmeinv = moCn.GetFldVal("Select (case '" + "S" + "' when 'G' then " + CStr(ADC("wIdLmgSal")) + " " + _
'                          "when 'P' then " + CStr(ADC("wIdLmpSal")) + " when 'S' then " + CStr(ADC("wIdLmsSal")) + " " + _
'                          "when 'L' then " + CStr(ADC("wIdLmlSal")) + " else 0 end) ")
'
'
...
'           ' Dim wf_BaseLmeOrd As Double
'            'Dim wf_baselmeinv As Double
'                     wf_BaseLmeOrd = moCn.GetFldVal("Select (case '" + "L" + "' when 'G' then OmLmgSal " + _
'                          "when 'P' then OmLmpSal when 'S' then OmLmsSal when 'L' then OmLmlSal else 0 end) from OrdMst where " + _
'                          "OmCoCd= '" + gs_CoCd + "' and OmTc= '" + GrdID.Value(GrdID.Row, "IdExpOdTc") + "' " + _
'                          "and OmYy= '" + GrdID.Value(GrdID.Row, "IdExpOdYy") + "' " + _
'                          "and OmChr= '" + GrdID.Value(GrdID.Row, "IdExpOdChr") + "' " + _
...
'
'          ' **** Manali 3.03 - 21/06/08 - Pd Mod - 'L' included
'                    wf_baselmeinv = moCn.GetFldVal("Select (case '" + "L" + "' when 'G' then " + CStr(ADC("wIdLmgSal")) + " " + _
'                          "when 'P' then " + CStr(ADC("wIdLmpSal")) + " when 'S' then " + CStr(ADC("wIdLmsSal")) + " " + _
'                          "when 'L' then " + CStr(ADC("wIdLmlSal")) + " else 0 end) ")
'
'
...
'          ', wf_BaseLmeOrd As Single, wf_baselmeinv As Single
'          '****** Sachin 3.02 31-12-07 - PrtKey added
'          ws_BaseRmCtg = moCn.GetFldVal("Select B.RmCtg from RmMst B where " + _
...
'             wb_IsCustRmCd = IIF(moCn.GetFldVal("Select RmCmCd from RmMst where RmCd='" + wRsRmDet!qirrmcd + "'") <> "", True, False)
'
...
'        'tst end
      ...
      'sri
      'tst start
'      If mf_AddBrkMsgYN Then
'      'gs_CoCd = "IG" Or gs_CoCd = "MW" Then
'             Dim wAddBMWtToZWtBMWt As Double
'             Dim wAddBMToZWtGrdRow As Integer
'             wAddBMToZWtGrdRow = 1
'              Dim wAddBMToZWtAlrPrcsd As String
'              Dim wAddBMToZWtCurRowVal As String
'              Dim wCnd As String
'              wAddBMToZWtGrdRow = wRmRow
'          '  For wAddBMToZWtGrdRow = 1 To GrdIR.Rows
'              wAddBMToZWtCurRowVal = "||" + .Value(wAddBMToZWtGrdRow, "IrRmCd") + ",," + _
'                                     CStr(.Value(wAddBMToZWtGrdRow, "IrLotNo")) + ",," + _
'                                     CStr(.Value(wAddBMToZWtGrdRow, "IrRmSz")) + ",," + _
'                                     CStr(.Value(wAddBMToZWtGrdRow, "IrRmSz2")) + ",," + _
'                                     CStr(.Value(wAddBMToZWtGrdRow, "IrRmSz3")) + ",," + _
'                                     CStr(.Value(wAddBMToZWtGrdRow, "IrStkRt")) + "||"
'
'              wCnd = " and '" + .Value(wAddBMToZWtGrdRow, "IrRmCd") + "' = TdRmCd and '" + _
'                         .Value(wAddBMToZWtGrdRow, "IrLotNo") + "'= TdLotNo and " + _
'                         CStr(.Value(wAddBMToZWtGrdRow, "IrRmSz")) + "=TdRmSz and " + _
'                         CStr(.Value(wAddBMToZWtGrdRow, "IrRmSz2")) + "=TdRmSz2 and " + _
'                         CStr(.Value(wAddBMToZWtGrdRow, "IrRmSz3")) + "=TdRmSz3 and " + _
'                         CStr(.Value(wAddBMToZWtGrdRow, "IrStkRt")) + "=TdRmStkRt  "
'              wCnd = wCnd + " and IfCoCd = '" + gs_CoCd + "' and IfTc= '" + ADC("wIdTc") + "' " + _
'                 "and IfYy= '" + ADC("wIdYy") + "' and IfChr= '" + ADC("wIdChr") + "' and " + _
'                 "IfNo = " + CStr(ADC("wIdNo")) + " and IfSr = " + CStr(GrdID.Value(GrdID.Row, "IdSr"))
'
'              If InStr(1, wAddBMToZWtAlrPrcsd, wAddBMToZWtCurRowVal) = 0 Then
'                wAddBMWtToZWtBMWt = moCn.GetFldVal("Select sum(TdRmWt * case " + _
'                " ((case when TdFrRmLocTyp in ('B','M') then TdFrRmDc when TdToRmLocTyp in ('B','M') " + _
'                " then TdToRmDc else '' end)) when 'D' then 1 when 'C' then -1 else 0 end) " + _
'                " from InvFgd join Txnd on InvFgd.IfFdBYy = TdBYy and IfFdBChr = TdBChr and " + _
'                " IfFdBNo = TdBNo and IfCoCd = TdCoCd and (TdToRmLocTyp = 'B' or TdToRmLocTyp = 'M' " + _
'                " or TdFrRmLocTyp='M' or TdFrRmLocTyp = 'B')" + wCnd)
'                .Value(wAddBMToZWtGrdRow, "IrRmZWt") = .Value(wAddBMToZWtGrdRow, "IrRmZWt") + wAddBMWtToZWtBMWt
'                wAddBMWtToZWtTotBMWt = wAddBMWtToZWtTotBMWt + wAddBMWtToZWtBMWt
'                wAddBMToZWtAlrPrcsd = wAddBMToZWtAlrPrcsd + wAddBMToZWtCurRowVal
'              End If
'      'Next wAddBMToZWtGrdRow
'      End If
'tst end
  ...
  ''tst start
'  If mf_AddBrkMsgYN Then
'  'gs_CoCd = "IG" Or gs_CoCd = "MW"
'    For wAddBMToZWtGrdRow = 1 To GrdIR.Rows
'        If GrdIR.Value(wAddBMToZWtGrdRow, "IrMainMet") = "Y" Then
'            wAddBMWtToZWtTotBMWt = wAddBMWtToZWtTotBMWt / 5
'            If GrdIR.Value(wAddBMToZWtGrdRow, "IrRmZWt") >= wAddBMWtToZWtTotBMWt Then
'              GrdIR.Value(wAddBMToZWtGrdRow, "IrRmZWt") = GrdIR.Value(wAddBMToZWtGrdRow, "IrRmZWt") - wAddBMWtToZWtTotBMWt
'            End If
'          Exit For
'        End If
'    Next wAddBMToZWtGrdRow
    ...
    Do While Not (wRsSrcLab.EOF Or wRsSrcLab.BOF)
      ...
      If UCase(ms_IdTcTyp) = UCase(ctInTcTyp) Then
        ...
        '.Value(wLabRow, "iLiRt") = IIF(ms_LabRtfrRtChrt = "Y", _
                                    ...
                                    wRsSrcLab!qLabiRt)
        .Value(wLabRow, "iLiRt") = wRsSrcLab!qLabiRt
...
Private Sub DispFra(ByVal pv_InvDsgFra As en_InvDsgFraTst)
...
' Manoj 2.10.0
  ...
  End Select
End Sub
Private Sub EnaDisaCmds(ByVal pv_ShowFra As Boolean, Optional ByVal pv_CmdBut As MWCTL_BTN1, Optional ByVal pv_InvDsgFra As en_InvDsgFraTst)

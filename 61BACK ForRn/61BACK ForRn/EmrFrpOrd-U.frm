...
'                  "'{' + Max(OrRmCd) + '}') as OrRmCd"
    ...
    wTblStr = "Select OmCoCd, OmYy, OmTc, OmChr, OmNo,OmCmCd,OmDt, OmPONo,OmPoDt,OmLmgCst,OmLmgSal,OmLmpSal,OmLmsSal,OmLmlSal,OmDelDt,OdDelDt," + _
              ...
              " OdDmCd,Space(40) as CdOurDmCd,OdDmSz,OdSfx,OdDmStkCoCd,OdDmStkYy, OdDmStkChr, OdDmStkNo,DmCtg,DmSalCtg,DmTcTyp,OdDmCol, 0 as OdTrayNo,OdPicNm,OdPoNo,OdKt as IdKt,DmUom, OdVaCtg as IdVaCtg," + _
              ...
              " CmLkUpMetLs,DsgMst.DmLsCtg,OdMulby,CmName, OdOmCmCd, DmWaxWt,Space(4) as qTag,OrMainMet,0 as qMainMet,Space(1) as qPtrYN,  OrSrNo, OrRmCtg as RmCtg,OrRmSCtg,Space(14) as OrRmCd ,RmDesc, RmQw,OrLn1,OrLn2,OrLn3,OrRmPtr  , " + _
      ...
      wCommStr = "Select /* row_Number() over(Partition By OmIdNo Order By OmCoCd,OmTc,OmYy,OmChr,OmNo" + wExcelOrdBy + ",OdSr) as qRow,*/ OmCoCd, OmYy, OmTc, OmChr, OmNo, max(OmCmCd) as OmCmCd, max(OmDt) as OmDt, MAX(OmPONo) as OmPONo, max(OmPoDt) as OmPoDt, " + _
                 ...
                 "max(DsgMst.DmCtg) as DmCtg, max(DsgMst.DmSalCtg) as DmSalCtg, max(DsgMst.DmTcTyp) as DmTcTyp, max(OdDmCol) as OdDmCol, 0 as OdTrayNo, Max(OdPicNm) as OdPicNm, Max(OdPoNo) as OdPoNo, " + _
  ...
  '    OdDmPrdInst, OdCmPrdInst, OdCmStmpInst, OdSalRem, OdSzInst, OmSalRem, OmCmDelTerms, OmCmPayTerms,
      ...
      wCommStr = wCommStr + " max(Replace(OdDmPrdInst,char(13)+ char(10),' ')) as OdDmPrdInst, " + _
                            ...
                            " ' ' AS qOdOmPoNo, max(Case When OmLkUpMetLs <> '' Then OmLkUpMetLs Else CmLkUpMetLs End) as CmLkUpMetLs, max(DsgMst.DmLsCtg) as DmLsCtg, max(OdMulby) as OdMulby, max(CmName) as CmName, max(OdOmCmCd) as OdOmCmCd, " + _
  ...
  '   *********************************
    ...
    'Manoj 2.10.0
      ...
      Case Is = UCase("N") 'OrRmCtg to get RmVal and RmSetVal, No dets r shown
        ' ***** Manali 3.03 - 28/06/08 - OrLmeSal added
        wRmStr = " 0 as OrSrNo, OrRmCtg as RmCtg, '*' as OrRmSCtg, '*' as OrRmCd, " + wRmDesc + " '*' as RmQw, 0 as OrLn1, " + _
      ...
      Case Is = UCase("Sr")
       '*************************** ZUBIN **************************
        ...
        ' Zubin 213 (BaseCur added)
        ' ***** Manali 3.03 - 28/06/08 - OrLmeSal added
        wRmStr = " OrSrNo, max(OrRmCtg) as RmCtg, max(OrRmSCtg) as OrRmSCtg, " + wOurRmCd + IIF(Trim(wOurRmCd) <> "", ", ", "") + wRmDesc + _
  ...
  '     URmi 2.04-3 Change is  wRtStr has been used to calculate the rates
      ...
      Case Is = UCase("RmSCtg")
        ' ***** Manali 3.03 - 28/06/08 - OrLmeSal added
        wRmStr = " 0 as OrSrNo, OrRmCtg as RmCtg, OrRmSCtg, '*' as OrRmCd, " + wRmDesc + " '*' As RmQw, 0 as OrLn1, 0 as OrLn2, 0 as OrLn3, 0 as OrRmPtr, " + _
      ...
      Case Is = UCase("RmCtg")
        ' ***** Manali 3.03 - 28/06/08 - OrLmeSal added
        wRmStr = " 0 as OrSrNo, OrRmCtg as RmCtg, '*' as OrRmSCtg, '*' as OrRmCd, " + wRmDesc + " '*' As RmQw, 0 as OrLn1, 0 as OrLn2, 0 as OrLn3, 0 as OrRmPtr, " + _
                "sum(" + ws_RmQty + ") as OrQty, sum(" + ws_RmWt + ") as OrWt, 0.00 as OrLmeSal, 0.00 as OrSalRt, '*' as OrSetSCd, 0.00 as OrSetSalRt, " + wRmSetValOpt + ", " + wRmValOpt + " as OrSalVal, '' as RmRSzRt, 0.00 as OrAlySalRt, "
        wRmGrp = " group by OmCoCd, OmYy, OmTc, OmChr, OmNo, OdSr, OrRmCtg "
...
'        wRmStr = " 0 as OrSrNo, OrRmCtg as RmCtg, OrRmSCtg, " + wOurRmCd + IIF(Trim(wOurRmCd) <> "", ", ", "") + wRmDesc + _
  ...
  '     ??wRmGrp = " group by OmYy, OmTc, OmChr, OmNo, OdSr, OrRmCtg, OrRmSCtg, OrRMCd, RrRngSz, OrSalRt, (OrSetSCd, OrSetSalRt)?????"
      ...
      Case Is = UCase("RmSCtgRt")
        wRmStr = " 0 as OrSrNo, OrRmCtg as RmCtg, OrRmSCtg, '*' as OrRmCd, " + wRmDesc + " max(RmQw) As RmQw, 0 as OrLn1, 0 as OrLn2, 0 as OrLn3, 0 as OrRmPtr, " + _
                 "sum(" + ws_RmQty + ") as   OrQty, sum(" + ws_RmWt + ") as OrWt, " + _
                 IIF(wb_InBaseCur, " (Case when max(OmMulDiv)= 'M' then OrLmeSal/max(OmCnvFct) else OrLmeSal*max(OmCnvFct) end) ", "OrLmeSal") + " as OrLmeSal, " + _
                 IIF(wb_InBaseCur, " (Case when max(OmMulDiv)= 'M' then OrSalRt/max(OmCnvFct) else OrSalRt*max(OmCnvFct) end) ", "OrSalRt") + " as OrSalRt, " + _

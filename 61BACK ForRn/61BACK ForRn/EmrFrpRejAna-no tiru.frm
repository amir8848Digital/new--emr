...
Private Sub SetGroupSort()
  GRP_REP.Add "Process", "TdCoCd+TdByLoc", "'['+TdCoCd+'] '+TdByLoc", "TdByLoc", "hTdByLoc", "Company Code,Loc Prnt Code", "", "", "(Select LocDesc From Loc Where LocCoCd = TdCoCd and LocTyp= 'P' and LocCd= TdByLoc) "
  GRP_REP.Add "(Process)Worker", "TdCoCd+TdByLoc+TdByWrk", "'('+TdCoCd+'/'+ RTrim(TdByLoc)+ ') '+ TdByWrk", "TdByLoc,TdByWrk", "hTdByLoc,hTdByWrk", "Company Code,Process", "", "", "(Select vPDesc From vParam Where vPCoCd = TdCoCd and vPTyp= 'WORK' and vPMCd= TdByWrk) "
  ...
  GRP_REP.Add "Design Code", "BOdDmCd", "", "BOdDmCd", "hBOdDmCd", "Design Ctg,Prd Ctg,(DsgCd)Colour", "", "", "(Select Substring(DmDesc,1,120) From DsgMst Where " + IIF(gs_Partition = ctCurrPrtn, " DmPrtKey='" + ctCurrPrtn + "' and ", "") + " DmTcTyp= 'DM' and DmCd= BOdDmCd and DmSz= '') "
  ...
  '*** Jay 3.2.0 [OdPoNo]
  GRP_REP.Add "Cust Sub PO", "OmCmCd+OmPONo+OdPoNo", "'('+ OmCmCd+ ') '+ LTrim(OmPONo)", "OmCmCd,OmPoNo,OdPoNo", "hOmCmCd,hOmPONo,hOdPONo", "Company Code,Customer PO", "", "", "BOdTc+'/'+BOdYy+'/'+BOdChr+'/'+LTrim(Str(BOdNo))+'/'+LTrim(Str(BOdSr))+(case when OdPONo<> '' then ' - '+ LTrim(OdPONo) else '' end )"
  '*** Jay 3.2.0 [OdPoNo]
  '### Check This Grouping
...
'*** Jay 2.13(CT) ***
  ...
  ws_TmpTblA = "Set dateformat DMY Select " + grpflds + ", " + _
             "'D' as qTag, TdCoCd, TdTc, TdYy, TdChr, TdNo, TdSr, TdBYy, TdBChr, TdBNo, " + _
             ws_RjQtyWt + " as qRjQty, " + ws_RjPtQty + " as qRjPtQty, " + ws_PrdQty + " as qPrdQty, " + _
             ws_PrdPtQty + " as qPrdPtQty, " + _
             "(Case when TdRjDc = 'D' then 1 when TdRjDc = 'C' then -1 else 0 end) as qMul, " + _
             "TdRjCd as qRjCd, TdByWrk, LocPrntCd, TdByLoc, TDt, DmCtg, DmPrdCtg, BOdDmCd, OdKt, " + _
             "BOdTc, BOdYy, BOdChr, BOdNo, OmCmCd, OmPoNo " + _
  ...
  wSqlStrg1 = "Set dateformat DMY Select * from #TMPA "
  '*** (Jen 2.13)
  ...
  wSqlStrg2 = " Select Grp1, Grp2, Grp3, DGrp1, DGrp2, DGrp3, G1Desc, G2Desc, G3Desc, " + _
              ...
              ws_RjQtyWt + " as qRjQty, " + ws_RjPtQty + " as qRjPtQty, " + ws_PrdQty + " as qPrdQty, " + _
              ws_PrdPtQty + " as qPrdPtQty, TdByWrk, IsNull(Lc.LocPrntCd, '') as LocPrntCd, TdByLoc, TDt, DmCtg, DmPrdCtg, BOdDmCd, OdKt, " + _
              "BOdTc, BOdYy, BOdChr, BOdNo, OmCmCd, OmPoNo " + _

   ...
   Begin VB.Frame FRA_NKEYS 
      ...
      Begin VB.Frame FraNKeyAll 
         ...
         Begin MwfCtl.MWCTL_FLX GrdID 
            ...
            datatype12      =   2
            mask12          =   "########0.00"
            recalcon12      =   $"EmrFrmInvDsg.frx":0000
            ...
            datatype13      =   2
            mask13          =   "########0.00"
            recalcon13      =   $"EmrFrmInvDsg.frx":00A5
         ...
         Begin MwfCtl.MWCTL_FLX GrdIR 
            ...
            datafld2        =   "IrRmCd"
            datatype2       =   4
            recalcparent2   =   $"EmrFrmInvDsg.frx":016C
            maxlength2      =   12
            ...
            mask5           =   "#######0.00"
            maxlength5      =   11
            tooltiptext5    =   "Enter Raw Material StockRate"
            colname6        =   "WQWSAL"
            heading6        =   "Q/W"
            datatype6       =   4
            recalcon6       =   "GrdIR(IRRMCD)"
            maxlength6      =   1
            style6          =   2
            colname7        =   "IRRMQTY"
            heading7        =   "Qty        "
            ...
            datatype7       =   1
            mask7           =   "#####0"
            recalcparent7   =   "GrdIR(IRSETAVAL),GrdIR(IRSETIVAL),GrdIR(IRSETZVAL),GrdIR(IRRMIVAL),GrdIR(IRRMZVAL),GrdIR(IRRMAVAL)"
            maxlength7      =   6
            tooltiptext7    =   "Enter Raw Material Quantity"
            colname8        =   "IRRMAWT"
            heading8        =   "Actual Wt    "
            datafld8        =   "IrRmAWt"
            datatype8       =   2
            mask8           =   "#####0.000"
            recalcparent8   =   "GrdIR(IRRMAVAL),GrdID(IDAGLDASWT),GrdID(IDALABASWT),GrdID(WIDADIAWT),GrdID(WIDACSWT)"
            maxlength8      =   10
            style8          =   2
            tooltiptext8    =   "Actual Raw Material Weight"
            colname9        =   "IRRMIWT"
            heading9        =   "Inv Wt        "
            datafld9        =   "IrRmIWt"
            datatype9       =   2
            mask9           =   "#####0.000"
            recalcparent9   =   "GrdIR(IRRMIVAL),GrdID(IDIGLDASWT),GrdID(IDILABASWT),GrdID(WIDIDIAWT),GrdID(WIDICSWT)"
            maxlength9      =   10
            tooltiptext9    =   "Enter Invoice Raw Material Weight"
            colname10       =   "IRRMZWT"
            heading10       =   "Custm Wt    "
            datafld10       =   "IrRmZWt"
            datatype10      =   2
            mask10          =   "#####0.000"
            recalcparent10  =   "GrdID(IDCUSTMMTCHWT),GrdIR(IRRMZVAL),GrdIR(IRRMZPURERT),GrdID(IDZGLDASWT),GrdID(IDZLABASWT),GrdID(WIDZDIAWT),GrdID(WIDZCSWT)"
            maxlength10     =   10
            tooltiptext10   =   "Enter Customs Raw Material Weight"
            colname11       =   "IRRMART"
            datafld11       =   "IrRmARt"
            datatype11      =   2
            mask11          =   "#######0.000"
            recalcparent11  =   "GrdIR(IRRMAVAL)"
            maxlength11     =   12
            style11         =   0
            tooltiptext11   =   "Actual Raw Material Rate"
            colname12       =   "IRRMIRT"
            heading12       =   "Inv Rt                "
            datafld12       =   "IrRmIRt"
            datatype12      =   2
            mask12          =   "#######0.000"
            recalcon12      =   "GrdIR(IRRMCD)"
            recalcparent12  =   "GrdIR(IRRMZRT),GrdIR(IRRMIVAL)"
            maxlength12     =   12
            tooltiptext12   =   "Enter Invoice Raw Material Rate"
            colname13       =   "IRRMZRT"
            heading13       =   "Custm Rt         "
            datafld13       =   "IrRmZRt"
            datatype13      =   2
            mask13          =   "#######0.000"
            recalcon13      =   "GrdIR(IRRMIRT),GrdIR(IRRMCD)"
            recalcparent13  =   "GrdIR(IRRMZVAL),GrdIR(IRRMZPURERT)"
            maxlength13     =   12
            tooltiptext13   =   "Enter Customs Raw Material Rate"
            colname14       =   "IRRMZPURERT"
            heading14       =   "Custm PureRt"
            datafld14       =   "IrRmZPureRt"
            datatype14      =   2
            mask14          =   "#######0.000"
            recalcon14      =   "GrdIR(IRRMCD),GrdIR(IRRMZRT),GrdIR(IRRMZVAL),GrdIR(IRRMZWT)"
            maxlength14     =   12
            style14         =   2
            tooltiptext14   =   "Enter Customs Raw Material Pure Rate"
            colname15       =   "IRRMAVAL"
            datafld15       =   "IrRmAVal"
            datatype15      =   2
            mask15          =   "########0.00"
            recalcon15      =   "GrdIR(IRRMAWT),GrdIR(IRRMART),GrdIR(IRRMCD),GrdIR(IRRMQTY)"
            recalcparent15  =   "GrdID(IDAVAL)"
            maxlength15     =   12
            style15         =   0
            tooltiptext15   =   "Actual Raw Material Value"
            colname16       =   "IRRMIVAL"
            heading16       =   "Inv Val             "
            datafld16       =   "IrRmIVal"
            datatype16      =   2
            mask16          =   "########0.00"
            recalcon16      =   "GrdIR(IRRMIWT),GrdIR(IRRMIRT),GrdIR(IRMAINMET),GrdIR(IRRMCD),GrdIR(IRRMQTY)"
            recalcparent16  =   "GrdID(IDIVAL)"
            maxlength16     =   12
            style16         =   2
            tooltiptext16   =   "Enter Invoice Raw Material Value"
            colname17       =   "IRRMZVAL"
            heading17       =   "Custm Val       "
            datafld17       =   "IrRmZVal"
            datatype17      =   2
            mask17          =   "########0.00"
            recalcon17      =   "GrdIR(IRRMZWT),GrdIR(IRRMZRT),GrdIR(IRMAINMET),GrdIR(IRRMCD),GrdIR(IRRMQTY)"
            recalcparent17  =   "GrdID(IDZVAL),GrdIR(IRRMZPURERT)"
            maxlength17     =   12
            style17         =   2
            tooltiptext17   =   "Enter Customs Raw Material Value"
            colname18       =   "IRSETSCD"
            heading18       =   "Setting        "
            datafld18       =   "IrSetSCd"
            datatype18      =   4
            recalcparent18  =   "GrdIR(IRSETAVAL),GrdIR(IRSETIVAL),GrdIR(IRSETZVAL),GrdIR(IRSETIRT)"
            maxlength18     =   8
            tooltiptext18   =   "Enter Setting Code"
            colname19       =   "IRSETART"
            datafld19       =   "IrSetARt"
            datatype19      =   2
            mask19          =   "#####0.00"
            recalcparent19  =   "GrdIR(IRSETAVAL)"
            maxlength19     =   9
            style19         =   0
            tooltiptext19   =   "Actual Setting Rate"
            colname20       =   "IRSETIRT"
            heading20       =   "Inv SetRt  "
            datafld20       =   "IrSetIRt"
            datatype20      =   2
            mask20          =   "#####0.00"
            recalcon20      =   "GrdIR(IRSETSCD)"
            recalcparent20  =   "GrdIR(IRSETIVAL),GrdIR(IRSETZRT)"
            maxlength20     =   9
            tooltiptext20   =   "Enter Invoice Setting Rate"
            colname21       =   "IRSETZRT"
            heading21       =   "Custm SetRt"
            datafld21       =   "IrSetZRt"
            datatype21      =   2
            mask21          =   "#####0.00"
            recalcon21      =   "GrdIR(IRSETIRT)"
            recalcparent21  =   "GrdIR(IRSETZVAL)"
            maxlength21     =   9
            tooltiptext21   =   "Enter Customs Setting Rate"
            colname22       =   "IRSETAVAL"
            datafld22       =   "IrSetAVal"
            datatype22      =   2
            mask22          =   "######0.00"
            recalcon22      =   "GrdIR(IRSETSCD),GrdIR(IRRMQTY),GrdIR(IRSETART)"
            recalcparent22  =   "GrdID(IDAVAL)"
            maxlength22     =   10
            style22         =   0
            tooltiptext22   =   "Actual Setting Value"
            colname23       =   "IRSETIVAL"
            heading23       =   "Inv SetVal"
            datafld23       =   "IrSetIVal"
            datatype23      =   2
            mask23          =   "######0.00"
            recalcon23      =   "GrdIR(IRSETSCD),GrdIR(IRRMQTY),GrdIR(IRSETIRT)"
            recalcparent23  =   "GrdID(IDIVAL)"
            maxlength23     =   10
            style23         =   2
            tooltiptext23   =   "Enter Invoice Setting Value"
            colname24       =   "IRSETZVAL"
            heading24       =   "Custm SetVal"
            datafld24       =   "IrSetZVal"
            datatype24      =   2
            mask24          =   "######0.00"
            recalcon24      =   "GrdIR(IRSETSCD),GrdIR(IRRMQTY),GrdIR(IRSETZRT)"
            recalcparent24  =   "GrdID(IDZVAL)"
            maxlength24     =   10
            style24         =   2
            tooltiptext24   =   "Enter Customs Setting Value"
            colname25       =   "IRALYSALRT"
            heading25       =   "Aly Sal Rt"
            datafld25       =   "IrAlySalRt"
            datatype25      =   2
            mask25          =   "######0.00"
            maxlength25     =   10
            style25         =   2
            tooltiptext25   =   "Alloy Sale Rate"
            colname26       =   "IRMAINMET"
            heading26       =   "MMet"
            datafld26       =   "IrMainMet"
            datatype26      =   4
            recalcon26      =   "GrdIR(IRRMCD)"
            recalcparent26  =   "GrdID(IDCUSTMMTCHWT),GrdIR(IRRMIVAL),GrdIR(IRRMZVAL),GrdID(IDAGLDASWT),GrdID(IDIGLDASWT),GrdID(IDZGLDASWT)"
            maxlength26     =   1
            tooltiptext26   =   "Enter Main Metal (Y/N)"
            colname27       =   "IRRMZCD"
            heading27       =   "Custm Code            "
            datafld27       =   "IrRmZCd"
            datatype27      =   4
            recalcon27      =   "GrdIR(IRRMCD)"
            maxlength27     =   12
            style27         =   2
            tooltiptext27   =   "Enter Customs Code"
            colname28       =   "IRPRTKEY"
            heading28       =   "Prtn "
            datafld28       =   "IrPrtKey"
            maxlength28     =   1
            style28         =   0
            colname29       =   "IRCUSTRMCD"
            datafld29       =   "IrCustRmCd"
            datatype29      =   4
            recalcon29      =   "GrdIR(IRRMCD),GrdIR(IRRMSZ)"
            maxlength29     =   20
            style29         =   0
         End
         Begin MwfCtl.MWCTL_MED ATXT 
      ...
      Begin VB.Frame FraSumm 
         ...
         Begin TabDlg.SSTab TabSumm 
            ...
            Tab(1).Control(0)=   "FraTabSumm(0)"
            Tab(1).Control(0).Enabled=   0   'False
            Tab(1).ControlCount=   1
            TabCaption(2)   =   "Tab 2"
            Tab(2).ControlEnabled=   -1  'True
            Tab(2).Control(0)=   "FraTabSumm(0)"
      ...
      Begin VB.Frame FraSalHst 
         ...
         Begin MwfCtl.MWCTL_FLX GrdHR 
            ...
            mask9           =   "####0.000"
            maxlength9      =   9
            colname10       =   "WHIRSETVAL"
            heading10       =   "Set Val            "
            datatype10      =   2
            mask10          =   "########0.00"
            maxlength10     =   12
            colname11       =   "WHIRMAINMET"
            heading11       =   "Main Met"
            datatype11      =   4
            maxlength11     =   1
            style11         =   0
...
Dim mLocalExp As String, mSlvMod As Boolean, mf_QWModYn As Boolean
...
'  ReDim mArr_Cv(7), mArr_Ed(7)
  ...
  ReDim mArr_Cv(10), mArr_Ed(10)      ' ***** Manali 3.6.0 - 29/10/09 - Refresh Metal Rate
' Manoj 2.10.0
...
Private Sub ADC_NonKeyWhen(Cancel As Boolean, ErrMsg As String)
 ...
 ' ms_LockDt = "01/01/80"
  ...
  Call GetLockDt("TC", ms_IdTcTyp, ms_LockDt, ms_FutureDt)
...
Private Sub ATXT_FldWhen(Index As Integer, ByVal IdName As String, _
  ...
  If (adc("wIdPrtKey") <> ctCurrPrtn Or mf_DtLocked = True) _
       And (IdName <> UCase("WIDTC") And IdName <> UCase("WIDYY") And IdName <> UCase("WIDCHR") And IdName <> UCase("WIDNO") And _
            ...
            IdName <> UCase("wDLGrp") And IdName <> UCase("wILGrp") And IdName <> UCase("wIDGrp")) Then
  ...
  If moCn.RecSeek("Select 'x' from InvZRm where IzCoCd= '" + gs_CoCd + "' and IzTc= '" + adc("wIdTc") + "' and " + _
                  ...
                  (IdName = UCase("wDdIdValAddn") Or IdName = UCase("wDdIdVaCtg") Or _
                   ...
                   IdName = UCase("wDdIdCustmMtchWt")) Then
    'Or IdName = UCase("wDdIdFixPrc")
...
Private Sub GrdHD_RowWhen(ByVal RowNum As Integer)
  ...
  If RowNum > 0 Then
    ...
    wSqlStr = "Select IrSrNo, IrRmCd, IrLotNo, IrRmSz, IrMainMet, " & _
...
Private Sub GrdIdRecalcHelper(ByVal ColumnsList As String, ByVal RowNum As Integer, ByVal SourceRowNum As Double, ByVal SourceColName As String)
    ...
    Dim i As Integer
          ...
          If Not GrdIR.IsDel(i) Then
            ...
            If wf_IdCustmMtchWt Or wf_IdADiaWt Or wf_IDIDiaWt Or wf_IdZDiaWt Then
              ...
              If wf_wIdZCsWt Then _
                wIdZCsWt = wIdZCsWt + IIF(wRmCtg = "D", GrdIR.Value(i, "IrRmZWt"), 0)
     ...
     For i = 1 To GrdIL.Rows - 1
        If Not GrdIL.IsDel(i) Then
          ...
          If wf_IDZVal And wf_IDZValCalc Then _
    ...
    If wf_IdCustmMtchWt Then _
      GrdID.Value(RowNum, "IdCustmMtchWt") = wd_IdCustmMtchWt
  ...
  With GrdID
    ...
    Case Is = UCase("IdCustmMtchWt")
      If .Mode = fgmnorm Or .Mode = fgmCopy Then
        wSourceGrdMode = Me.Controls(SourceName).Mode
        If (wSourceGrdMode = fgmnorm Or wSourceGrdMode = fgmCopyOver Or wSourceGrdMode = fgmdel) Then
          Call GrdIdRecalcHelper("GrdId", .Row, 0, SourceColName)
          Controls(SourceName).AddSave "GrdID", asCurrent
        End If
      End If
...
'''      Next i
    ...
    Case Is = UCase("IdALabAsWt")
      ...
      For i = 1 To GrdIL.Rows - 1
        ...
        If Not (GrdIL.Value(i, "iLMCd") = ctDHCLMCd Or GrdIL.Value(i, "iLMCd") = ctCHCLMCd) And Not GrdIL.IsDel(i) And GrdIL.Value(i, "iLCstQw") = "W" Then
          
          ' ***** Manali 3.03 - 05/07/08 - Om Lk Up parameter passed if not blank
          GrdIL.Value(i, "ilAVal") = GetLabVal(GrdID.Value(RowNum, "IdExpCmCd"), _
                     GrdIL.Value(i, "ilMCd"), GrdIL.Value(i, "ilSCd"), _
                     GrdIL.Value(i, "iLARt"), GrdIL.Value(i, "ilQty"), _
        ...
        '*** (Jen 2.14 Next 20/03/07)
          ...
          '                        "and LrCmCtg= 'C' and LrCmCd= 'ZSELF' and LrFrWt<= " + CStr(wd_LabAsWt) + " " + _
          ...
          'GrdIL.Value(i, "ilAVal") = GetLabVal(GrdID.Value(RowNum, "IdExpCmCd"), _
                     GrdIL.Value(i, "ilMCd"), GrdIL.Value(i, "ilSCd"), _
                     GrdIL.Value(i, "iLARt"), GrdIL.Value(i, "ilQty"), _
                     MWLib.Div(NewValue, GrdID.Value(RowNum, "IdQty")), GrdIL.Value(i, "ilQw"), "C", "C", ADC("wIdCmCurCd")) * _
                     GrdID.Value(RowNum, "IdQty")
          '*** (Bef 2.14 Next)
...
''          End If
    ...
    Case Is = UCase("IdILabAsWt") '****** Sachin 2.13.0 - 26-05-2006 ******
      ...
      For i = 1 To GrdIL.Rows - 1
      ' ******** Manali - 18/05/09 - "DHC" and "CHC" excluded
        If Not (GrdIL.Value(i, "iLMCd") = ctDHCLMCd Or GrdIL.Value(i, "iLMCd") = ctCHCLMCd) And Not GrdIL.IsDel(i) Then
          ...
          End If
          If GrdIL.Value(i, "ilQw") = "W" Then
            ' **** Manali 3.03 - 05/07/08 - Om Lk Up fields passes if not blank
    ...
    Case Is = UCase("IdZLabAsWt") '****** Sachin 2.13.0 - 26-05-2006 ******
      ...
      For i = 1 To GrdIL.Rows - 1
      ' ******** Manali - 18/05/09 - "DHC" and "CHC" excluded
        If Not (GrdIL.Value(i, "iLMCd") = ctDHCLMCd Or GrdIL.Value(i, "iLMCd") = ctCHCLMCd) And Not GrdIL.IsDel(i) And GrdIL.Value(i, "ilQw") = "W" Then
...
' Zubin 212
  ...
  Case Is = UCase("IrLotNo")
    Cancel = Not moCn.RecSeek("Select 'x' from RmMst where RmCd= '" + GrdIR.Value(RowNum, "IrRmCd") + "' and " + _
                                "RmCtg In ('D', 'C', 'X') " + IIF(gs_Partition = ctCurrPrtn, " And RmPrtKey='" + GrdIR.Value(RowNum, "IrPrtKey") + "' ", ""))
  ...
  With GrdIR
    ...
    Case Is = UCase("IrRmIRt")
      If (.Mode = fgmnorm Or .Mode = fgmCopy) And (ms_IdTcTyp = ctCTBTcTyp) Then
        ...
        If adc("wIdLmgSal") > 0 And ws_RmCtg = "G" Then
         .Value(RowNum, "IrRmIRt") = GetGldRt(adc("wIdCmCd"), adc("wIdLmgSal"), _
                                      .Value(RowNum, "IrRmCd"), .Value(RowNum, "IrAlySalRt"), "DM", _
                                      GrdID.Value(GrdID.Row, "IdDmCd"), "S", "T", md_InCnvRt)
        ElseIf adc("wIdLmpSal") > 0 And ws_RmCtg = "P" Then
          .Value(RowNum, "IrRmIRt") = GetGldRt(adc("wIdCmCd"), adc("wIdLmpSal"), _
                                      .Value(RowNum, "IrRmCd"), .Value(RowNum, "IrAlySalRt"), "DM", _
                                      GrdID.Value(GrdID.Row, "IdDmCd"), "S", "T", md_InCnvRt)
        ElseIf adc("wIdLmsSal") > 0 And ws_RmCtg = "S" Then
          If mSlvMod = True Then
            .Value(RowNum, "IrRmIRt") = GetGldRt(adc("wIdCmCd"), adc("wIdLmsSal"), _
                                        .Value(RowNum, "IrRmCd"), .Value(RowNum, "IrAlySalRt"), "DM", _
                                        GrdID.Value(GrdID.Row, "IdDmCd"), "S", "T", md_InCnvRt)
          Else
            .Value(RowNum, "IrRmIRt") = 0
          End If
        ElseIf adc("wIdLmlSal") > 0 And ws_RmCtg = "L" Then
          If mb_PdMod = True Then
            .Value(RowNum, "IrRmIRt") = GetGldRt(adc("wIdCmCd"), adc("wIdLmlSal"), _
                                        .Value(RowNum, "IrRmCd"), .Value(RowNum, "IrAlySalRt"), "DM", _
                                        GrdID.Value(GrdID.Row, "IdDmCd"), "S", "T", md_InCnvRt)
          Else
            .Value(RowNum, "IrRmIRt") = 0
        ...
        ElseIf ws_RmCtg = "X" Then
          If moCn.RecSeek("select 'x' from Param where PTyp= 'RMSCTG' and PMCd= '" + ws_RmCtg + "' " + _
            ...
            If wf_BaseLme > 0 Then
              .Value(RowNum, "IrRmIRt") = GetRmRt(adc("wIdCmCd"), .Value(RowNum, "IrRmCd"), 0, 0, 0, "S", wf_BaseLme, "T", , , , adc("wIdCmCurCd"))
            End If
          End If
        End If
      End If
    ...
    Case Is = UCase("IrRmZVal")   '*** recalc on IrRmZWt, IrRmZRt, IrMainMet
      ...
      If .Mode = fgmnorm Or .Mode = fgmCopy Then
        ...
        End If
      End If
    Case Is = UCase("IrSetAVal")    '*** recalc on IrSetSCd, IrSetARt, IrRmQty
      If .Mode = fgmnorm Or .Mode = fgmCopy Then _
         .Value(RowNum, "IrSetAVal") = GetLabVal(GrdID.Value(GrdID.Row, "IdExpCmCd"), "SET", _
    ...
    Case Is = UCase("IrRmZPureRt")    '*** recalc on IrRmCd,IrRmZRt,IrRmZVal
      'If (.Mode = fgmnorm Or .Mode = fgmCopy) And UCase(ms_IdTcTyp) = UCase(ctInTcTyp) Then
      If .Mode = fgmnorm And UCase(ms_IdTcTyp) = UCase(ctInTcTyp) Then
...
' Zubin 212
  ...
  End With
End Sub
Private Sub GrdIR_OnDelete(ByVal RowNum As Integer, Cancel As Boolean, ErrMsg As String)
  '*** (Jen 2.12) 08/02/06
  If GrdID.Mode = fgmnorm And GrdIL.Mode = fgmnorm Then
    Dim wi_i As Integer '', wi_ZAdd As Integer
    ''wi_ZAdd = 0
    With GrdIL
      For wi_i = 1 To .Rows - 1
        ...
        ''End If
      Next wi_i
      ''If wi_ZAdd > 0 Then .Value(wi_ZAdd, "iLZRt") = GetZAddVal(GrdID.Row)
    End With
  End If
  '*** (Jen 2.12) 08/02/06
End Sub
...
Private Sub GrdIR_InitKey(ByVal RowNum As Integer)
  ...
  End With
End Sub
Private Sub GrdIR_RowSave(ByVal RowNum As Integer, Cancel As Boolean, ErrMsg As String)
  '*** (Jen 2.12) 06/01/06
  If GrdID.Mode = fgmnorm And GrdIL.Mode = fgmnorm Then
    Dim wi_i As Integer
    With GrdIL
      For wi_i = 1 To .Rows - 1
        If .Value(wi_i, "ilMCd") = ctBrkLMCd And .Value(wi_i, "iLSCd") = ctBrkLSCd Then
          .Value(wi_i, "iLiVal") = .Value(wi_i, "iLiRt") / 100 * GetDCRmVal("IrRmiVal")
          .Value(wi_i, "iLZVal") = .Value(wi_i, "iLZRt") / 100 * GetDCRmVal("IrRmZVal")
          .SaveRec (wi_i)
        ' ****** Manali 3.5.0 - 18/05/09 - "DHC" and "CHC"
        ' ***** Manali 3.9.0 - ctDCHCLSCd='-' removed
        ElseIf .Value(wi_i, "ilMCd") = ctDHCLMCd Then         '''' And .Value(wi_i, "iLSCd") = ctDCHCLSCd
          .Value(wi_i, "iLiVal") = .Value(wi_i, "iLiRt") / 100 * GetDCRmVal("IrRmiVal", , "D")
          .Value(wi_i, "iLZVal") = .Value(wi_i, "iLZRt") / 100 * GetDCRmVal("IrRmZVal", , "D")
          .SaveRec (wi_i)
        ElseIf .Value(wi_i, "ilMCd") = ctCHCLMCd Then         '''' And .Value(wi_i, "iLSCd") = ctDCHCLSCd
          .Value(wi_i, "iLiVal") = .Value(wi_i, "iLiRt") / 100 * GetDCRmVal("IrRmiVal", , "C")
          .Value(wi_i, "iLZVal") = .Value(wi_i, "iLZRt") / 100 * GetDCRmVal("IrRmZVal", , "C")
          .SaveRec (wi_i)
        ' ****** Manali 3.5.0 - 18/05/09 - "DHC" and "CHC"
        End If
      Next wi_i
...
Private Sub GrdIL_ColWhen(ByVal RowNum As Integer, ByVal ColName As String, Cancel As Boolean, ErrMsg As String, ByVal Action As MwfCtl.en_fgAction)
  ...
  Case Is = UCase("iLQty")
    ...
    If (GrdIL.Value(RowNum, "ilMCd") = ctBrkLMCd And GrdIL.Value(RowNum, "iLSCd") = ctBrkLSCd) Or _
       ...
       (GrdIL.Value(RowNum, "ilMCd") = ctCHCLMCd) Then
  ...
  With GrdIL
    ...
    Case Is = UCase("iLAVal")     '*** recalc of iLAVal on iLMCd,iLSCd,iLARt,iLQw,iLQty
      ...
      If .Mode = fgmnorm Or .Mode = fgmCopy Then
        ...
        Else
          .Value(RowNum, "iLAVal") = GetLabVal(GrdID.Value(GrdID.Row, "IdExpCmCd"), .Value(RowNum, "ilMCd"), _
...
Private Sub ADC_NonKeyValid(pr_Cancel As Boolean, pr_ErrMsg As String)
  ...
  If UCase(ms_IdTcTyp) = UCase(ctInTcTyp) And adc("wIdPrtKey") = ctCurrPrtn Then
    ...
    '*** (Jen 23/11/05) (2.11 Patch3)
      ...
      wi_IdSr = moCn.GetFldVal("Set dateformat dmy " + _
...
Private Sub GrdID_SetRecSource()
  ...
  '****** Sachin 3.02.0 ******
  wInCnd = IIF(gs_Partition = ctCurrPrtn, " And Exists (Select 'x' From InvHd Where InPrtKey=IdPrtKey And InCoCd=IdCoCd And InTc=IdTc And InYy=IdYy And InChr=IdChr And InNo=IdNo And InDt>'" + ms_PurgeDt + "' ) ", "")
...
Private Sub CmdCRL_Click()
  ...
  With GrdID
    ...
    If moCn.GetFldVal("Select hSizeStkRt from Head where HCoCd= '" + gs_CoCd + "' and " + _
      ...
      '*** Copy Raw Material Dets from OrdRm
      Call MakeRm(.Value(GrdID.Row, "IdSr"), .Value(GrdID.Row, "IdExpOdTc"), _
                  ...
                  .Value(GrdID.Row, "IdExpCmCd"), .Value(GrdID.Row, "IdDmCd"), _
                  .Value(GrdID.Row, "IdQty"), wOdIWtEqOrd, wOdIWtFrOrd, wOdIGldRtEqOrd)
    Else
      '*** Copy Raw Material Dets FROM FgRm
...
Private Sub CmdDCGo_Click()
  ...
  ws_SqlStr = "Select Max(OdDmCd) as qDmCd, Max(OdSfx) as qSfx,Max(OdDmSz) as qDmSz, sum(IsNull(IfQty, FdQty- " + ms_DespTyp + ")) as qQty, " + _
               ...
               "OdSr as qOdSr, " + IIF(mb_InByBag = True, " B.FdBYy as qBYy, B.FdBChr as qBChr, B.FdBNo as qBNo,", "") + " Max(OmCmCd) as qCmCd, Max(OdVaCtg) as qVaCtg, Max(OdKt) as qKt,max(OdILabWtFrOrd) as OdILabWtFrOrd,max(OdLabAsWt) as OdLabAsWt, " + _
  ...
  ws_SqlStr = ws_SqlStr + " where OdCoCd= '" + gs_CoCd + "' " + _
  ...
  '(Bef 2.13) If wRsSrcDsg.RecCount = 0 Then DispMsg "Bags Do Not Exist For The Specified Order Sr. Range/ Order Closed", etError: Exit Sub: Set wRsSrcDsg = Nothing
  '*** (Jen 2.13)
...
'*** This option cannot be used if there are records existing in the GrdID grid
  ...
  Set wRsSrcDsg = moCn.OpenRes("Select Max(OdDmCd) as qDmCd, Max(OdSfx) as qSfx, " + _
                  ...
                  "Max(OdVaCtg) as qVaCtg, Max(OdKt) as qKt, Max(OdFixPrc) as qFixPrc, " + _
                  "Max(OdGldAs) as qGldAs, Max(OdLabAs) as qLabAs, max(OdIWtEqOrd) as OdIWtEqOrd,max(OdILabWtFrOrd) as OdILabWtFrOrd,max(OdLabAsWt) as OdLabAsWt, " + _
                  ...
                  "where IfCoCd= '" + gs_CoCd + "' and IfTc= '" + adc("wIdTc") + "' and " + _
                  "IfYy= '" + adc("wIdYy") + "' and IfChr= '" + adc("wIdChr") + "' and " + _
                  "IfNo= " + CStr(adc("wIdNo")) + " and IfPrtKey='" + ctCurrPrtn + "' group by OdCoCd, OdTc, OdYy, OdChr, OdNo, OdSr" + IIF(mb_InByBag = True, ",IfFdBYy, IfFdBChr, IfFdBNo", " ") + ws_OrdBy)
  If wRsSrcDsg.RecCount = 0 Then DispMsg "No Records In Invoice Bags", etError: Exit Sub: Set wRsSrcDsg = Nothing
...
Private Sub MakeDsgWithBags(ByVal mMkInv As Boolean, ByVal mRsSrcDsg As MDORowSet)
  ...
  With GrdID
    ...
    MWLib.BeginProcess Me, "Copying Designs"        '4.1.3.0
    
    TrackStatus ("Copying Designs...")
  ...
  '*******Geeta****Emr206***09/04/04
    ...
    '***
      ...
      '4.1.3.0  -   Sachin
      wi_Cnt = wi_Cnt + 1
      MWLib.RunningProcess "Copying Design " + CStr(wi_Cnt) + " of " + CStr(wi_TotCnt) + " "
      TrackStatus ("Copying Design " + CStr(wi_Cnt) + " of " + CStr(wi_TotCnt) + " ")
      If .Value(wDsgRow, "IdSr") = 0 Then .Value(wDsgRow, "IdSr") = .MaxVal("IdSr") + 1
      .Value(wDsgRow, "IdPrtKey") = ctCurrPrtn          '****** Sachin 3.02.0 - 28-12-2007
      ...
      .Value(wDsgRow, "IdCustmMtchWt") = 0    '*** (Jen 2.13)
      
      '*** (Jen 3.01.0_1) here the IdGldLs recalc is overwritten
      ...
      TrackStatus ("Starting Save of Id table " + CStr(wi_Cnt) + " of " + CStr(wi_TotCnt))
      If Not .SaveRec(wDsgRow) Then GoTo NextOd
      TrackStatus ("Ending Save of Id table " + CStr(wi_Cnt) + " of " + CStr(wi_TotCnt))
      
      '****** Sachin 3.3.0 (23-06-08) - [42. Make Invoice By Bag] ******
      'wByBagStr = " and IfSrNo=(Select If2.IfSrNo from InvFgd If2 " + _
               " Where If1.IfCoCd=If2.IfCoCd and If1.IfTc=If2.IfTc And If1.IfYy=If2.IfYy And " + _
               " If1.IfChr=If2.IfChr and If1.IfNo=If2.IfNo and If1.IfSr=If2.IfSr and " + _
               " If2.) "
      ...
      'If mMkInv = True Or wInvBagExists = True Then
        '****** Sachin 3.02 - Current Partition
        TrackStatus ("InvFgd Update " + CStr(wi_Cnt) + " of " + CStr(wi_TotCnt) + " ")
      ...
      If mMkInv = False Then
        'wInvBagExists = True
        'Set wRsSrcBag = moCn.OpenRes("Select * from InvFgd join Fgd on " + _
                        "FdCoCd= IfCoCd and  FdTc= IfFdTc and FdYy= IfFdYy and " + _
                        "FdChr= IfFdChr and FdNo= IfFdNo and FdSr= IfFdSr " + _
                        "where IfCoCd= '" + gs_CoCd + "' and " + _
                        "IfTc='" + ADC("wIdTc") + "' and " + _
                        "IfYy='" + ADC("wIdYy") + "' and " + _
                        "IfChr='" + ADC("wIdChr") + "' and " + _
                        "IfNo=" + CStr(ADC("wIdNo")) + " and IfSr= 0 and " + _
                        "FdExpOdTc= '" + mRsSrcDsg!qOdTc + "' and " + _
                        "FdExpOdYy= '" + mRsSrcDsg!qOdYy + "' and " + _
                        "FdExpOdChr= '" + mRsSrcDsg!qOdChr + "' and " + _
                        "FdExpOdNo= " + CStr(mRsSrcDsg!qOdNo) + " and " + _
                        "FdExpOdSr= " + CStr(mRsSrcDsg!qOdSr))
        
        'If wRsSrcBag.RecCount = 0 Then
        '''''If moCn.GetFldVal("Select count(*) from InvFgd where IfCoCd= '" + gs_CoCd + "' and " + _
                         "IfTc= '" + ADC("wIdTc") + "' and IfYy= '" + ADC("wIdYy") + "' and " + _
                         "IfChr= '" + ADC("wIdChr") + "' and IfNo= " + CStr(ADC("wIdNo")) + " and " + _
                         "IfSr= " + CStr(GrdID.Value(wDsgRow, "IdSr")) + " ") = 0 Then
          'wInvBagExists = False
          ...
          '****** Sachin 3.02 - Current Partition only
        ...
        'End If
        TrackStatus ("Starting GrdIB Copy " + CStr(wi_Cnt) + " of " + CStr(wi_TotCnt) + " ")
        With GrdIB
          GrdIB.StartCopy
          '%%% wTotDsgQty = 0
          wIfSrNo = 0
          
          'If wInvBagExists = False Then
            '****** Sachin 3.02 - Current Partition
          ...
          Do While Not (wRsSrcBag.EOF Or wRsSrcBag.BOF)
            'If wInvBagExists = True Then Exit Do
            .AddItem
            wBagRow = .Rows - 1
            '##### .Value(wBagRow, "IfSrNo") = moCn.AutoGen("InvFgd", "IfSrNo", adc("wIdTc") + adc("wIdYy") + adc("wIdChr") + CStr(adc("wIdNo")))
            wIfSrNo = wIfSrNo + 1
            ...
            '%%% wTotDsgQty = wTotDsgQty + (wRsSrcBag!FdQty - wRsSrcBag!FdDespQty)
            .Value(wBagRow, "IfPrtKey") = ctCurrPrtn        '****** Sachin 3.02 28-12-07
            TrackStatus ("Starting Save of GrdIB " + CStr(wi_Cnt) + " of " + CStr(wi_TotCnt) + ": Row : " + CStr(wIfSrNo))
            .SaveRec (wBagRow)
            TrackStatus ("Completed Save of GrdIB " + CStr(wi_Cnt) + " of " + CStr(wi_TotCnt) + ": Row : " + CStr(wIfSrNo))
            wRsSrcBag.MoveNext
          Loop
          '%%% GrdID.Value(wDsgRow, "IdQty") = wTotDsgQty
          '%%% GrdID.SaveRec (wDsgRow)
          GrdIB.EndCopy
        End With
      End If
      TrackStatus ("Ending GrdIB Copy " + CStr(wi_Cnt) + " of " + CStr(wi_TotCnt) + " ")
      '*** 25/07/05
      ...
      If wb_BagExists = True Then
        If moCn.GetFldVal("Select hSizeStkRt from Head where HCoCd= '" + gs_CoCd + "' and " + _
                          "HCd= '" + ctSelfCmCd + "'") = "N" Then
          '*** Copy Raw Material Dets from OrdRm
          TrackStatus ("Starting Make Rm Proc " + CStr(wi_Cnt) + " of " + CStr(wi_TotCnt) + " ")
          Call MakeRm(.Value(wDsgRow, "IdSr"), .Value(wDsgRow, "IdExpOdTc"), _
                      ...
                      .Value(wDsgRow, "IdExpCmCd"), .Value(wDsgRow, "IdDmCd"), _
                      .Value(wDsgRow, "IdQty"), mRsSrcDsg!OdIwtEqOrd, _
                      mRsSrcDsg!OdIwtFrOrd, mRsSrcDsg!OdIGldRtEqOrd)
          TrackStatus ("Ending Make Rm Proc " + CStr(wi_Cnt) + " of " + CStr(wi_TotCnt) + " ")
        Else
          '*** Copy Raw Material Dets from FgRm
          TrackStatus ("Starting Make Rm From Fg " + CStr(wi_Cnt) + " of " + CStr(wi_TotCnt) + " ")
          Call MakeRmFromFg(mRsSrcDsg!OdIwtEqOrd, mRsSrcDsg!OdIwtFrOrd, mRsSrcDsg!OdIGldRtEqOrd, .Value(wDsgRow, "IdQty"))
          TrackStatus ("Ending Make Rm From Fg " + CStr(wi_Cnt) + " of " + CStr(wi_TotCnt) + " ")
        End If
      End If
      ...
      '*** Lab
      If wb_BagExists = True Then
        TrackStatus ("Starting Make Lab " + CStr(wi_Cnt) + " of " + CStr(wi_TotCnt) + " ")
        ...
        TrackStatus ("Ending Make Lab " + CStr(wi_Cnt) + " of " + CStr(wi_TotCnt) + " ")
      End If
      Call CalcGrdIdVals(wDsgRow)
      GrdID.SaveRec wDsgRow
...
Private Sub CalcGrdIdVals(ByVal RowNum As Integer)
  Call GrdIdRecalcHelper("IdCustmMtchWt,wIdADiaWt,wIdIDiaWt,wIdZDiaWt,wIdACsWt,wIdICsWt,wIdZCsWt,IdAVal,IdIVal,IdZVal,IdAGldAsWt,IdIGldAsWt,IdZGldAsWt,IdALabAsWt,IdILabAsWt,IdZLabAsWt", RowNum, 0, "")
End Sub
    ...
    Do While Not (wFinalResultSet.EOF Or wFinalResultSet.BOF)
      ...
      If UCase(ms_IdTcTyp) = UCase(ctInTcTyp) Then
        ...
        If wFinalResultSet!OrMainMet = "Y" Then
          ...
          '*** (Bef 3.01.0_1)
          '.Value(wRmRow, "IrRmIWt") = IIF(wWtFrOrdYN = "N", wFinalResultSet!qRmIWt - (wTotIWt - wTotAWt), wFinalResultSet!qRmIWt - wTotIXtraWt)
          '*** (Bef 3.01.0_1)
          ...
          If whZWtEq = "A" Then
            ...
            '.Value(wRmRow, "IrRmZWt") = wFinalResultSet!qRmZWt - wTotZXtraWt - (wTotZWt - wTotAWt)
          ElseIf whZWtEq = "I" Then
            '*** (Bef 3.01.0_1)
...
Public Sub MakeRmFromFg(ByVal mIWtEqOrd As String, ByVal mIWtFrOrd As String, _
  ...
  '****** Sachin 3.3.0 (25-06-08) - [14. Cost Markup In Invoicing] ******
  ...
  ElseIf UCase(ms_IdTcTyp) = UCase(ctCTBTcTyp) Then
    ...
    wStr = "Select (case when max(isnull(qOrRmCd, ''))= '' then '' else 'Y' end) as qOrRmExists, " + _
           ...
           "Space(1) as qIrMainMet, max(RmPurityZ) as qRmPurityZ, max(RmCtg) as qRmCtg, max(RmSCtg) as qRmSCtg,Max(OrCustRmCd) as OrCustRmCd  " + _
           "into " + wTmpTbl + " from InvFgd " + _
           "join FgRm on FrFdIdNo=IfFdIdNo and FrCoCd= IfCoCd and FrTc= IfFdTc and FrYy= IfFdYy and FrChr= IfFdChr and FrNo = IfFdNo And FrSr = IfFdSr And FrPrtKey=IfPrtKey " + _
           "Left Outer Join (select OrRmcd as qOrRmcd ," + ws_OrLn + " as qOrLn1, OrSetSCd as qOrSetSCd, " + _
           "OrSetSalRt as qOrSetSalRt, sum(OrWt) as qOrWt, sum(OrQty),Max(OrCustRmCd) as OrCustRmCd as qOrQty from OrdRm " + _
           "Join RmMst on RmCd= OrRmCd and RmPrtKey=OrPrtKey " + _
           "Join Param on PTyp= 'RMSCTG' and PMCd= RmCtg and PSCd= RmSCtg " + _
           "where OrCoCd= '" + gs_CoCd + "' and OrTc= '" + GrdID.Value(GrdID.Row, "IdExpOdTc") + "' " + _
           "and OrYy= '" + GrdID.Value(GrdID.Row, "IdExpOdYy") + "' " + _
      ...
      If UCase(ms_IdTcTyp) = UCase(ctInTcTyp) Then
        ...
        If wRsRmDet!qIrMainMet = "Y" Then
          ...
          If whZWtEq = "A" Then
            .Value(wRmRow, "IrRmZWt") = wRsRmDet!qIrRmZWt - (wTotZWt - wTotAWt)
          ElseIf whZWtEq = "I" Then
            '.Value(wRmRow, "IrRmZWt") = wRsRmDet!qIrRmIWt - (wTotIWt - wTotAWt)    '*** (Bef 3.01.0_1)
            .Value(wRmRow, "IrRmZWt") = wd_Wt     '*** (Jen 3.01.0_1)
          End If
        Else
          ' Manoj 2.10.0
        ...
        '***** Sachin 3.11.0 - Markup for Metals
        Dim wMetStkRt As Boolean
        wMetStkRt = moCn.RecSeek("Select 'x' From InvHd Where InCoCd='" + gs_CoCd + "' And InTc='" + adc("wIdTc") + "' And InYy='" + adc("wIdYy") + "' " + _
                          " And InChr='" + adc("wIdChr") + "' And InNo=" + CStr(adc("wIdNo")) + " And InPrtKey='" + adc("wIdPrtKey") + "' And InMetIRtWrtStkYN='Y' ")
        ...
        ' **** Manali 3.03 - 21/06/08 - Pd Mod
        ' Manali 3.6.0 - 27/10/09 - Cost Markup And Limit In Invoicing For Accessories
        ElseIf UCase(wRsRmDet!qRmCtg) = "X" And (mIGldRtEqOrd <> "Y" Or ms_RmRtfrRtChrt = "Y") And _
          ...
          '*** (Bef 2.13)
          'If GetRmRt(GrdID.Value(GrdID.Row, "IdExpCmCd"), wRsRmDet!qIrRmCd, 0, 0, 0, "S", wf_BaseLmeOrd) = _
             GetRmRt(GrdID.Value(GrdID.Row, "IdExpCmCd"), wRsRmDet!qIrRmCd, 0, 0, 0, "S", wf_BaseLmeInv) Then
          '*** (Bef 2.13)

          '*** (Jen 2.13)
          ' **** Manali 3.03 - 05/07/08 - Om Lk Up fields passed if not blank
          If GetRmRt(GrdID.Value(GrdID.Row, "IdExpCmCd"), wRsRmDet!qIrRmCd, 0, 0, 0, "S", wf_BaseLmeOrd, , , , , adc("wIdCmCurCd"), IIF(wOmLkUpRmRt <> "", wOmLkUpRmRt, "")) = _
             GetRmRt(GrdID.Value(GrdID.Row, "IdExpCmCd"), wRsRmDet!qIrRmCd, 0, 0, 0, "S", wf_BaseLmeInv, , , , , adc("wIdCmCurCd"), IIF(wOmLkUpRmRt <> "", wOmLkUpRmRt, "")) Then
          '*** (Jen 2.13)
            .Value(wRmRow, "IrRmIRt") = wRsRmDet!qIrRmIRt
          Else
            '*** (Bef 2.13)
            '.Value(wRmRow, "IrRmIRt") = GetRmRt(GrdID.Value(GrdID.Row, "IdExpCmCd"), wRsRmDet!qIrRmCd, 0, 0, 0, "S", wf_BaseLmeInv)
            '*** (Bef 2.13)
            
            '*** (Jen 2.13)
            ' **** Manali 3.03 - 05/07/08 - Om Lk Up fields passed if not blank
            .Value(wRmRow, "IrRmIRt") = GetRmRt(GrdID.Value(GrdID.Row, "IdExpCmCd"), wRsRmDet!qIrRmCd, 0, 0, 0, "S", wf_BaseLmeInv, , , , , adc("wIdCmCurCd"), IIF(wOmLkUpRmRt <> "", wOmLkUpRmRt, ""))
            '*** (Jen 2.13)
          End If
          '.Value(wRmRow, "IrRmZRt") = wRsRmDet!qIrRmZRt
          .Value(wRmRow, "IrRmZRt") = .Value(wRmRow, "IrRmIRt")
        ...
        Else
          '****** Sachin 3.3.0 (25-06-08) - [14. Cost Markup And Limit In Invoicing] ******
          ' **** Manali 3.6.0 - 27/10/09 - 'X' added below
          If ((wRsRmDet!qRmCtg = "D" Or wRsRmDet!qRmCtg = "C") And _
             ...
             ' **** Manali 3.6.0 - Modified StkRt Considered for Calculation based on RmQW
             Dim wStkRtQW As Single, wRmQW As String
             wRmQW = moCn.GetFldVal("Select RmQw From RmMst where RmCd= '" + .Value(wRmRow, "IrRmCd") + "'" + IIF(adc("wIdPrtKey") = ctCurrPrtn, " and RmPrtKey='" + ctCurrPrtn + "' ", ""))
             
             ' ***** Manali 3.6.1 - 16/02/10 - Multi-Currency considered for StkRt
             Dim wStkRtInCmCur As Single, wBaseCurCd As String
             ...
             wStkRtQW = IIF(wRmQW = "Q" And wRsRmDet!qRmCtg = "X", wStkRtInCmCur * wRsRmDet!qIrRmIWt / IIF(wRsRmDet!qIrRmQty = 0, 1, wRsRmDet!qIrRmQty), wStkRtInCmCur)
             ' ***** Manali 3.6.1 - 16/02/10 - Multi-Currency considered for StkRt
             ...
             ' Bef 3.6.1 - Multi-Currency considered
             'wStkRtQW = IIF(wRmQW = "Q" And wRsRmDet!qRmCtg = "X", wRsRmDet!qIrStkRt * wRsRmDet!qIrRmIWt / IIF(wRsRmDet!qIrRmQty = 0, 1, wRsRmDet!qIrRmQty), wRsRmDet!qIrStkRt)

            ' ***** Manali3.6.1 - 15/02/10 - Passed CmCurCd
            ' **** Manali 3.8.0 - DmCd, DmCtg added
             wCurrMrkUpRt = GetMarkUpRt(GrdID.Value(GrdID.Row, "IdExpCmCd"), wRsRmDet!qRmCtg, wRsRmDet!qRmSCtg, wStkRtQW, adc("wIdCmCurCd"), wDmCtg, GrdID.Value(GrdID.Row, "IdDmCd"))
             
             
             wRmQtyWt = IIF(wRmQW = "Q", (MWLib.Div(wRsRmDet!qIrRmQty, mIdQty)), (MWLib.Div(.Value(wRmRow, "IrRmIWt"), mIdQty)))
            ' **** Manali 3.6.0 - 07/09/09 - Modified StkRt Considered for Calculation based on RmQW
            
''' Bef 3.6.0
''             wCurrMrkUpRt = GetMarkUpRt(GrdID.Value(GrdID.Row, "IdExpCmCd"), wRsRmDet!qRmCtg, wRsRmDet!qRmSCtg, wRsRmDet!qIrStkRt)
''             wRmQtyWt = IIF(moCn.GetFldVal("Select RmQw From RmMst where RmCd= '" + .Value(wRmRow, "IrRmCd") + "'" + IIF(ADC("wIdPrtKey") = ctCurrPrtn, " and RmPrtKey='" + ctCurrPrtn + "' ", "")) = "Q", _
''                                       (wRsRmDet!qIrRmQty / mIdQty), (.Value(wRmRow, "IrRmIWt") / mIdQty))
...
''' Bef 3.6.0
''             .Value(wRmRow, "IrRmIRt") = wRsRmDet!qIrStkRt + wFnlIncrVal / wRmQtyWt
        ...
        '*** (Jen 2.13)
        'wf_CustmCdPurityZ = moCn.GetFldVal("Select R.RmPurityZ from RmMst R where R.RmCd= (Select R1.RmZCd from RmMst R1 where R1.RmCd= '" + wRsRmDet!qIrRmCd + "') ")
        ...
        '.Value(wRmRow, "IrRmZPureRt") = IIF(wRsRmDet!qRmPurityZ > 0, MWLib.Div(.Value(wRmRow, "IrRmZRt"), wRsRmDet!qRmPurityZ) * wf_CustmCdPurityZ, .Value(wRmRow, "IrRmZRt"))
        '.Value(wRmRow, "IrRmZPureRt") = IIF(wRsRmDet!qRmPurityZ > 0, MWLib.Div(IIF(moCn.GetFldVal("Select RmQw from RmMst where " + _
                                         "RmCd= '" + .Value(wRmRow, "IrRmCd") + "' ") = "Q", _
                                         MWLib.Div(.Value(wRmRow, "IrRmZVal"), .Value(wRmRow, "IrRmZWt")), .Value(wRmRow, "IrRmZRt")), wRsRmDet!qRmPurityZ) * wf_CustmCdPurityZ, .Value(wRmRow, "IrRmZRt"))
        .Value(wRmRow, "IrRmZPureRt") = IIF(moCn.GetFldVal("Select RmQw from RmMst where RmPrtKey='" + ctCurrPrtn + "' And " + _
                                         "RmCd= '" + .Value(wRmRow, "IrRmCd") + "' ") = "Q", _
                                         MWLib.Div(.Value(wRmRow, "IrRmZVal"), .Value(wRmRow, "IrRmZWt")), _
        ...
        '*** (Bef 2.13) .Value(wRmRow, "IrRmZPureRt") = IIF(wRsRmDet!qRmPurityZ > 0, MWLib.Div(.Value(wRmRow, "IrRmZRt"), wRsRmDet!qRmPurityZ), .Value(wRmRow, "IrRmZRt"))
      ElseIf UCase(ms_IdTcTyp) = UCase(ctCTBTcTyp) Then
        .Value(wRmRow, "IrSrNo") = wRmRow
        .Value(wRmRow, "IrPrtKey") = ctCurrPrtn     '****** Sachin 3.02 02-01-08
        .Value(wRmRow, "IrRmCd") = wRsRmDet!qIrRmCd
        ...
        .Value(wRmRow, "IrRmZPureRt") = 0
        .Value(wRmRow, "IrMainMet") = wRsRmDet!qIrMainMet
        .Value(wRmRow, "IrPrtKey") = ctCurrPrtn '****** Sachin 3.02 31-12-07 - PrtKey added
      End If
...
Private Sub MakeLab(ByVal mExpOdTc As String, ByVal mExpOdYy As String, _
 ...
 '****Geeta***3.02 Patch******New Parameter added IdQty
  ...
  With GrdIL
    .StartCopy
    mf_StopRecalcDuringCopyIL = True
...
'      Call GrdIL_RecalcRoutine(wLabRow, UCase("IlQW"), 0, "", "")
...
'    '*** (Jen 2.12) (Bef 07/01/06)
'    If UCase(ms_IdTcTyp) = UCase(ctInTcTyp) And _
'       moCn.RecSeek("Select 'x' from Param where PTyp= 'LABSCD' and " + _
'       "PMCd= '" + ctBrkLMCd + "' and PSCd= '" + ctBrkLSCd + "'") Then
'      .StartCopy
'      .AddItem
'      wLabRow = .Rows - 1
'      .Value(wLabRow, "iLSrNo") = wLabRow
'      .Value(wLabRow, "iLMCd") = ctBrkLMCd
'      .Value(wLabRow, "iLSCd") = ctBrkLSCd
'      .Value(wLabRow, "iLQty") = 1
'      .Value(wLabRow, "iLARt") = 0
'      .Value(wLabRow, "ilQw") = "Q"
'      '.Value(wLabRow, "iLiRt") = 0
'      '.Value(wLabRow, "iLZRt") = 0
'      '.Value(wLabRow, "iLZVal") = 0
'      .SaveRec (wLabRow)
'      .EndCopy
'    End If
'    '*** (Jen 2.12) (Bef 07/01/06)
    ...
    '*** (Bef 2.13) Remove 'Local Inv' Check
    '************Geeta*****Emr208******22/11/04**
    'Dim wf_AddLab As Double
    'Dim wf_RmZVal As Double, wf_LZVal As Double
    'wf_RmZVal = moCn.GetFldVal("Select sum(IrRmZVal+IrSetZVal) from InvRm " + _
    '            "where IrCoCd= '" + gs_CoCd + "' and " + _
    '            "IrTc= '" + ADC("wIdTc") + "' and IrYy= '" + ADC("wIdYy") + "' and " + _
    ...
    '            "IlTc= '" + ADC("wIdTc") + "' and IlYy= '" + ADC("wIdYy") + "' and " + _
    '            "IlChr= '" + ADC("wIdChr") + "' and IlNo= " + CStr(ADC("wIdNo")) + " and " + _
    '            "IlSr= " + CStr(GrdID.Value(GrdID.Row, "IdSr")))
    '
    'wf_AddLab = GrdID.Value(GrdID.Row, "IdIFOB") - (wf_RmZVal + wf_LZVal + GrdID.Value(GrdID.Row, "IdZAdd"))
    '
    '
    'If mLocalExp = "Y" And Round(wf_AddLab, 3) <> 0 Then
    '  .StartCopy
    '  .AddItem
    '  wLabRow = .Rows - 1
    '  .Value(wLabRow, "iLSrNo") = wLabRow
    ...
    '  .Value(wLabRow, "iLARt") = 0
    '  .Value(wLabRow, "iLiRt") = 0
    '  .Value(wLabRow, "iLZRt") = wf_AddLab
    '  .Value(wLabRow, "ilQw") = "Q"
    '  .Value(wLabRow, "iLZVal") = wf_AddLab
    '  .SaveRec (wLabRow)
    '  .EndCopy
    'End If
    '*** (Bef 2.13) Remove 'Local Inv' Check
  ...
  For i = 1 To GrdIR.Rows - 1
    If Not GrdIR.IsDel(i) Then
      ...
      wWt = IIF(((InStr(1, wBigStr, "," + wRmCtg + ",") <> 0) And _
            wRmCtg <> wMainMetRmCtg And wRmCtg <> "G" And wRmCtg <> "P" And wRmCtg <> "S" And wRmCtg <> "L") _
...
Private Sub GetLabAsWt(ByVal mIdRow As Double, ByVal mTypeList As String, _
  ...
  For i = 1 To GrdIR.Rows - 1
    If Not GrdIR.IsDel(i) Then
      ...
      wWt = IIF((InStr(1, wBigStr, "," + wRmCtg + ",") <> 0), _
            GrdIR.Value(i, "IrRmAWt"), 0)
...
Private Sub DsgSalHst(ByVal ps_DmCd As String)
  ...
  wSqlStr = "Set DateFormat DMY " & vbCrLf & "Select Top 5 IdCoCd, IdTc, IdYy, IdChr, IdNo, IdSr, InDt As IdDt, IdExpCmCd, IdKt, OdDmCol," & _
...
Private Sub SetZAddLab(ByVal pf_IdRow As Single)
  ...
  '*** (Jen 2.12) 02/02/06
End Sub
Private Function GetDCRmVal(ByVal fs_IdName As String, Optional ByVal fi_DelRow As Variant, Optional ByVal fs_RmCtg As String) As Double
  ...
  For wi_i = 1 To GrdIR.Rows - 1
    ...
    If fs_RmCtg <> "" Then
      If ws_RmCtg = fs_RmCtg And Not (GrdIR.IsDel(wi_i)) And wi_i <> wi_DelRow Then _
        ...
        For wi_R = 1 To .Rows - 1
          If .Value(wi_R, "IrPrtKey") = ctCurrPrtn Then
            ...
            If ws_RmCtg = "G" Then
              ...
              .Value(wi_R, "IrRmIRt") = GetGldRt(GrdID.Value(wi_D, "IdExpCmCd"), adc("wIdLmgSal"), _
            ...
            ElseIf ws_RmCtg = "P" Then
              ...
              .Value(wi_R, "IrRmIRt") = GetGldRt(GrdID.Value(wi_D, "IdExpCmCd"), adc("wIdLmpSal"), _
                                      .Value(wi_R, "IrRmCd"), .Value(wi_R, "IrAlySalRt"), "DM", GrdID.Value(wi_D, "IdDmCd"), "S", "C", , adc("wIdCmCurCd"), _
                                      IIF(wOmLkUpRmRt <> "", wOmLkUpRmRt, ""), IIF(wOmLkUpMetLs <> "", wOmLkUpMetLs, ""))
              .Value(wi_R, "IrRmZRt") = .Value(wi_R, "IrRmIRt")
            ...
            ElseIf ws_RmCtg = "S" Then
              If mSlvMod = True Then
                .Value(wi_R, "IrRmIRt") = GetGldRt(GrdID.Value(wi_D, "IdExpCmCd"), adc("wIdLmsSal"), _
                                        .Value(wi_R, "IrRmCd"), .Value(wi_R, "IrAlySalRt"), "DM", GrdID.Value(wi_D, "IdDmCd"), "S", "C", , adc("wIdCmCurCd"), _
                                        IIF(wOmLkUpRmRt <> "", wOmLkUpRmRt, ""), IIF(wOmLkUpMetLs <> "", wOmLkUpMetLs, ""))
              Else
            ...
            ElseIf ws_RmCtg = "L" Then
              If mb_PdMod = True Then
                .Value(wi_R, "IrRmIRt") = GetGldRt(GrdID.Value(wi_D, "IdExpCmCd"), adc("wIdLmlSal"), _
                                        .Value(wi_R, "IrRmCd"), .Value(wi_R, "IrAlySalRt"), "DM", GrdID.Value(wi_D, "IdDmCd"), "S", "C", , adc("wIdCmCurCd"), _
                                        IIF(wOmLkUpRmRt <> "", wOmLkUpRmRt, ""), IIF(wOmLkUpMetLs <> "", wOmLkUpMetLs, ""))
              Else
                .Value(wi_R, "IrRmIRt") = 0
            ...
            ElseIf ws_RmCtg = "X" Then
              ...
              If GetRmRt(GrdID.Value(wi_D, "IdExpCmCd"), .Value(wi_R, "IrRmCd"), 0, 0, 0, "S", wf_BaseLmeOrd, , , , , adc("wIdCmCurCd"), IIF(wOmLkUpRmRt <> "", wOmLkUpRmRt, "")) <> _
                 GetRmRt(GrdID.Value(wi_D, "IdExpCmCd"), .Value(wi_R, "IrRmCd"), 0, 0, 0, "S", wf_BaseLmeInv, , , , , adc("wIdCmCurCd"), IIF(wOmLkUpRmRt <> "", wOmLkUpRmRt, "")) Then
                  .Value(wi_R, "IrRmIRt") = GetRmRt(GrdID.Value(GrdID.Row, "IdExpCmCd"), .Value(wi_R, "IrRmCd"), 0, 0, 0, "S", wf_BaseLmeInv, , , , , adc("wIdCmCurCd"), IIF(wOmLkUpRmRt <> "", wOmLkUpRmRt, ""))
                  .Value(wi_R, "IrRmZRt") = .Value(wi_R, "IrRmIRt")
              End If

      ...
      Begin TabDlg.SSTab TAB_REP 
         ...
         Begin VB.Frame fra_tabrep 
            ...
            Begin MwfCtl.MWCTL_MED atxt 
               ...
               DataType        =   4
               DataField       =   "UOBAGTYP"
               ReCalcParent    =   "UOBCHRFR,UOBCHRTO,UOBCHRSEL,UOBCHR2FR,UOBCHR2TO,UOBCHR2SEL"
               IdName          =   "UOBAGTYP"
            End
            Begin MwfCtl.MWCTL_MED atxt 
               Height          =   285
...
Private Sub SetGroupSort()
 ...
 '4.1.4
    wTdRate = " (Case When RSCtg.PValue1='N' Then " + RmRate("RrCstRt", "TdRmSz", "RmQwCst") + " Else TdRmStkRt End)"
    wFrRate = " (Case When RSCtg.PValue1='N' Then " + RmRate("RrCstRt", "FrRmSz", "RmQwCst") + " Else FrRmStkRt End)"
    wBkDtRate = " (Case When RSCtg.PValue1='N' Then " + RmRate("RrCstRt", "TR.TdRmSz", "RmQwCst") + " Else TR.TdRmStkRt End)"
  GRP_REP.Add "(RmCd) Stk-CstRt", Array("TdRmCd+ Str(" + wTdRate + ", 9, 2)", "FrRmCd+ Str(" + wFrRate + ", 9, 2)", "FrRmCd+ Str(" + wFrRate + ", 9, 2)", "TR.TdRmCd+ Str(" + wBkDtRate + ", 9, 2)"), Array("'('+TdRmCd+') '+LTrim(str(" + wTdRate + ",9,2))", "'('+FrRmCd+') '+LTrim(str(" + wFrRate + ",9,2))", "'('+FrRmCd+') '+LTrim(str(" + wFrRate + ",9,2))", "'('+Str(" + wBkDtRate + ",9,2)+') '+LTrim(str(" + wBkDtRate + ",9,2))"), "", "", "Rm Ctg,Rm SubCtg,Rm Code,BaseCd + RmCd,(RmCd) Sv/Sz,Rm Sv/Sz,Rm Ptr,Rm SaleRt", "", "", " '('+ RTrim(RmCtg)+ '/'+ RmSCtg+')' "
    ...
    wTdRate = " (Case When RSCtg.PValue1='N' Then " + RmRate("RrSalRt", "TdRmSz", "RmQw") + " Else TdRmStkRt End)"
    wFrRate = " (Case When RSCtg.PValue1='N' Then " + RmRate("RrSalRt", "FrRmSz", "RmQw") + " Else FrRmStkRt End)"
    wBkDtRate = " (Case When RSCtg.PValue1='N' Then " + RmRate("RrSalRt", "TR.TdRmSz", "RmQw") + " Else TR.TdRmStkRt End)"
  GRP_REP.Add "(RmCd) Stk-SalRt", Array("TdRmCd+ Str(" + wTdRate + ", 9, 2)", "FrRmCd+ Str(" + wFrRate + ", 9, 2)", "FrRmCd+ Str(" + wFrRate + ", 9, 2)", "TR.TdRmCd+ Str(" + wBkDtRate + ", 9, 2)"), Array("'('+TdRmCd+') '+LTrim(str(" + wTdRate + ",9,2))", "'('+FrRmCd+') '+LTrim(str(" + wFrRate + ",9,2))", "'('+FrRmCd+') '+LTrim(str(" + wFrRate + ",9,2))", "'('+Str(" + wBkDtRate + ",9,2)+') '+LTrim(str(" + wBkDtRate + ",9,2))"), "", "", "Rm Ctg,Rm SubCtg,Rm Code,BaseCd + RmCd,(RmCd) Sv/Sz,Rm Sv/Sz,Rm Ptr,Rm SaleRt", "", "", " '('+ RTrim(RmCtg)+ '/'+ RmSCtg+')' "
    ...
    wTdRate = RmRate("RrCstRt", "TdRmSz", "RmQwCst")
    wFrRate = RmRate("RrCstRt", "FrRmSz", "RmQwCst")
    wBkDtRate = RmRate("RrCstRt", "TR.TdRmSz", "RmQwCst")
  GRP_REP.Add "(RmCd) CostRt", Array("TdRmCd+ Str(" + wTdRate + ", 9, 2)", "FrRmCd+ Str(" + wFrRate + ", 9, 2)", "FrRmCd+ Str(" + wFrRate + ", 9, 2)", "TR.TdRmCd+ Str(" + wBkDtRate + ", 9, 2)"), Array("'('+TdRmCd+') '+LTrim(str(" + wTdRate + ",9,2))", "'('+FrRmCd+') '+LTrim(str(" + wFrRate + ",9,2))", "'('+FrRmCd+') '+LTrim(str(" + wFrRate + ",9,2))", "'('+Str(" + wBkDtRate + ",9,2)+') '+LTrim(str(" + wBkDtRate + ",9,2))"), "", "", "Rm Ctg,Rm SubCtg,Rm Code,BaseCd + RmCd,(RmCd) Sv/Sz,Rm Sv/Sz,Rm Ptr,Rm CostRt", "", "", " '('+ RTrim(RmCtg)+ '/'+ RmSCtg+')' "
    ...
    wTdRate = RmRate("RrSalRt", "TdRmSz", "RmQw")
    wFrRate = RmRate("RrSalRt", "FrRmSz", "RmQw")
    wBkDtRate = RmRate("RrSalRt", "TR.TdRmSz", "RmQw")
...
'  From Bag, Txnd, Txn, RmMst, RmRt, DsgMst, Param, OrdDsg where 1= 2
  ...
  If gs_Partition = ctCurrPrtn And gs_PurgeDt <> "01/01/80" And _
      ...
      CDate(adc("UOASOFDT")) <= CDate(gs_PurgeDt) And CDate(adc("UoAsOfDt")) <> MWLib.EmptyDate) Then
      DispMsg "From/To/As Of Date Can Be Either [01/01/80] Or Greater Than Purge Date [" + CStr(gs_PurgeDt) + "]", etError: Exit Sub
...
'  End If
 ...
 If UCase(adc("UoYN3")) = UCase("Y") Then
  ...
  If UCase(adc("UoPMCdFr")) = "STKVAL" Then
    ...
    'wTdRate = " TdRmStkRt " + " as qCalcRt "
    'wFrRate = " FrRmStkRt as qCalcRt "
    'wBkDtRate = " TR.TdRmStkRt as qCalcRt "
    
    '4.1.4
    wTdRate = IIF(UCase(adc("UoPMCdTo")) = "CSTVAL", " (Case When RSCtg.PValue1='N' Then " + RmRate("RrCstRt", "TdRmSz", "RmQwCst") + " Else TdRmStkRt End)", _
                IIF(UCase(adc("UoPMCdTo")) = "SALVAL", " (Case When RSCtg.PValue1='N' Then " + RmRate("RrSalRt", "TdRmSz", "RmQw") + " Else TdRmStkRt End)", " TdRmStkRt ")) + " as qCalcRt "

    wFrRate = IIF(UCase(adc("UoPMCdTo")) = "CSTVAL", " (Case When RSCtg.PValue1='N' Then " + RmRate("RrCstRt", "FrRmSz", "RmQwCst") + " Else FrRmStkRt End)", _
                IIF(UCase(adc("UoPMCdTo")) = "SALVAL", " (Case When RSCtg.PValue1='N' Then " + RmRate("RrSalRt", "FrRmSz", "RmQw") + " Else FrRmStkRt End)", " FrRmStkRt ")) + " as qCalcRt "    '" FrRmStkRt as qCalcRt "
                
    wBkDtRate = IIF(UCase(adc("UoPMCdTo")) = "CSTVAL", " (Case When RSCtg.PValue1='N' Then " + RmRate("RrCstRt", "TR.TdRmSz", "RmQwCst") + " Else TR.TdRmStkRt End)", _
                IIF(UCase(adc("UoPMCdTo")) = "SALVAL", " (Case When RSCtg.PValue1='N' Then " + RmRate("RrSalRt", "TR.TdRmSz", "RmQw") + " Else TR.TdRmStkRt End)", " TR.TdRmStkRt ")) + " as qCalcRt "    '" TR.TdRmStkRt as qCalcRt "
    ...
    '*** (Bef 05/05/07)
    ''****** Sachin 2.13.0 - 05/06/2006 - Stock Value to be considered always Weight Wise ******
    'GRP_REP.SetFormula Rep, "wRmVal", " If Round({@wPureWt}, 3)<> 0 Then {@wPureWt}* {rdo.TdRmStkRt} Else {@wRmWt}*{rdo.TdRmStkRt}"
    ''****** Sachin 2.13.0 - 05/06/2006 - Stock Value to be considered always Weight Wise ******
    '*** (Bef 05/05/07)
    
    '*** (Jen 2.13 05/05/07)
    'GRP_REP.SetFormula Rep, "wRmVal", "{rdo.TdRmWt}* {rdo.qMul}* {rdo.TdRmStkRt}"
    GRP_REP.SetFormula Rep, "wRmVal", "{rdo.TdRmWt}* {rdo.qMul}* {rdo.qCalcRt}"
    '*** (Jen 2.13 05/05/07)
    
  ElseIf UCase(adc("UoPMCdFr")) = "CSTVAL" Then
    wTdRate = RmRate("RrCstRt", "TdRmSz", "RmQwCst") + " as qCalcRt "
    wFrRate = RmRate("RrCstRt", "FrRmSz", "RmQwCst") + " as qCalcRt "
    wBkDtRate = RmRate("RrCstRt", "TR.TdRmSz", "RmQwCst") + " as qCalcRt "    '*** (Jen 2.14)
    Rep.TxtValTyp.SetText "(Value = Cost)"
    Rep.hTdRmStkRt.SetText "Cost Rt"
    
'    If Round(adc("UoPrc"), 3) = 0 Then
'      GRP_REP.SetFormula Rep, "wRmVal", "If Round({@wPureWt}, 3)<> 0 then {@wPureWt}* {rdo.qCalcRt} Else {@wRmWt}* {rdo.qCalcRt}"
'    Else
'      GRP_REP.SetFormula Rep, "wRmVal", "If Round({@wPureWt}, 3)<> 0 then {@wPureWt}* {rdo.qCalcRt}+ {@wPureWt}* {rdo.qCalcRt}* " + CStr(adc("UoPrc")) + "/ 100 Else {@wRmWt}* {rdo.qCalcRt}+ {@wRmWt}* {rdo.qCalcRt}* " + CStr(adc("UoPrc")) + "/ 100  "
'    End If
    If Round(adc("UoPrc"), 3) = 0 Then
      'GRP_REP.SetFormula Rep, "wRmVal", "(IF UpperCase({rdo.RmQW}) = UpperCase(""Q"") AND UpperCase({rdo.RmCtg}) = UpperCase(""X"") Then {@wRmQty} Else (If Round({@wPureWt}, 3)<> 0 then {@wPureWt} Else {@wRmWt})) * {rdo.qCalcRt}"
      'GRP_REP.SetFormula Rep, "wRmVal", "(IF UpperCase({rdo.RmQWCst}) = UpperCase(""Q"") Then {@wRmQty} Else (If Round({@wPureWt}, 3)<> 0 then {@wPureWt} Else {@wRmWt})) * {rdo.qCalcRt}"
      ' ***** Manali 3.9.0 - For 'X' RmCtg GmWt considered for deriving value
    ...
    Else
      'GRP_REP.SetFormula Rep, "wRmVal", "(IF UpperCase({rdo.RmQW}) = UpperCase(""Q"") AND UpperCase({rdo.RmCtg}) = UpperCase(""X"") Then {@wRmQty} Else (If Round({@wPureWt}, 3)<> 0 then {@wPureWt} Else {@wRmWt})) * {rdo.qCalcRt} * (1 + (" + CStr(adc("UoPrc")) + "/ 100))"
      'GRP_REP.SetFormula Rep, "wRmVal", "(IF UpperCase({rdo.RmQWCst}) = UpperCase(""Q"") Then {@wRmQty} Else (If Round({@wPureWt}, 3)<> 0 then {@wPureWt} Else {@wRmWt})) * {rdo.qCalcRt} * (1 + (" + CStr(adc("UoPrc")) + "/ 100))"
      ' ***** Manali 3.9.0 - For 'X' RmCtg GmWt considered for deriving value
...
'    Set adc.RepSource = Rep
    wTdRate = RmRate("RrSalRt", "TdRmSz", "RmQw") + " as qCalcRt "
    wFrRate = RmRate("RrSalRt", "FrRmSz", "RmQw") + " as qCalcRt "
    wBkDtRate = RmRate("RrSalRt", "TR.TdRmSz", "RmQw") + " as qCalcRt "   '*** (Jen 2.14)
...
'    End If
    If Round(adc("UoPrc"), 3) = 0 Then
      'GRP_REP.SetFormula Rep, "wRmVal", "(IF UpperCase({rdo.RmQW}) = UpperCase(""Q"") AND UpperCase({rdo.RmCtg}) = UpperCase(""X"") Then {@wRmQty} Else (If Round({@wPureWt}, 3)<> 0 then {@wPureWt} Else {@wRmWt})) * {rdo.qCalcRt}"
      'GRP_REP.SetFormula Rep, "wRmVal", "(IF UpperCase({rdo.RmQW}) = UpperCase(""Q"") Then {@wRmQty} Else (If Round({@wPureWt}, 3)<> 0 then {@wPureWt} Else {@wRmWt})) * {rdo.qCalcRt}"
      ' ***** Manali 3.9.0 - For 'X' RmCtg GmWt considered for deriving value
    ...
    Else
      'GRP_REP.SetFormula Rep, "wRmVal", "(IF UpperCase({rdo.RmQW}) = UpperCase(""Q"") AND UpperCase({rdo.RmCtg}) = UpperCase(""X"") Then {@wRmQty} Else (If Round({@wPureWt}, 3)<> 0 then {@wPureWt} Else {@wRmWt})) * {rdo.qCalcRt} * (1 + (" + CStr(adc("UoPrc")) + "/ 100))"
      'GRP_REP.SetFormula Rep, "wRmVal", "(IF UpperCase({rdo.RmQW}) = UpperCase(""Q"") Then {@wRmQty} Else (If Round({@wPureWt}, 3)<> 0 then {@wPureWt} Else {@wRmWt})) * {rdo.qCalcRt} * (1 + (" + CStr(adc("UoPrc")) + "/ 100))"
      ' ***** Manali 3.9.0 - For 'X' RmCtg GmWt considered for deriving value
...
'''                        " " + ws_AddFgCnd + ") "
      ...
      ' ***** Manali FgRm Speed
      ws_AddFgCnd = " and (FdYy + STR(FdKey, 7)) = (Select max(FdYy + STR(FdKey, 7)) from Fgd Fd1 " + _
                    "   Where Fd1.FdBIdNo=FdMax.FdBIdNo and Fd1.FdCoCd = FdMax.FdCoCd And Fd1.FdBYy = FdMax.FdBYy And Fd1.FdBChr = FdMax.FdBChr " + _
                    "   and Fd1.FdBNo= FdMax.FdBNo " + IIF(gs_Partition = ctCurrPrtn, " and Fd1.FdPrtKey=FdMax.FdPrtKey ", "") + _
                        IIF(adc("UoDtFr") = "01/01/80", " ", " and Fd1.FdDt>= '" + CStr(adc("UoDtFr")) + "' ") + _
                        IIF(adc("UoDtTo") = "01/01/80", " ", " and Fd1.FdDt<= '" + CStr(adc("UoDtTo")) + "' ") + _
...
'    Rep.TxtLocFr.SetText "PFG"
 ...
 ' **** Zubin 211 **** '
 'Uma *** blank <> 'D'
 'IG.88-BChrTo & Sel added in Param Join to get BChr list
...
' "TdRmWt * (Case when RmCtg in ('G', 'P', 'S', 'L', 'M') then RmPurityWt when RmCtg= 'X' then RmBasePurityWt else 0 end)" + wPurityWt + " as qGldWt, "
     ...
     wSqlStrg1 = wSqlStrg1 + " Left Outer Join Param SCls on SCls.PTyp= 'STNCLS' and SCls.PmCd= RmCtg and ',' + SCls.PDesc225 + ',' like '%,'+ RmSCtg +',%' " + _
...
'"FrRmWt * (Case when RmCtg in ('G', 'P', 'S', 'L', 'M') then RmPurityWt when RmCtg= 'X' then RmBasePurityWt else 0 end)" + wPurityWt + " as qGldWt, "
       wSqlStrg2 = wSqlStrg2 + " Left Outer Join Param SCls on SCls.PTyp= 'STNCLS' and SCls.PmCd= RmCtg and ',' + SCls.PDesc225 + ',' like '%,'+ RmSCtg +',%' " + _
                "Left Outer Join RmRt On RrTcTyp= 'RSZ' and RrCmCtg= 'C' And RrCmCd= '" + ctSelfCmCd + "' And RrCtg= RmCtg And RrSCtg= RmSCtg and RrSTWGrp= '' and RrCd= '' and RrDmCtg= '' and " + _
  ...
  ElseIf UCase(adc.MenuCd) = UCase("RepWipBRmBkDt") Then
    ...
    wSqlStrg3 = "Select " + grpflds2 + ", " + _
                ...
                "from (Select BPrtKey, BIdNo, BCoCd, BYy, BChr, BNo, BDmIdNo, BOdDmCd, BOdDmSz, BOdIdNo, BOdTc, BOdYy, BOdChr, BOdNo, BOdSr, BOpnDt, " + _
                ...
                "Join DsgMst on DmIdNo=BDmIdNo and DmTcTyp= 'DM' and DmCd= BOdDmCd and DmSz= '' " + IIF(gs_Partition = ctCurrPrtn, " and DmPrtKey=BPrtKey ", "")
    ...
    wSqlStrg3 = wSqlStrg3 + _
                ...
                "Join Txn T on TIdNo=TR.TdTIdNo and TCoCd= TR.TdCoCd and TTc= TR.TdTc and TYy= TR.TdYy and TChr= TR.TdChr and TNo= TR.TdNo " + IIF(gs_Partition = ctCurrPrtn, " and TPrtKey=TR.TdPrtKey ", "")
    '(09/01/07)
    '*** ***
    ...
    wSqlStrg3 = wSqlStrg3 + _
                ...
                "       SubString(max(FdYy + Str(FdKey, 10, 0) + FgToBLoc), 13, 5) As qBLoc " + _
                ...
                "left Outer Join Param SCls on SCls.PTyp= 'STNCLS' and SCls.PmCd= RmCtg and ',' + SCls.PDesc225 + ',' like '%,'+ RmSCtg +',%' " + _
  ...
  '*** Jay 2.13(CT) ***
  'Uma *** blank <> 'D'
  'IG.88-BChr To & Sel added in Bag Chr range to show in report
  If adc("UoBagTyp") = "F" Then
    'Rep.TxtBagTypAndChr.SetText "(Flute Bags" & IIF(adc("UoBChr2Fr") <> "", ",  Chr = " & adc("UoBChr2Fr"), "") & ")"
  ...
  ElseIf adc("UoBagTyp") = "P" Then
    'Rep.TxtBagTypAndChr.SetText "(Primary Bags" & IIF(adc("UoBChr") <> "", ",  Chr = " & adc("UoBChr"), "") & ")"
  ...
  ElseIf adc("UoBagTyp") = "C" Then
    'Rep.TxtBagTypAndChr.SetText "(Component Bags" & IIF(adc("UoBChr") <> "", ",  Chr = " & adc("UoBChr"), "") & ")"
  ...
  ElseIf adc("UoBagTyp") = "D" Then
    'Rep.TxtBagTypAndChr.SetText "(PD Bags" & IIF(adc("UoBChr") <> "", ",  Chr = " & adc("UoBChr"), "") & ")"
  ...
  'if it is NO stock rate is invisible in report
...
'  If pv_NewValue = "" Then adc("UoBChr2Fr") = "":         adc("UoBChr2To") = "":      adc("UoBChr2Sel") = ""
...
Private Sub ATXT_FldWhen(Index As Integer, ByVal IdName As String, Cancel As Boolean, ErrMsg As String)
  ...
  '*** (Jen 2.11)
  Select Case UCase(IdName)
    'IG.88- BChr TO & Sel for help added
...
Private Sub atxt_ReCalculate(Index As Integer, ByVal IdName As String, ByVal OldVal As Variant, ByVal RowNum As Integer, ByVal SourceName As String, ByVal SourceColName As String)
  ' **** Zubin 211 **** '
  Select Case UCase(IdName)
'    Case Is = UCase("UoBChr2Fr"), UCase("UoBChr2To"), UCase("UoBChr2Sel")
'      'If ADC("UoBagTyp") = "N" Then
'      adc("UoBChr2Fr") = ""
'      adc("UoBChr2To") = ""
'      adc("UoBChr2Sel") = ""
    Case Is = UCase("UoBChr2Fr")
      If adc("UoBagTyp") = "" Then adc("UoBChr2Fr") = ""

...
Begin VB.Form EmrFrmCustmMatch 
   ...
   Begin VB.Frame FRA_NKEYS 
      ...
      Begin VB.Frame FraNKeyAll 
         ...
         Begin MwfCtl.MWCTL_FLX GrdTxndZ 
            ...
            recalcparent2   =   $"EmrFrmCustmMatch.frx":0000
            maxlength2      =   22
   ...
   End
End
Attribute VB_Name = "EmrFrmCustmMatch"
...
'  ms_FutureDt = moCn.GetFldVal("Select PDesc225 from Param where PTyp= 'LOCKDT' and PMCd= 'FUTUREDT'")
  ...
  Call GetLockDt(gs_CoCd, "TC", ctInTcTyp, ms_LockDt, ms_FutureDt)
...
Private Sub ADC_NonKeyValid(pr_Cancel As Boolean, pr_ErrMsg As String)
  ...
  End If
  '6.1
  If moCn.RecSeek(" Select 'x' Where Cast('" + CStr(ADC("WIZDT")) + "'  as smalldatetime) > '" + IIF(UCase(MWLib.DtSetting) = "MM/DD/YY", "02/20/15", "20/02/15") + "'") Then
  ...
  With GrdTxndZ
    ...
    Case Is = UCase("wTzBaseVchNo")
      ...
      Cancel = Not moCn.RecSeek("Select TzTc from TxndZ where " + _
                 ...
                 IIF(GrdTxndZ.Mode = fgmnorm Or GrdTxndZ.Mode = fgmCopy, " and TzRmZCd='" + GrdIZ.Value(GrdIZ.Row, "IzRmZCd") + "' and TzCls='N' ", ""))
      
      ' ***** Manali 3.5.0 - 07/11/08 - added [TzCls = 'N']
      If Cancel = True Then ErrMsg = "Invalid Base Voucher Number Or Voucher is Closed or Voucher not valid for this RmCd": Exit Sub
...
End Sub
Private Sub DispFra(ByVal pv_InvZFra As en_InvZFra)
  ...
  End Select
End Sub
Private Sub EnaDisaCmds(ByVal pv_ShowFra As Boolean, Optional ByVal pv_CmdBut As MWCTL_BTN1, Optional ByVal pv_InvZFra As en_InvZFra)

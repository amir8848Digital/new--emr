...
Begin VB.Form EmrFrpCustAly 
   ...
   Begin VB.Frame fra_nkeys 
      ...
      Begin TabDlg.SSTab TAB_REP 
         ...
         TabPicture(0)   =   "EmrFrpCustAly.frx":0000
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "fra_tabrep(0)"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "&Group Sort"
         TabPicture(1)   =   "EmrFrpCustAly.frx":001C
         ...
         Begin VB.Frame fra_tabrep 
            ...
            Begin MwfCtl.MWCTL_MED atxt 
               ...
               Left            =   1215
               TabIndex        =   3
               ToolTipText     =   "Enter For Raw Material Category"
               Top             =   1215
               Width           =   465
               _ExtentX        =   820
               _ExtentY        =   503
   ...
   End
End
Attribute VB_Name = "EmrFrpCustAly"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Rep As New EmrRepCustAly
...
Private Sub SetGroupSort()
  ...
  GRP_REP.Add "Customer", "CmCd", "", "CmCd", "hCmCd", "Alloy Cd", "", "", "case when (Select PNum from Param where Ptyp = 'USR' and PmCd = '" + Trim(gs_UsrCd) + "')  <= 5 then  CmName else CmCd end"
  'GRP_REP.Add "Customer", "CmCd", "", "CmCd", "hCmCd", "Alloy Cd", "", "", "case when (Select PNum from Param where Ptyp = 'USR' and PmCd = '" + Trim(EmrFrmMDI.TXT_UCD.text) + "')  <= 5 then  CmName else CmCd end"
  GRP_REP.Add "Rm SubCtg", "RmSCtg", "", "RmSCtg", "hRmSCtg", "", "", "", "(Select PDesc From Param Where PTyp= 'RMSCTG' and PMCd = RmCtg and PSCd= RmSCtg)"
  GRP_REP.Add "Rm Code", "RmSCtg+RmCd", "'('+ RmSCtg+ ') '+ RmCd", "RmSCtg,RmCd", "hRmSCtg,hRmCd", "Rm SubCtg", "", "", "SubString(RmDesc, 1, 30) "
  GRP_REP.Add "Alloy Cd", "CaAlyCd", "", "CaAlyCd", "hCaAlyCd", "Rm Ctg,Rm SubCtg,Rm Code", "", "", "(Select SubString(RmDesc, 1, 30) From RmMst Where " + IIF(gs_Partition = ctCurrPrtn, " RmPrtKey='" + ctCurrPrtn + "' and ", "") + " RmCd= CaAlyCd)"
  GRP_REP.Add "Dsg Colour", "CaDmCol", "", "CaDmCol", "hCaDmCol", "", "", "", "(Select PDesc From Param Where PTyp= 'RMCOL' and PMCd = CaDmCol)"
End Sub
...
On Error GoTo RepErr
  ...
  'CmCtg , CmCd, CaRmCd, CaDmCol, CaAlyCd
  'From CustAly, CustMst, RmMst Where 1 = 2
  '*** Report Sql ***
  ...
  '### RmCtg Should Be Only 'G' or 'P' (Check To Be Put In Trigger)
  wSqlStrg = "Select " + grpflds + ", " + _
             "CmCtg, CmCd, CaRmCd, CaDmCol, CaAlyCd " + _
             "from CustAly join CustMst on CmCtg= CaCtg and CmCd= CaCd " + _
             "join RmMst on " + IIF(gs_Partition = ctCurrPrtn, " RmPrtKey='" + ctCurrPrtn + "' and ", "") + " RmCd= CaRmCd where CmCtg= 'C' " + wCnd
  adc.RepRecSource = wSqlStrg + ctMaxDopOpt  '****** Sachin 3.01 ctMaxDopOpt added
  '578.19 calling function to change Rmcode font size
  GRP_REP.SetFormula Rep, "wRmCdFontSz", GetRmcdFontSz("{rdo.CaRmCd}", 8)
  GRP_REP.SetFormula Rep, "wRmCdFontSz", GetRmcdFontSz("{rdo.CaAlyCd}", 8)

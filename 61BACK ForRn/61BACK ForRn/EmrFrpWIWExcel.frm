...
'*** Jay 2.13(CT) ***
  ...
  ' ****** Manali 3.5.0 - 19/11/08 - Check Boxes added
  If adc("UoYN8") = "Y" Then ChkBoxArr(8).Value = Checked Else ChkBoxArr(8).Value = Unchecked   '6.1-23
...
On Error GoTo Err_Hndlr:
  ...
  Dim wSrcFile As String, wTgtFile As String, wFileNm As String
  ...
  With wRsExcel
    ...
    Do While Not (wRsExcel.EOF Or wRsExcel.BOF)
      ...
      oSheet.Cells(n, 3) = wRsExcel!DmTcTyp
      oSheet.Cells(n, 4) = wRsExcel!OdDmCd
      oSheet.Cells(n, 5) = wRsExcel!qCustDmCd
      oSheet.Cells(n, 6) = wRsExcel!OmDt
      oSheet.Cells(n, 7) = wRsExcel!OmCmCd
      oSheet.Cells(n, 8) = wRsExcel!OdPrtCd
      oSheet.Cells(n, 9) = wRsExcel!OdKt
      oSheet.Cells(n, 10) = wRsExcel!OdDelDt
      oSheet.Cells(n, 11) = wRsExcel!OdSfx
      oSheet.Cells(n, 12) = wRsExcel!OdDmSz
      oSheet.Cells(n, 13) = wRsExcel!DmCtg
      oSheet.Cells(n, 14) = wRsExcel!OdDmCol
      oSheet.Cells(n, 15) = wRsExcel!OdPicNm
      oSheet.Cells(n, 16) = wRsExcel!qUniqRmCd
      oSheet.Cells(n, 17) = wRsExcel!OdPrdSeq
      oSheet.Cells(n, 18) = wRsExcel!OdOrdQty
      oSheet.Cells(n, 19) = wRsExcel!qBalQty
      oSheet.Cells(n, 20) = wRsExcel!qFlrQty
      oSheet.Cells(n, 21) = wRsExcel!qHsQty
      oSheet.Cells(n, 22) = wRsExcel!qhHs
      oSheet.Cells(n, 23) = wRsExcel!qWsQty
      oSheet.Cells(n, 24) = wRsExcel!qhWs
      oSheet.Cells(n, 25) = wRsExcel!qQty1
      oSheet.Cells(n, 26) = wRsExcel!qQty2
      oSheet.Cells(n, 27) = wRsExcel!qQty3
      oSheet.Cells(n, 28) = wRsExcel!qQty4
      oSheet.Cells(n, 29) = wRsExcel!qQty5
      oSheet.Cells(n, 30) = wRsExcel!qQty6
      oSheet.Cells(n, 31) = wRsExcel!qQty7
      oSheet.Cells(n, 32) = wRsExcel!qQty8
      oSheet.Cells(n, 33) = wRsExcel!qQty9
      oSheet.Cells(n, 34) = wRsExcel!qQty10
      oSheet.Cells(n, 35) = wRsExcel!qQty11
      oSheet.Cells(n, 36) = wRsExcel!OdSalRem
      oSheet.Cells(n, 37) = wRsExcel!qDetPos
      oSheet.Cells(n, 38) = wRsExcel!qDispSalRemYN
      oSheet.Cells(n, 39) = wRsExcel!qColNm
      oSheet.Cells(n, 40) = wRsExcel!qColCrCd
      oSheet.Cells(n, 41) = wRsExcel!qAppColYN
      oSheet.Cells(n, 42) = wRsExcel!qOmColCrCd
      oSheet.Cells(n, 43) = wRsExcel!qSec
      oSheet.Cells(n, 44) = wRsExcel!vPValue1

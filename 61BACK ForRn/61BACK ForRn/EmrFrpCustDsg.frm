...
Begin VB.Form EmrFrpCustDsg 
   ...
   Begin VB.Frame fra_nkeys 
      ...
      Begin TabDlg.SSTab TAB_REP 
         ...
         TabPicture(0)   =   "EmrFrpCustDsg.frx":0000
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "fra_tabrep(0)"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "&Group Sort"
         TabPicture(1)   =   "EmrFrpCustDsg.frx":001C
   ...
   End
End
Attribute VB_Name = "EmrFrpCustDsg"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Rep As New EmrRepCustDsg
...
Private Sub SetGroupSort()
  ...
  GRP_REP.Add "Customer", "CmCd", "", "CmCd", "hCmCd", "Design Code", "", "", "case when (Select PNum from Param where Ptyp = 'USR' and PmCd = '" + Trim(gs_UsrCd) + "')  <= 5 then  CmName else CmCd end"
  'GRP_REP.Add "Customer", "CmCd", "", "CmCd", "hCmCd", "Design Code", "", "", "case when (Select PNum from Param where Ptyp = 'USR' and PmCd = '" + Trim(EmrFrmMDI.TXT_UCD.text) + "')  <= 5 then  CmName else CmCd end"
  GRP_REP.Add "Design Code", "DmCtg+CdOurDmCd", "'('+DmCtg+')'+CdOurDmCd", "CdOurDmCd", "hCdOurDmCd", "Design Ctg", "", "", "DmDesc"
  GRP_REP.Add "Design Ctg", "DmCtg", "", "DmCtg", "hDmCtg", "", "", "", "(Select PDesc from Param where PTyp= 'DMCTG' and PMCd= DmCtg) "
  GRP_REP.Add "Design Size", "CdOurDmSz", "", "CdOurDmSz", "hCdOurDmSz", "", "", "", "(Select PDesc from Param where PTyp= 'DMSZ' and PMCd= CdOurDmSz) "
End Sub
...
'  CmCtg , CmCd, DmCtg, CdOurDmCd, CdOurDmSz, CdOurSfx, CdCustDmCd, CdDesc
'  from CustDsg, CustMst, DsgMst where 1= 2
  '*** Report Sql ***
  ...
  wSqlStrg = "Select " + grpflds + ", " + _
             "CmCtg, CmCd, DmCtg, CdOurDmCd, CdOurDmSz, CdOurSfx, CdCustDmCd, CdDesc " + _
             "from CustDsg join CustMst on CmCtg= CdCtg and CmCd= CdCd " + _
             "join DsgMst on DmTcTyp= 'DM' and DmCd= CdOurDmCd and DmSz= '' " + IIF(gs_Partition = ctCurrPrtn, " And DmPrtKey=CdPrtKey ", "") + _
             "where " + IIF(gs_Partition = ctCurrPrtn, " CdPrtKey='" + ctCurrPrtn + "' And ", "") + " CmCtg= 'C' " + wCnd

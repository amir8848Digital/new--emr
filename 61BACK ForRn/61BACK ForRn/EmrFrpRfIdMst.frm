...
Begin VB.Form EmrFrpRfIdMst 
   ...
   Begin VB.Frame fra_nkeys 
      ...
      Begin TabDlg.SSTab TAB_REP 
         ...
         TabPicture(0)   =   "EmrFrpRfIdMst.frx":0000
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "fra_tabrep(0)"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "&Group Sort"
         TabPicture(1)   =   "EmrFrpRfIdMst.frx":001C
   ...
   End
End
Attribute VB_Name = "EmrFrpRfIdMst"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Rep As New EmrRepRfIdMst
Dim moCn As MwfLib.MDOConnection   '*** (Bef speed) bef 24/11/06
Private Sub SetGroupSort()

GRP_REP.Add "Company Code", "RimBCoCd", "RimBCoCd", "", "", "", "", "", "(Select HName from Head where HCd= '" + ctSelfCmCd + "' and HCoCd=RimBCoCd) "
End Sub
Private Sub adc_setreprecsource()
  ...
  wSqlStrg = "Select " + grpflds + ", " + _
             "RimNo, RimBCoCd, RimBYY, RimBChr, RimBNo, RimDmCd From RfIdMst " + wCnd + _
             "Order By RimNo"
...
Private Sub ADC_Load()
    ...
    Set adc.FirNKeyCtl = adc("UoRimNoFr")
    Call InitProp(Me)

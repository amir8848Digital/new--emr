...
Private Sub ADC_Load()
    ...
    'End If
    '*** Emr2-06
    'VK.28-Parent code visible only RM Rate Listing
    If UCase(adc.MenuCd) = UCase("RepRmRt") Then
      LblRmPrntCd.Visible = True: adc("UoParentCdFr").Visible = True: adc("UoParentCdTo").Visible = True: adc("UoParentCdSel").Visible = True
    End If

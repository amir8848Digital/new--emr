...
'  GRP_REP.Add "Rm Size", "convert(varchar(8),IrRmSz)", "", "IrRmSz", "hRmSz", "", "", "", "convert(varchar(8),IrRmSz)"
  ...
  GRP_REP.Add "Inv Date", "convert(varchar(10), InDt, 112)", "convert(varchar(8), InDt, 3)", "InDt", "hInDt", "", "", "", ""
  ...
  GRP_REP.Add "OrderNo", "IdExpOdTc+IdExpOdYy+IdExpOdChr+str(IdExpOdNo)", "IdExpOdTc+'/'+IdExpOdYy+'/'+IdExpOdChr+'/'+LTrim(Str(IdExpOdNo))", "", "", "", "", "", "'('+convert(varchar(8), OmDt, 5) +'/'+ IdExpCmCd+ '/'+ OmPONo+ ')' "
...
'  Next i
  ...
  'if it is NO stock rate is invisible in report. This logic applies only if ValueAs type is S-Stock Value

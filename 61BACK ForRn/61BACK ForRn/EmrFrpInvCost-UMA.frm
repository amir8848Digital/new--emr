...
'  Dim ws_BaseCurCd As String, wb_InBaseCur As Boolean, ws_CurJoin As String
  ...
  If adc("UoCurCdFr") = "" Then
    ...
    If UCase(adc.MenuCd) = UCase("RepInvCat") Or UCase(adc.MenuCd) = UCase("RepInvCTBCat") Then _
...
'''                   " Else 0 end) "
      ...
      ElseIf UCase(adc("UoInVal")) = "S" Then
        ...
        wIrRmWt = "IrRmAWt"
        ' ***** Manali 3.03 - 29/06/08 - LmeRt
        wIrLmeRt = " (case  max(OdIGldRtEqOrd)  when 'Y' then max(OrLmeSal)  " + _
                   " When 'N' then (case max(IrRmCtg) when 'G' Then max(InLmgSal) when 'P' then max(InLmpSal) when 'S' then max(InLmsSal) when 'L' then max(InLmlSal) Else 0 End) " + _
                   " Else 0 end) "
        wIrRmRt = "IrStkRt"
        wIrSetRt = " (Case when InMulDiv= 'M' then IrSetARt/InCnvFct else IrSetARt*InCnvFct end) "
        wiLRt = " (Case when InMulDiv= 'M' then iLARt/InCnvFct else iLARt*InCnvFct end) "
...
''      Rep.FldLmp.Suppress = False
    ...
    '                  "CrOurRmCd = Max(IrRmCd) and 0 Between CrFrLn and CrToLn)," + _
      ...
      wOurRmCd = " (Case when Max(IrCustRmCd) ='' Then '{'+Max(IrRmCd)+'}' Else Max(Cast(IrCustRmCd as varChar(14))) End) as OrRmCd "        '4.1.0.0
    Else
      wOurRmCd = "Max(IrRmCd) as OrRmCd"
    End If
    '*************************** ZUBIN **************************
    ...
    '                  "'{' + IrRmCd + '}') as OrRmCd"
        wOurRmCd = " (Case when IrCustRmCd ='' Then '{'+IrRmCd+'}' Else Cast(IrCustRmCd as varChar(14)) End) as OrRmCd "
  ...
  '  ' **** Zubin 211 **** '
    ...
    wTblStr = "Select OmCoCd, OmYy, OmTc, OmChr, OmNo, OmCmCd, OmDt, OmPONo,OmPoDt,OmLmgCst,OmLmgSal,OmLmpSal,OmLmsSal,OmLmlSal,OmDelDt,OdDelDt," + _
              ...
              " OdDmCd,Space(40) as CdOurDmCd,OdDmSz,OdSfx,OdDmStkYy, OdDmStkChr, OdDmStkNo, DmCtg,DmSalCtg,DmTcTyp,OdDmCol, 0 as OdTrayNo,OdPicNm,OdPoNo,OdKt as IdKt,DmUom, OdVaCtg as IdVaCtg," + _
              ...
              " CmLkUpMetLs,DmLsCtg,OdMulby,CmName, OdOmCmCd,DmWaxWt,Space(4) as qTag,OrMainMet,0 as qMainMet,Space(1) as qPtrYN,  OrSrNo, OrRmCtg as RmCtg,OrRmSCtg,Space(14) as OrRmCd ,RmQw,OrLn1,OrLn2,OrLn3,PDesc225 as qRmSzDesc,OrRmPtr  , " + _
...
ws_InstrStr = " max(Replace(OdDmPrdInst,char(13)+ char(10),' ')) as OdDmPrdInst, " + _
      ...
      wCommStr = "Select InCoCd as OmCoCd, InYy as OmYy, InTc as OmTc, InChr as OmChr, InNo as OmNo, max(InCmCd) as OmCmCd, " + _
                 ...
                 "max(IdDmCd) as OdDmCd," + wOurDsgCd + ", max(IdDmSz) as OdDmSz, max(IdSfx) as OdSfx, '' as OdDmStkYy, '' as OdDmStkChr, 0 as OdDmStkNo, " + _
                 "max(DmCtg) as DmCtg, max(DmSalCtg) as DmSalCtg, 'DM' as DmTcTyp, Max(OdDmCol) as OdDmCol, max(IdTrayNo) as OdTrayNo, " + _
                 "max(OdPicNm) as OdPicNm, max(OdPoNo) as OdPoNo, max(IdKt) as IdKt, " + _
      ...
      '******Emr206 **********RmWt for ('D','C') is not Converted into grams]
        ...
        wRmStr = " IrSrNo as OrSrNo, max(RmCtg) as RmCtg, max(RmSCtg) as OrRmSCtg,  " + wOurRmCd + ", max(RmQw) As RmQw, max(IrRmSz) as OrLn1, max(IrRmSz2) as OrLn2, max(IrRmSz3) as OrLn3, " + wRmSzDesc + " as qRmSzDesc,  0 as OrRmPtr, " + _
  ...
  '''''               "0 as OrSetSalRt, sum(" + wIrSetVal + ") as OrSetSalVal, sum(" + wIrRmVal + ") as OrSalVal, Space(10) as RmRSzRt,"
        ' ***** Manali 3.03 - 29/06/08 - LmeRt added
        '*** Manali 3.03 - 07/07/08 - RmSzDesc added
        wRmStr = " 0 as OrSrNo, RmCtg, RmSCtg as OrRmSCtg, " + wOurRmCd + ", RmQw, 0 as OrLn1, 0 as OrLn2, 0 as OrLn3, '' as qRmSzDesc,  0 as OrRmPtr, " + _
                 "sum(IrRmQty) as OrQty, sum(" + wIrRmWt + ") as OrWt, " + _
                 "max(" + IIF(wb_InBaseCur, " (Case when InMulDiv= 'M' then " + wIrLmeRt + " /InCnvFct else " + wIrLmeRt + " *InCnvFct end)", wIrLmeRt) + ")  as OrLmeSal, " + _
  ...
  ' **** Zubin 211 **** '
      Case Is = UCase("RmCd")
        ' ***** Manali 3.03 - 29/06/08 - LmeRt added
        '*** Manali 3.03 - 07/07/08 - RmSzDesc added
        wRmStr = " 0 as OrSrNo, RmCtg, RmSCtg as OrRmSCtg, " + wOurRmCd + ", max(RmQw) as RmQw, 0 as OrLn1, 0 as OrLn2, 0 as OrLn3, '' as qRmSzDesc,  0 as OrRmPtr, " + _
      ...
      Case Is = UCase("RmSCtg")
        ' ***** Manali 3.03 - 29/06/08 - LmeRt added
        '*** Manali 3.03 - 07/07/08 - RmSzDesc added
        wRmStr = " 0 as OrSrNo, RmCtg, RmSCtg as OrRmSCtg, '*' as OrRmCd, '*' as RmQw, 0 as OrLn1, 0 as OrLn2, 0 as OrLn3, '' as qRmSzDesc,  0 as OrRmPtr, " + _
                 "sum(IrRmQty) as OrQty, sum(" + wIrRmWt + ") as OrWt, 0.00 as OrLmeSal, 0 as OrSalRt, '' as OrSetSCd, 0 as OrSetSalRt, " + _
                 "sum(" + wIrSetVal + ") as OrSetSalVal, sum(" + wIrRmVal + ") as OrSalVal, Space(10) as RmRSzRt, 0.00 as OrAlySalRt, "
      ...
      Case Is = UCase("RmCtg")
        ' ***** Manali 3.03 - 29/06/08 - LmeRt added
        '*** Manali 3.03 - 07/07/08 - RmSzDesc added
        wRmStr = " 0 as OrSrNo, RmCtg, '*'  as OrRmSCtg, '*' as OrRmCd, '*' as RmQw, 0 as OrLn1, 0 as OrLn2, 0 as OrLn3, '' as qRmSzDesc,  0 as OrRmPtr, " + _
                 "sum(IrRmQty) as OrQty, sum(" + wIrRmWt + ") as OrWt, 0.00 as OrLmeSal, 0 as OrSalRt, '*' as OrSetSCd, 0 as OrSetSalRt, " + _
                 "Sum (" + wIrSetVal + ") as OrSetSalVal, Sum(" + wIrRmVal + ") as OrSalVal, Space(10) as RmRSzRt, 0.00 As OrAlySalRt, "
      ...
      Case Is = UCase("RmRSzRt")
        ' ***** Manali 3.03 - 29/06/08 - LmeRt added
        '*** Manali 3.03 - 07/07/08 - RmSzDesc added
        wRmStr = " 0 as OrSrNo, max(RmCtg) as RmCtg, max(RmSCtg) as OrRmSCtg, " + wOurRmCd + ", max(RmQw) As RmQw, max(IrRmSz) as OrLn1, max(IrRmSz2) as OrLn2, max(IrRmSz3) as OrLn3, " + wRmSzDesc + " as qRmSzDesc,  0 as OrRmPtr, " + _
                 "sum(IrRmQty) as OrQty, sum(" + wIrRmWt + ") as OrWt, " + _
                 "max (" + IIF(wb_InBaseCur, " (Case when InMulDiv = 'M' then " + wIrLmeRt + " /InCnvFct else " + wIrLmeRt + " *InCnvFct end)", wIrLmeRt) + ")  as OrLmeSal, " + _
      ...
      Case Is = UCase("RmSCtgRt")
        wRmStr = " 0 as OrSrNo, max(RmCtg) as RmCtg, max(RmSCtg) as OrRmSCtg, '*' as OrRmCd, max(RmQw) As RmQw, 0 as OrLn1, 0 as OrLn2, 0 as OrLn3, '' as qRmSzDesc,  0 as OrRmPtr, " + _
                 "sum(IrRmQty) as OrQty, sum(" + wIrRmWt + ") as OrWt, " + _
                 "max (" + IIF(wb_InBaseCur, " (Case when InMulDiv = 'M' then " + wIrLmeRt + " /InCnvFct else " + wIrLmeRt + " *InCnvFct end)", wIrLmeRt) + ")  as OrLmeSal, " + _
     ...
     wRmCommStr = wRmCommStr + "From InvHd " + _
               ...
               ws_CurJoin + wCnd + IIF(gs_Partition = ctCurrPrtn, " And InPrtKey='" + ctCurrPrtn + "' ", "") + wRmGrp
      ...
      wLabCommStr = "'2LAB' as qTag, '' as OrMainMet, 0 as qMainMet,'' as qPtrYN, 0 as OrSrNo, '' as RmCtg, '' as OrRmSCtg, " + _
                    ...
                    ws_CurJoin + wCnd + IIF(gs_Partition = ctCurrPrtn, " And InPrtKey='" + ctCurrPrtn + "' ", "") + wLabGrp
...
'      mRep.Subreport2_hHSetQty.Suppress = True
  ' **** Zubin 211 **** '
    ...
    wSqlStrg = "Insert Into TmpA " + _
                 ...
                 "(Select sum(" + wIrRmWt + "/ (case when RmCtg in ('C', 'D') then 5 else 1 end)) " + _
                 ...
                 "and IrYy= IdYy and IrChr= IdChr and IrNo= IdNo and IrSr= IdSr ) as qGrsWt, IdTrayNo as OdTrayNo "
     ...
     wSqlStrg = " Select  " + IIF(adc("UOYN3") = "Y", " OmCoCd,'' as OmYy,OmTc,'' as OmChr,0 as OmNo ", " OmCoCd,OmYy,OmTc,OmChr,OmNo") + ",qRow,Max(OmCmCd) as OmCmCd ,Max(OdOmCmCd) as OdOmCmCd,Max(OmDt) as OmDt,Max(OmPoNo) as OmPoNo, " + _
      ...
      wRmDet = "Select " + IIF(adc("UOYN3") = "Y", " '' as OdYy, IdTc as OdTc, '' as OdChr, 0 as OdNo, IdIdNo as OdSr ", " IdYy as OdYy, IdTc as OdTc, IdChr as OdChr, IdNo as OdNo, IdSr as OdSr") + ", IrMainMet as OrMainMet, " + _
               ...
               "as qTag, RmSCtg as OrRmSCtg," + IIF(adc("UoYN30") = "Y", "(Case When RmIntQly='' Then IrRmCd Else RmIntQly End)", " IrRmCd") + " as OrRmCd, IrRmQty as OrQty, " + wIrRmWt + " as OrWt " + _

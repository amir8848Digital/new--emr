...
Begin VB.Form EmrFrpOrd 
   ...
   Begin VB.Frame fra_nkeys 
      ...
      Begin TabDlg.SSTab TAB_REP 
         ...
         TabPicture(0)   =   "EmrFrpOrd.frx":0000
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "fra_tabrep(0)"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "&Group Sort"
         TabPicture(1)   =   "EmrFrpOrd.frx":001C
         ...
         Begin VB.Frame fra_tabrep 
            ...
            Begin VB.CheckBox ChkBoxArr 
               Alignment       =   1  'Right Justify
               Caption         =   "Show Direct Value instead of Formula"
               BeginProperty Font 
                  Name            =   "Arial"
                  Size            =   9.75
                  Charset         =   0
               ...
               Left            =   4530
               TabIndex        =   70
               Tag             =   "Show Direct Value instead of Formula"
               ToolTipText     =   "Check To Show Direct Value instead of Formula"
               Top             =   7320
               Width           =   2355
            End
            Begin VB.CheckBox ChkBoxArr 
            ...
            Begin VB.CheckBox ChkBoxArr 
               ...
               TabIndex        =   58
               Tag             =   "ShowVchSr"
               ToolTipText     =   "Check To Print Rm Desc"
               Top             =   7800
               Visible         =   0   'False
               Width           =   2040
            End
            ...
            Begin VB.CheckBox ChkBoxArr 
               ...
               TabIndex        =   20
               Tag             =   "FinalSrt"
               ToolTipText     =   "Check To Show Final Sort On Design Code"
               Top             =   2010
               Width           =   2415
            End
            Begin VB.CheckBox ChkBoxArr 
            ...
            Begin MwfCtl.MWCTL_MED atxt 
               ...
               Left            =   1905
               TabIndex        =   46
               ToolTipText     =   "Enter From Prodction Delivery Date"
               Top             =   4860
               Width           =   885
               _ExtentX        =   1561
               _ExtentY        =   503
            ...
            Begin MwfCtl.MWCTL_MED atxt 
               ...
               TabIndex        =   73
               Tag             =   "ShowRmdesc"
               ToolTipText     =   "Show Rm Desc (Yes / No)"
               Top             =   7800
               Visible         =   0   'False
               Width           =   285
               _ExtentX        =   503
            ...
            Begin MwfCtl.MWCTL_MED atxt 
               ...
               Left            =   7320
               TabIndex        =   2
               ToolTipText     =   "Enter Report Heading"
               Top             =   555
               Width           =   4005
               _ExtentX        =   7064
               _ExtentY        =   503
      ...
      Begin VB.Frame FraSc 
         ...
         Begin VB.CheckBox ChkBoxArr 
            ...
            TabIndex        =   177
            Tag             =   "ShowPic"
            ToolTipText     =   "Check To Show Rm Lot No"
            Top             =   3000
            Width           =   3600
         End
         Begin VB.CheckBox ChkBoxArr 
            ...
            TabIndex        =   176
            Tag             =   "ShowPic"
            ToolTipText     =   "Check To Show Wax Wt"
            Top             =   2700
            Width           =   3600
         End
         Begin VB.CheckBox ChkBoxArr 
         ...
         Begin MwfCtl.MWCTL_MED atxt 
            ...
            Left            =   3540
            TabIndex        =   86
            ToolTipText     =   "Show Wax Weight (Yes / No)"
            Top             =   2700
            Visible         =   0   'False
            Width           =   285
            _ExtentX        =   503
         ...
         Begin MwfCtl.MWCTL_MED atxt 
            ...
            Left            =   3540
            TabIndex        =   87
            ToolTipText     =   "Show Rm Lot No (Yes / No)"
            Top             =   3000
            Visible         =   0   'False
            Width           =   285
            _ExtentX        =   503
...
On Error GoTo RepErr
  ...
  '*** Jay 3.3(FG)
    ...
    adc("UoLabGrp") = "SR"
  End If
  If Trim(adc("UoRmGrp")) = "" Or Trim(adc("UoLabGrp")) = "" Then
    adc("UoRmGrp") = "N"
    adc("UoLabGrp") = "N"
'    DispMsg "Rm Detail level and Lab Detail Level cannot be blank", etError
'    Exit Sub
  End If
  '6.1_27 if copy picture option is selected and path is blank then raise error message
  If UCase(adc.MenuCd) = UCase("RepDetOrd") Or UCase(adc.MenuCd) = UCase("RepOrdCat") Then
    If adc("UOYN35") = "Y" And adc("wTarPicPath") = "" Then _
      DispMsg "Picture Path Should Not Be Blank ", etError: Exit Sub
    'if target picture path is not valid then it will raise error
    If adc("UOYN35") = "Y" And adc("wTarPicPath") <> "" Then
...
'  from OrdDsg, OrdRm where 1= 2
  ...
  If UCase(adc("UoTcTypFr")) = "QS" Or UCase(adc("UoTcTypFr")) = "OS" Then
    wDmTcTyp = "SM"
  Else
    wDmTcTyp = "DM"
  End If
  ...
  If adc("UoCurCdFr") = "" Then
    ...
    If UCase(adc.MenuCd) = UCase("RepOrdCat") Or UCase(adc.MenuCd) = UCase("RepJtCat") Then
...
'                  "'{' + Max(OrRmCd) + '}') as OrRmCd"
            '8 cust rmcd size chanegd from 14 to 20
            wOurRmCd = " (Case when Max(OrCustRmCd) ='' Then '{'+Max(OrRmCd)+'}' Else Max(Cast(OrCustRmCd as varChar(20))) End) as OrRmCd "
...
'                  "'{' + Max(OrRmCd) + '}') as OrRmCd"
    ...
    For i = 0 To UBound(wGrpArr1)
      Select Case UCase(wGrpArr1(i))
       ...
       Case Is = "DMCTG"
          ...
          'If UCase(ADC.MenuCd) = UCase("RepDetOrd") Or UCase(ADC.MenuCd) = UCase("RepAvgOrd") Then
          '*** Jay 3.3(FG)
            qDmCtgDesc = " (Select PDesc from Param where PTyp= 'DMCTG' and PMCd= max(DsgMst.DmCtg)) as qDmCtgDesc"
          Else
            qDmCtgDesc = " (Select PDesc from Param where PTyp= 'DMCTG' and PMCd=DsgMst.DmCtg) as qDmCtgDesc"
          End If
      ...
      Case Is = "SALCTG"
        ...
        'If UCase(ADC.MenuCd) = UCase("RepDetOrd") Or UCase(ADC.MenuCd) = UCase("RepAvgOrd") Then
        '*** Jay 3.3(FG)
          qDmSalCtgDesc = " (Select PDesc from Param where PTyp= 'SALCTG' and PMCd= max(DsgMst.DmCtg) and PSCd= max(DsgMst.DmSalCtg)) as qDmSalCtgDesc "
        Else
          qDmSalCtgDesc = " (Select PDesc from Param where PTyp= 'SALCTG' and PMCd= DsgMst.DmCtg and PSCd= DsgMst.DmSalCtg) as qDmSalCtgDesc "
        End If
    ...
    'pg.5 - OdMrp,OdMrpDisc added
    'BnM.3 qBagNo added
    'sv.19 Space(1)added to OrMainMet, OrRmCtg changed as Space(2) for RmCtg,Space(5) as OrRmSCtg,
    'sv.19 Space(16) as OrLotNo,Space(1) as RmQw,Space(8) as OrSetSCd
    'sv.19 Null added to OrSrNo,OrLn1,OrLn2,OrLn3,OrRmPtr,OrLmeSal,OrSalRt,OrSetSalRt,OrSetSalVal,OrSalVal,OrAlySalRt,RmPurityRt
    'sv.19 OrPrdQty changed as Null for OrQty, OrPrdWt changed as Null for OrWt
    'sv.33 OmCmCtg added. GetGldRtLsPer, wCmPurityRt in SetExcel procedure needs CmCtg as a parameter.
    'gs_CmCtg was used there. now going to change gs_CmCtg to OmCmCtg. OmCmCtg not in this select statement.
    'so OmCmCtg not able to use there. so OmCmCtg added here
    '62 qHuidNo added
    '8 OrRmCd size changed from 14 to 20
    '6.1B Subcust added
    wTblStr = "Select OmCoCd, OmYy, OmTc, OmChr, OmNo,OmCmCtg,OmCmCd,OmDt, OmPONo,OmPoDt,OmLmgCst,OmLmgSal,OmLmpSal,OmLmsSal,OmLmlSal,OmDelDt,OdDelDt," + _
              ...
              " OrRmctg, OdDmCol as OdDmCol3,OdGldAs,OdLabAs,OdGldAsWt,OdLabAsWt,OdSalPrc,OdMrp,OdMrpDisc,space(20) as qBagNo,space(30) as qHuidNo," + _
              " OdOrdEnt as qOrdQty, OdSalPrc as qSalVal,OdDmPrdInst, " + _
              " OdCmPrdInst,OdCmStmpInst, OdSalRem, OdSzInst,OmSalRem,OmCmDelTerms, OmCmPayTerms, OmPoNo AS qOdOmPoNo, " + _
              " CmLkUpMetLs,DsgMst.DmLsCtg,OdMulby,CmName, OdOmCmCd, DmWaxWt,Space(4) as qTag,Space(1) as OrMainMet,0 as qMainMet,Space(1) as qPtrYN, Null as OrSrNo, Space(2) as RmCtg,Space(5) as OrRmSCtg,Space(16) as OrLotNo,Space(20) as OrRmCd ,RmDesc, Space(1) as RmQw,Null as OrLn1,Null as OrLn2,Null as OrLn3,Null as OrRmPtr  , " + _
              " Null as OrQty,Null as OrWt,Null as OrLmeSal,Null as OrSalRt,Space(8) as OrSetSCd,Null as OrSetSalRt,Null as OrSetSalVal,Null as OrSalVal,Space(10) as RmRSzRt,Null as OrAlySalRt,Null as RmPurityRt,0 as qRmCtgSr, " + _
      ...
      'sv.33 max(OmCmCtg) as OmCmCtg added
      '62 qHuidNo added
      '578.22 conversion factor added to OdMrp
      '6.1b OdSubCust added
      wCommStr = "Select /* row_Number() over(Partition By OmIdNo Order By OmCoCd,OmTc,OmYy,OmChr,OmNo" + wExcelOrdBy + ",OdSr) as qRow,*/ OmCoCd, OmYy, OmTc, OmChr, OmNo,max(OmCmCtg) as OmCmCtg, max(OmCmCd) as OmCmCd, max(OmDt) as OmDt, MAX(OmPONo) as OmPONo, max(OmPoDt) as OmPoDt, " + _
                 ...
                 "max(OdDmCd) as OdDmCd," + wOurDsgCd + ", max(OdDmSz) as OdDmSz, max(OdSfx) as OdSfx,max(OdDmStkCoCd) as OdDmStkCoCd, max(OdDmStkYy) as OdDmStkYy, max(OdDmStkChr) as OdDmStkChr, max(OdDmStkNo) as OdDmStkNo, " + _
                 "max(DsgMst.DmCtg) as DmCtg, max(DsgMst.DmSalCtg) as DmSalCtg, max(DsgMst.DmTcTyp) as DmTcTyp, max(OdDmCol) as OdDmCol, 0 as OdTrayNo, Max(OdPicNm) as OdPicNm, Max(OdSubCust) as OdSubCust, Max(OdPoNo) as OdPoNo, " + _
                 "max(OdKt) as IdKt, max(DsgMst.DmUom) as DmUom, max(OdVaCtg) as IdVaCtg, " + _
                 ...
                 "Max(OdGldAs) as OdGldAs, Max(OdLabAs) as OdLabAs, max(OdGldAsWt) as OdGldAsWt, max(OdLabAsWt) as OdLabAsWt, max(" + wOdSalPrcOpt + ") as OdSalPrc, " + _
                 "Max(" + IIF(wb_InBaseCur, " (Case when OmMulDiv= 'M' then OdMrp/OmCnvFct else OdMrp*OmCnvFct end) ", "OdMrp") + ") as OdMrp,Max(OdMrpDisc) as OdMrpDisc,max(OdBYy+'/'+OdBChr+'/'+LTrim(str(OdBNo))) as qBagNo, '' as qHuidNo, "
  ...
  '    OdDmPrdInst, OdCmPrdInst, OdCmStmpInst, OdSalRem, OdSzInst, OmSalRem, OmCmDelTerms, OmCmPayTerms,
      ...
      wCommStr = wCommStr + " max(Replace(OdDmPrdInst,char(13)+ char(10),' ')) as OdDmPrdInst, " + _
                            ...
                            " ' ' AS qOdOmPoNo, max(OmLkUpMetLs) as CmLkUpMetLs, max(DsgMst.DmLsCtg) as DmLsCtg, max(OdMulby) as OdMulby, max(CmName) as CmName, max(OdOmCmCd) as OdOmCmCd, " + _
                           " max(isnull(DsgmstForWax.DmWaxWt,DsgMst.DmWaxWt)) as DmWaxWt, "
  ...
  '   *********************************
    ...
    'Manoj 2.10.0
      ...
      Dim wRmDesc As String
      If UCase(adc.MenuCd) = UCase("RepDetOrd") And adc("UoYn29") = "Y" And _
                            (UCase(adc("UoRmGrp")) = "SR" Or UCase(adc("UoRmGrp")) = "RMCDRT" Or _
                             UCase(adc("UoRmGrp")) = "RMCD" Or UCase(adc("UoRmGrp")) = "RMSZRT" Or _
                             UCase(adc("UoRmGrp")) = "RMRSZRT") Then
        wRmDesc = " max(RmPrtDesc) as RmDesc, "
      Else
        wRmDesc = " '' as RmDesc, "
      End If
      Select Case UCase(adc("UoRmGrp"))
      ...
      Case Is = UCase("N") 'OrRmCtg to get RmVal and RmSetVal, No dets r shown
        ' ***** Manali 3.03 - 28/06/08 - OrLmeSal added
        wRmStr = " 0 as OrSrNo, OrRmCtg as RmCtg, '*' as OrRmSCtg,'' as OrLotNo,'*' as OrRmCd, " + wRmDesc + " '*' as RmQw, 0 as OrLn1, " + _
                 "0 as OrLn2, 0 as OrLn3, 0 as OrRmPtr, sum(" + ws_RmQty + ") as OrQty, sum(" + ws_RmWt + ") as OrWt, 0.00 as OrLmeSal, 0.00 as OrSalRt, '*' as OrSetSCd, " + _
      ...
      Case Is = UCase("Sr")
       '*************************** ZUBIN **************************
        ...
        ' Zubin 213 (BaseCur added)
        ' ***** Manali 3.03 - 28/06/08 - OrLmeSal added
        wRmStr = " OrSrNo, max(OrRmCtg) as RmCtg, max(OrRmSCtg) as OrRmSCtg, max(OrLotNo) as OrLotNo, " + wOurRmCd + IIF(Trim(wOurRmCd) <> "", ", ", "") + wRmDesc + _
                 "max(RmQw) As RmQw, max(OrLn1) as OrLn1, " + _
                 "max(OrLn2) as OrLn2, max(OrLn3) as OrLn3, " + _
  ...
  '      wRmStr = " OrSrNo, max(OrRmCtg), max(OrRmSCtg), " + wOurRmCd + ", max(OrLn1), max(OrLn2), " + _
      ...
      Case Is = UCase("RmCdRt")
        ' Zubin 213 (BaseCur added)
        ' ***** Manali 3.03 - 28/06/08 - OrLmeSal added
        wRmStr = " 0 as OrSrNo, OrRmCtg as RmCtg, OrRmSCtg,'' as OrLotNo, " + wOurRmCd + IIF(Trim(wOurRmCd) <> "", ", ", "") + wRmDesc + _
                 " RmQw, 0 as OrLn1, 0 as OrLn2,  0 as OrLn3, 0 as OrRmPtr, " + _
  ...
  '     URmi 2.04-3 Change is  wRtStr has been used to calculate the rates
      ...
      Case Is = UCase("RmSCtg")
        ' ***** Manali 3.03 - 28/06/08 - OrLmeSal added
        wRmStr = " 0 as OrSrNo, OrRmCtg as RmCtg, OrRmSCtg, '' as OrLotNo, '*' as OrRmCd, " + wRmDesc + " '*' As RmQw, 0 as OrLn1, 0 as OrLn2, 0 as OrLn3, 0 as OrRmPtr, " + _
      ...
      Case Is = UCase("RmCtg")
        ' ***** Manali 3.03 - 28/06/08 - OrLmeSal added
        wRmStr = " 0 as OrSrNo, OrRmCtg as RmCtg, '*' as OrRmSCtg, '' as OrLotNo, '*' as OrRmCd, " + wRmDesc + " '*' As RmQw, 0 as OrLn1, 0 as OrLn2, 0 as OrLn3, 0 as OrRmPtr, " + _
                "sum(" + ws_RmQty + ") as OrQty, sum(" + ws_RmWt + ") as OrWt, 0.00 as OrLmeSal, 0.00 as OrSalRt, '*' as OrSetSCd, 0.00 as OrSetSalRt, " + wRmSetValOpt + ", " + wRmValOpt + " as OrSalVal, '' as RmRSzRt, 0.00 as OrAlySalRt, "
        wRmGrp = " group by OmCoCd, OmYy, OmTc, OmChr, OmNo, OdSr, OrRmCtg "
      Case Is = UCase("RmRSzRt")
  '     Code by Shilp Changed by urmi
  '     wRmStr = " 0 as OrSrNo, max(OrRmCtg), max(OrRmSCtg), max(OrRmCd), max(OrLn1), max(OrLn2c), 0 as OrRmPtr, " + _
  ...
  '     urmi 2.04-3
        ' Zubin 213 (BaseCur added)
        ' ***** Manali 3.03 - 28/06/08 - OrLmeSal added
'        wRmStr = " 0 as OrSrNo, OrRmCtg as RmCtg, OrRmSCtg, " + wOurRmCd + IIF(Trim(wOurRmCd) <> "", ", ", "") + wRmDesc + _
                 "max(RmQw) As RmQw, max(OrLn1) as OrLn1, max(OrLn2) as OrLn2, max(OrLn3) as OrLn3, 0 as OrRmPtr, " + _
                 "sum(" + ws_RmQty + ") as   OrQty, sum(" + ws_RmWt + ") as OrWt, " + _
                 IIF(wb_InBaseCur, " (Case when max(OmMulDiv)= 'M' then OrLmeSal/max(OmCnvFct) else OrLmeSal*max(OmCnvFct) end) ", "OrLmeSal") + " as OrLmeSal, " + _
        ...
        wRmStr = " 0 as OrSrNo, OrRmCtg as RmCtg, OrRmSCtg,'' as OrLotNo, " + wOurRmCd + IIF(Trim(wOurRmCd) <> "", ", ", "") + wRmDesc + _
                 ...
                 IIF(wb_InBaseCur, " (Case when max(OmMulDiv)= 'M' then OrLmeSal/max(OmCnvFct) else OrLmeSal*max(OmCnvFct) end) ", "OrLmeSal") + " as OrLmeSal, " + _
                 IIF(wb_InBaseCur, " (Case when max(OmMulDiv)= 'M' then OrSalRt/max(OmCnvFct) else OrSalRt*max(OmCnvFct) end) ", "OrSalRt") + " as OrSalRt, " + _
                 "OrSetSCd , " + IIF(wb_InBaseCur, " (Case when max(OmMulDiv)= 'M' then OrSetSalRt/max(OmCnvFct) else OrSetSalRt*max(OmCnvFct) end) ", "OrSetSalRt") + " as OrSetSalRt, " + wRmSetValOpt + ", " + wRmValOpt + " as OrSalVal, isnull(max(RrRngSz)," + GetRmSzDispFldNm("max(OrLn1)", "max(OrLn2)", "max(OrLn3)") + ") as RmRSzRt, " + _
                 "max(" + IIF(wb_InBaseCur, " (Case when OmMulDiv= 'M' then OrAlySalRt/OmCnvFct else OrAlySalRt*OmCnvFct end) ", "OrAlySalRt") + ") as OrAlySalRt, "
  ...
  '     ??wRmGrp = " group by OmYy, OmTc, OmChr, OmNo, OdSr, OrRmCtg, OrRmSCtg, OrRMCd, RrRngSz, OrSalRt, (OrSetSCd, OrSetSalRt)?????"
      ...
      Case Is = UCase("RmSCtgRt")
        wRmStr = " 0 as OrSrNo, OrRmCtg as RmCtg, OrRmSCtg,'' as OrLotNo, '*' as OrRmCd, " + wRmDesc + " max(RmQw) As RmQw, 0 as OrLn1, 0 as OrLn2, 0 as OrLn3, 0 as OrRmPtr, " + _
                 "sum(" + ws_RmQty + ") as   OrQty, sum(" + ws_RmWt + ") as OrWt, " + _
                 IIF(wb_InBaseCur, " (Case when max(OmMulDiv)= 'M' then OrLmeSal/max(OmCnvFct) else OrLmeSal*max(OmCnvFct) end) ", "OrLmeSal") + " as OrLmeSal, " + _
                 IIF(wb_InBaseCur, " (Case when max(OmMulDiv)= 'M' then OrSalRt/max(OmCnvFct) else OrSalRt*max(OmCnvFct) end) ", "OrSalRt") + " as OrSalRt, " + _
      ...
      ' ***** Manali 3.6.0 - 25/09/09 - New RmGrp Added - RmSCtgRt
      End Select
      'sv.19 left outer join applicable only for JRI and JRO tcs
      Dim wRprJnCnd As String
      wRprJnCnd = IIF(adc("UoOmTcFr") = "JRI" Or adc("UoOmTcFr") = "JRO" Or adc("UoOmTcTo") = "JRI" Or adc("UoOmTcTo") = "JRO", "Left Outer ", "")
   ...
   '******Geeta *****Emr207** RmsCtg StkByPtr 'N' as qPtrYN is included As Underline is Not reqd for Ptr in Order (Reqd in Invoice )
      ...
      'indigo.164 DM replaced with " + wDmTcTyp + " in DsgMstForWax join
      'sv.19 wRprJnCnd added to OrdRm, RmMst join
      'sv.33 gs_CmCtg changed as OmCmCtg
      wRmCommStr = "'1RM' as qTag, Max(OrMainMet) as OrMainMet, (case when max(OrMainMet)= 'Y' or max(OrRmCd)= " + _
               ...
               " join DsgMst on DmIdNo=OdDmIdNo and DmTcTyp='" + wDmTcTyp + "' and DmCd= OdDmCd and DmSz='' " + IIF(gs_Partition = ctCurrPrtn, " and DmPrtKey=OdPrtKey ", "") + " Left Outer Join DsgMst DsgmstForWax On OdDmCd=DsgmstForWax.DmCd And DsgmstForWax.DmTcTyp='" + wDmTcTyp + "' And OdDmSz=DsgmstForWax.DmSz " + IIF(gs_Partition = ctCurrPrtn, " And DsgMstForWax.DmPrtKey=OdPrtKey ", "") + _
               " join CustMst on CmCtg=OmCmCtg and CmCd= OmCmCd " + _
               wRprJnCnd + " join OrdRm on OrOdIdNo=OdIdNo and OrCoCd= OdCoCd and OrTc= OdTc and OrYy= OdYy " + _
               " and OrChr= OdChr and OrNo= OdNo and OrSr= OdSr " + IIF(gs_Partition = ctCurrPrtn, " and OrPrtKey=OdPrtKey ", "") + _
               wRprJnCnd + " Join RmMst On RmCd=OrRmCd " + IIF(gs_Partition = ctCurrPrtn, " and RmPrtKey=OrPrtKey ", "") + _
                ws_BaseRefJoin + _
      ...
      wLabCommStr = "'2LAB' as qTag, '' as OrMainMet, 0 as qMainMet,'' as qPtrYN, 0 as OrSrNo, '' as RmCtg, '' as OrRmSCtg, '' as OrLotNo, " + _
                "'' as OrRmCd, '' as RmDesc, '' as RmQw, 0 as OrLn1, 0 as OrLn2, 0 as OrLn3, 0 as OrRmPtr, 0 as OrQty, 0 as OrWt, 0 as OrLmeSal, 0 as OrSalRt, " + _
                "'' as OrSetSCd, 0 as OrSetSalRt, 0 as OrSetSalVal, 0 as OrSalVal, '' as RmRSzRt, 0 as OrAlySalRt, 0 as RmPurityRt, 10 as qRmCtgSr, " + wLabStr + IIF(Trim(wLabStr) <> "", ", ", "") + _
                "0 as OctSrNo, '' as OctCd , '' as OctSz, '' as OctCtChr, 0 as OctParts,  '' as OctRmCd, '' as OctDmCol, 0 as OctRmWt, " + _
                "'' as OctDc, '' as OctPrdSeq, '' as OctMainPrtYn, '' as OctDesc " + _
                "From OrdMst " + _
  ...
  '*** Jay 2.13(CT) ***
     ...
     If moCn.RecSeek("Select hCompBagsYn from Head where HCd='" + ctSelfCmCd + "' And " + _
        ...
        'indigo.164 DM replaced with " + wDmTcTyp + " in DsgMstForWax join
        wOrdCTCommStr = "'3CT' as qTag, '' as OrMainMet, 0 as qMainMet,'' as qPtrYN, 0 as OrSrNo, '' as RmCtg, '' as OrRmSCtg, '' as OrLotNo, " + _
                "'' as OrRmCd, '' as RmDesc, '' as RmQw, 0 as OrLn1, 0 as OrLn2, 0 as OrLn3, 0 as OrRmPtr, 0 as OrQty, 0 as OrWt,  " + _
                ...
                "join CustMst on CmCtg=OmCmCtg and CmCd= OmCmCd " + _
                "/* The following left outer join added by Murugan as per ticket no. JE.2 dated */ " + _
                "Left Outer Join DsgMst DsgmstForWax On OdDmCd=DsgmstForWax.DmCd And DsgmstForWax.DmTcTyp='" + wDmTcTyp + "' And OdDmSz=DsgmstForWax.DmSz  And DsgMstForWax.DmPrtKey=OdPrtKey " + _
        ...
        If adc("UoYn23") = "Y" Then ws_OrdBy = ws_OrdBy + IIF(ws_OrdBy <> "", ",", "")
      Else
        If adc("UoYn23") = "Y" Then
      ...
      End If
  '*** Jay 2.13(CT) ***
      'sv.19 some fields in TmpA table modified as null. when running report decimal values of that field are getting cut.
      'ie, showing only int value not showing its decimals.
      ' to ignore this issue null values are changed as datatype
      Call AlterNull
  ...
  '           "join CustMst on CmCtg='C' and CmCd= OmCmCd " + wCnd
    ...
    'OdYy, OdTc, OdChr, OdNo, OdSr, DmCtg, qDesc, qOrdQty, qSalVal
      '****** Sachin 3.02 - Id fields in Joins
      ' ***** Manali Trading Module - CmCtg='C' replaced by gs_CmCtg
      'indigo.164 DM replaced with " + wDmTcTyp + " in DsgMst join
      'sv.33 gs_CmCtg changed as OmCmCtg
      wDsgCtgStr = "Select OdYy, OdTc, OdChr, OdNo, OdSr, DmCtg, (Select PDesc from Param where " + _
             "PTyp= 'DMCTG' and PMCd= DmCtg) as qDesc, " + _
             ...
             "DmSz= isnull((Select DmSz from DsgMst where " + IIF(gs_Partition = ctCurrPrtn, " DmPrtKey=OdPrtKey and ", "") + " DmIdNo=OdDmIdNo and DmTcTyp='" + wDmTcTyp + "' " + _
             "and DmCd= OdDmCd and DmSz= OdDmSz), '') " + _
             "join OrdMst on OdOmIdNo=OmIdNo and OdCoCd= OmCoCd and OdTc= OmTc and OdYy= OmYy and OdChr= OmChr and OdNo= OmNo " + IIF(gs_Partition = ctCurrPrtn, " and OdPrtKey=OmPrtKey ", "") + _
             "join CustMst on CmCtg=OmCmCtg and CmCd= OmCmCd " + wCnd + IIF(gs_Partition = ctCurrPrtn, " and OdPrtKey='" + ctCurrPrtn + "' ", "") + _
...
'                 wCnd + IIF(gs_Partition = ctCurrPrtn, " and OmPrtKey='" + ctCurrPrtn + "' ", "") + wCrmCnd
      ...
      wSqlStrg = "Insert Into TmpA " + _
                 ...
                 " row_Number() over(Partition By OmIdNo Order By OmCoCd,OmTc,OmYy,OmChr,OmNo" + wExcelOrdBy + ",OdSr)%3 as qCol,OmCoCd, OmYy, OmTc, OmChr, OmNo, OmCmCd, OdOmCmCd, OmDt, OmPoNo, OdSr ," + wOurDsgCd + ", OdDmCd, OdDmSz, OdSfx, OdDmStkYy, OdDmStkChr, OdDmStkNo, " + _
                 "DmCtg, DmSalCtg, DmTcTyp, OdDmCol, OdPicNm, OdPoNo, OdKt as IdKt, OdVaCtg as IdVaCtg, DmUom ," + _
                 "PNum as IdGldLs" + _
                 "," + qRmCtgDesc + "," + qDmCtgDesc + "," + qDmSalCtgDesc + "," + qDmColDesc + "," + qVaCtgDesc + "," + _
    ...
    wSqlStrg = " Select  OmCoCd,OmYy,OmTc,OmChr,OmNo,qRow,Max(OmCmCd) as OmCmCd ,Max(OmDt) as OmDt,Max(OdOmCmCd) as OdOmCmCd,Max(OmPoNo) as OmPoNo, " + _
      ...
      wSqlStrg = wSqlStrg + "Max((Case when qCol=2 Then   OdSr else 0 End)) as OdSr2,Max((Case when qCol=2 Then   CdOurDmCd else '' End)) as CdOurDmCd2, " + _
                        ...
                        " Max((Case when qCol=2 Then   OdDmStkYy+'/'+OdDmStkChr+'/'+ltrim(str(OdDmStkNo)) else '' End)) as OdDmId2," + _
      ...
      wSqlStrg = wSqlStrg + " Max((Case when qCol=0 Then   OdSr else 0 End)) as OdSr3,Max((Case when qCol=0 Then   CdOurDmCd else '' End)) as CdOurDmCd3, " + _
                            ...
                            " Max((Case when qCol=0 Then   OdDmStkYy+'/'+OdDmStkChr+'/'+ltrim(str(OdDmStkNo)) else '' End)) as OdDmId3," + _
      ...
      wRmDet = "Select OdYy, OdTc, OdChr, OdNo, OdSr, OrMainMet, " + _
               ...
               "as qTag, OrRmSCtg,OrLotNo, " + IIF(adc("UOYN30") = "Y", "(Case When RmIntQly='' Then OrRmCd Else RmIntQly End)", "OrRmCd") + " as OrRmCd, " + ws_RmQty + " as OrQty, " + ws_RmWt + " as OrWt " + _
               "From OrdDsg " + _
               " join OrdMst on OdOmIdNo=OmIdNo and OdCoCd= OmCoCd and OdTc= OmTc and OdYy= OmYy and OdChr= OmChr and OdNo= OmNo " + IIF(gs_Partition = ctCurrPrtn, " and OdPrtKey=OmPrtKey ", "") + _
               " join OrdRm on OrOdIdNo=OdIdNo and OrCoCd= OdCoCd and OrTc= OdTc and OrYy= OdYy and OrChr= OdChr and " + _
    ...
    If (UCase(adc.MenuCd) = UCase("RepDetOrd") Or UCase(adc.MenuCd) = UCase("RepOrdCat")) And adc("UOYN35") = "Y" Then
      ...
      If wRsPicCpy.RecCount > 0 Then
        ...
        Call PicCopy(wRsPicCpy, adc("wTarPicPath"), , adc("UoPMCdFr"))
        MWLib.EndProcess Me
...
'                                       "else Trim (ToText ({rdo.OrLn1}, 3)) "
    ...
    '*** Jay 3.3(FG)
      GRP_REP.SetFormula mRep, "wGrp3", "{rdo.qTag}+ToText({rdo.qMainMet}, '#')+ToText({rdo.OrSrNo}, '##0')+{rdo.RmCtg}+{rdo.OrRmSCtg}"
          ...
          ' ***** Manali Trading Module
          Case Is = "JT"
            mRep.TxtHead.SetText "Detail Costing "
            mRep.TxtVchNo.SetText "Voucher": mRep.TxtVchDt.SetText "Date"
            mRep.TxtPgVchNo.SetText "Voucher": mRep.TxtPgVchDt.SetText "Date"
          ' ***** Manali Trading Module
          'indigo.164 heading added for sketch
          Case Is = "OS"
            mRep.TxtHead.SetText "Detail Order Sketch Printing"
            mRep.TxtVchNo.SetText "Sketch Vch": mRep.TxtVchDt.SetText "Date"
          End Select
      ...
      End If
        ...
        Rep.SecOmRemDet3.Suppress = True
          ...
          Case Is = "FG"
            ...
            mRep.TxtVchNo.SetText "Finish Goods": mRep.TxtVchDt.SetText "Date"
          Case Is = "JT"
            mRep.TxtHead.SetText "Average Costing"
            mRep.TxtVchNo.SetText "Voucher": mRep.TxtVchDt.SetText "Date"
            mRep.TxtPgVchNo.SetText "Voucher": mRep.TxtPgVchDt.SetText "Date"
          'indigo.164 heading added for sketch
          Case Is = "OS"
            mRep.TxtHead.SetText "Average Order Sketch"
            mRep.TxtVchNo.SetText "Sketch Vch": mRep.TxtVchDt.SetText "Date"
          End Select
    ...
    ElseIf UCase(adc.MenuCd) = UCase("RepOrdCat") Or UCase(adc.MenuCd) = UCase("RepFgCat") Or UCase(adc.MenuCd) = UCase("RepJtCat") Then
      ...
      Case Is = "FG"
        ...
        mRep.TxtVchNo.SetText "Finish Goods": mRep.TxtVchDt.SetText "Date"
      Case Is = "JT"
        mRep.TxtHead.SetText "Costing Catalogue"
        mRep.TxtVchNo.SetText "Voucher": mRep.TxtVchDt.SetText "Date"
        mRep.TxtPgVchNo.SetText "Voucher": mRep.TxtPgVchDt.SetText "Date"
      'indigo.164 heading added for sketch
      Case Is = "OS"
        mRep.TxtHead.SetText "Order Sketch Catalogue"
        mRep.TxtVchNo.SetText "Sketch": mRep.TxtVchDt.SetText "Date"
      End Select
   ...
   '  FrLn to Ln kept as dsr was giving error this fld nm not knowm
    ...
    If adc("UoYN31") = "N" And (UCase(adc.MenuCd) = UCase("RepDetOrd") Or UCase(adc.MenuCd) = UCase("RepAvgOrd") _
                              Or UCase(adc.MenuCd) = UCase("RepJtDet") Or UCase(adc.MenuCd) = UCase("RepJtAvg")) Then
      Rep.LblWaxWt.Suppress = True
      Rep.DmWaxWt.Suppress = True    ' ***** Manali 3.6.0 - 31/10/09 - Lab Summary
    Else
      Rep.LblWaxWt.Suppress = False
      Rep.DmWaxWt.Suppress = False   ' ***** Manali 3.6.0 - 31/10/09 - Lab Summary
    End If
    
    If adc("UoYN32") = "Y" And UCase(adc("UoRmGrp")) = UCase("Sr") And (UCase(adc.MenuCd) = UCase("RepDetOrd") _
                              Or UCase(adc.MenuCd) = UCase("RepJtDet")) Then
      Rep.TxtRmLotNo.Suppress = False
      Rep.RmDet1.Suppress = False
      Rep.Line7.Suppress = True
    Else
      Rep.TxtRmLotNo.Suppress = True
      Rep.RmDet1.Suppress = True
      Rep.RmDetLine.Suppress = True
      Rep.Line7.Suppress = False
    End If
    'pg.5- MRp detail will display for detail order printing in Emr & Voucher printing in jEmr
    If adc("UoYN33") = "Y" And (UCase(adc.MenuCd) = UCase("RepDetOrd") Or UCase(adc.MenuCd) = UCase("RepJtDet")) Then
      Rep.TxtMrp.Suppress = False: Rep.OdMrp1.Suppress = False: Rep.OdMrpDisc1.Suppress = False
    Else
      Rep.TxtMrp.Suppress = True: Rep.OdMrp1.Suppress = True: Rep.OdMrpDisc1.Suppress = True
      
    End If
    'pg.5- ExpOrNo will display at right side,ExpOrNo in center will disbale for Voucher printing in jEmr
    If UCase(adc.MenuCd) = UCase("RepJtDet") Then
      Rep.LblExpOdNo.Suppress = True: Rep.TxtExpOdNo.Suppress = True: Rep.TxtExpOdNoColon.Suppress = True
    End If
    
    If UCase(adc.MenuCd) <> UCase("RepJtDet") Then
      GRP_REP.SetFormula mRep, "wExpOdNo", ""
      Rep.LblExpOdNo.Suppress = True: Rep.TxtExpOdNoColon.Suppress = True
    End If
...
'    Rep.FldRunSr.Suppress = True
    ...
    If adc("UoRepHead") <> "" And (UCase(adc.MenuCd) = UCase("RepDetOrd") Or UCase(adc.MenuCd) = UCase("RepAvgOrd") Or _
      UCase(adc.MenuCd) = UCase("RepJtDet") Or UCase(adc.MenuCd) = UCase("RepJtAvg")) Then
        mRep.TxtHead.SetText adc("UoRepHead")
    End If
    
    'BnM.3- if SHow Bag/StkId option is selected then will display Bag / stk id detials
    If adc("UoYN34") = "Y" Then
      'BnM.3- stock id details will display for jEmr Detail and Average costing reports
      If (UCase(adc.MenuCd) = UCase("RepJtDet") Or UCase(adc.MenuCd) = UCase("RepJtAvg")) Then
        Rep.wStkId1.Suppress = False: Rep.wBagNo1.Suppress = True
        Rep.wStkId2.Suppress = False: Rep.wBagNo2.Suppress = True
        'DmStkNum will not show twice if SHow Bag/StkId option is selected, StkNum in detail section is suppressed
        Rep.OdDmStkCoCd1.Suppress = True: Rep.OdDmStkYy1.Suppress = True
        Rep.OdDmStkChr1.Suppress = True:  Rep.OdDmStkNo1.Suppress = True
      Else
        'BnM.3- Bag details will display for Emr Detail and Average Order/Fg printing reports
    ...
    End If
    '62 Huid no details suppressed
    Rep.TxtHUIDNo.Suppress = True:  Rep.qHuidNo1.Suppress = True
...
RepErr:
  ...
  If adc("UOYN35") = "Y" And adc("wTarPicPath") <> "" And Err.Number = 53 Then _
...
With ChkBoxArr(Index)
  ...
  Case Is = 1     'mw.141 Tag = "Show Direct Value instead of Formula"
    If .Value = Checked Then
      'when Show excel option is selected then Show direct value option can be selected
      'else cannot select show direct value option
      If adc("UoYN23") = "Y" Then
        adc("wShowDirectValYN") = "Y"
      Else
        .Value = Unchecked: adc("wShowDirectValYN") = "N": DispMsg "Cannot Select Show Direct Value Option When Show Excel Report is not Selected", etError: Exit Sub
      End If
    Else
      adc("wShowDirectValYN") = "N"
    End If
  ...
  Case Is = 29          'Tag = "ShowRmDesc"    ' 4.1.2
  ...
  Case Is = 31          'Tag = "ShowWaxWt"    ' 4.1.2
    If .Value = Checked Then adc("UoYN31") = "Y" Else adc("UoYN31") = "N"
  Case Is = 32          'Tag = "ShowRmLotNo"    ' 4.1.2
    If .Value = Checked Then adc("UoYN32") = "Y" Else adc("UoYN32") = "N"
  Case Is = 33          'Tag = "ShowMRP"
    If .Value = Checked Then adc("UoYN33") = "Y" Else adc("UoYN33") = "N"
  'BnM.3 UoYN34 will store YN value as per check box Show Bag/StkId is selected
  Case Is = 34          'Tag = "ShowBagStkId"
    If .Value = Checked Then adc("UoYN34") = "Y" Else adc("UoYN34") = "N"
  Case Is = 35          '6.1_27
    If .Value = Checked Then adc("UoYN35") = "Y" Else adc("UoYN35") = "N"
End Select
End With
End Sub
...
Private Sub ADC_Load()
    ...
    '*** Jay 3.3(FG)
      ...
      '*** Jay 2.13(CT) ***
        ...
        ChkBoxArr(29).Enabled = True: ChkBoxArr(29).Visible = True
      '*** Jay 2.13(CT) ***
      End If
      '*** Jay 3.3(FG)
      ...
      'pg.5-Show MRP in scope will not show for FG detail printing
      If UCase(adc.MenuCd) = UCase("RepFgDet") Then ChkBoxArr(33).Enabled = False: ChkBoxArr(33).Visible = False
    ...
    '*** Jay 3.3(FG)
      ...
      ChkBoxArr(1).Enabled = False: ChkBoxArr(1).Visible = False  'mw.141 Show Direct value option not visible
      ChkBoxArr(24).Enabled = False: ChkBoxArr(24).Visible = False    ' **** Manali 3.6.1 - Sr in Catalogue
      'pg.5-Show MRP in scope will not show for Average printing reports
      ChkBoxArr(33).Enabled = False: ChkBoxArr(33).Visible = False
    '*** Jay 3.3(FG)
    ElseIf UCase(adc.MenuCd) = UCase("RepOrdCat") Or UCase(adc.MenuCd) = UCase("RepFgCat") Or UCase(adc.MenuCd) = UCase("RepJtCat") Then
    'ElseIf UCase(ADC.MenuCd) = UCase("RepOrdCat") Then
    '*** Jay 3.3(FG)
      ...
      'pg.5-Show MRP in scope will not show for calelog reports
      ChkBoxArr(33).Enabled = False: ChkBoxArr(33).Visible = False
      'BnM.3 -Show Bag/StkId option in scope will not show for calelog reports
      ChkBoxArr(34).Enabled = False: ChkBoxArr(34).Visible = False
    ...
    If UCase(adc.MenuCd) = UCase("RepOrdCat") Or UCase(adc.MenuCd) = UCase("RepJtCat") Or UCase(adc.MenuCd) = UCase("RepFgCat") Or _
        UCase(adc.MenuCd) = UCase("RepFgAvg") Or UCase(adc.MenuCd) = UCase("RepFgDet") Then
    
        adc("UoYN31").Visible = False: adc("UoYN31").Enabled = False:
        ChkBoxArr(31).Enabled = False: ChkBoxArr(31).Visible = False
        LblRepHead.Visible = False
        adc("UoRepHead").Visible = False: adc("UoRepHead").Enabled = False:
    
    End If
    
    If UCase(adc.MenuCd) = UCase("RepAvgOrd") Or UCase(adc.MenuCd) = UCase("RepOrdCat") Or _
        UCase(adc.MenuCd) = UCase("RepJtAvg") Or UCase(adc.MenuCd) = UCase("RepJtCat") Or _
        UCase(adc.MenuCd) = UCase("RepFgCat") Or UCase(adc.MenuCd) = UCase("RepFgAvg") Or UCase(adc.MenuCd) = UCase("RepFgDet") Then
    
        adc("UoYN32").Visible = False: adc("UoYN32").Enabled = False:
        ChkBoxArr(32).Enabled = False: ChkBoxArr(32).Visible = False
        
    End If
    
    ' ***** Manali 3.6.0 - Order Printing in Excel Format Module
    If moCn.RecSeek("Select 'x' from Head Where HCoCd='" + ctSelfCoCd + "' and HCd='" + ctSelfCmCd + "' and HOrdExcelRepYn<>'Y' ") Then
      ChkBoxArr(23).Visible = False: ChkBoxArr(23).Enabled = False
      ChkBoxArr(1).Enabled = False: ChkBoxArr(1).Visible = False  'mw.141 Show Direct value option not visible
    End If
    '6.1_27 copy picture option and pic path will not visible except detail order and catalogue report
    If UCase(adc.MenuCd) <> UCase("RepDetOrd") And UCase(adc.MenuCd) <> UCase("RepOrdCat") Then
      adc("wTarPicPath").Visible = False: LblPicPath.Visible = False
      ChkBoxArr(35).Enabled = False: ChkBoxArr(35).Visible = False
    End If
...
' *** Jay 2.14Next ***  [Show Rm Value]
  ...
  '6.1B-26 checking valid customer for the user
  Case Is = UCase("UOCMCDFR"), UCase("UOCMCDTO")
    Dim wValidCmCd As String, wCmCdSel() As String
    If UCase(adc.MenuCd) = UCase("RepAvgOrd") Or UCase(adc.MenuCd) = UCase("RepDetOrd") Or UCase(adc.MenuCd) = UCase("RepOrdCat") Then
      If pv_NewValue <> "" Then
        wValidCmCd = moCn.GetFldVal("Select PDesc225 from Param where PTyp= 'USRCMCD' and PMCd= '" + Trim(adc.UsrCd) + "'")
        If wValidCmCd = "" Then Exit Sub
        
        If InStr(1, "," + wValidCmCd + ",", "," + pv_NewValue + ",") = 0 Then _
          Cancel = True: ErrMsg = "User Does Not Have Access to This Customer ": Exit Sub
      End If
    End If
  End Select
...
'    End If
  ...
  End Select
  'indigo.164 sketch design tctype added
  If UCase(adc("UoTcTypFr")) = "QS" Or UCase(adc("UoTcTypFr")) = "OS" Then
    gs_DmTcTyp = "SM"
  Else
    gs_DmTcTyp = "DM"
...
Private Sub ADC_NonKeyWhen(pr_Cancel As Boolean, pr_ErrMsg As String)
 ...
 '*******************************
  ...
  If adc("UoYN30") = "" Then adc("UoYN30") = "N"
'  If adc("UoYn29") = "" Then adc("UoYn29") = "N"
    adc("UoYn29") = "N"
  If adc("UoYN31") = "" Then adc("UoYN31") = "N"
  If adc("UoYN32") = "" Then adc("UoYN32") = "N"
  If adc("UoYN33") = "" Then adc("UoYN33") = "N"  'MRP
  If adc("UoYN35") = "" Then adc("UoYN35") = "N"  '6.1_27
  ...
  If adc("UoYN30") = "Y" Then ChkBoxArr(30).Value = Checked Else ChkBoxArr(30).Value = Unchecked
  If adc("UoYn29") = "Y" Then ChkBoxArr(29).Value = Checked Else ChkBoxArr(29).Value = Unchecked
  If adc("UoYn31") = "Y" Then ChkBoxArr(31).Value = Checked Else ChkBoxArr(31).Value = Unchecked
  If adc("UoYn32") = "Y" Then ChkBoxArr(32).Value = Checked Else ChkBoxArr(32).Value = Unchecked
  If adc("UoYn33") = "Y" Then ChkBoxArr(33).Value = Checked Else ChkBoxArr(33).Value = Unchecked  'mrp
  'BnM.3 check box Show Bag/StkId show value from UsrOpt
  If adc("UoYn34") = "Y" Then ChkBoxArr(34).Value = Checked Else ChkBoxArr(34).Value = Unchecked
  'mw.141 default value=No for Show direct value instead of formula
  adc("wShowDirectValYN") = "N":  ChkBoxArr(1).Value = Unchecked
  ' ****** Manali 3.5.0 - 19/11/08 - Check Boxes added
  If adc("UoYn35") = "Y" Then ChkBoxArr(35).Value = Checked Else ChkBoxArr(35).Value = Unchecked  '6.1_27
  'adc("UoPMCdFr") = "3D"
...
'      mRep.wCoCd.SetText "ABCD"
  ...
  If moCn.RecSeek("Select 'x' From Head Where HCoCd='" + gs_CoCd + "' and HCd='" + ctSelfCmCd + "' and HShowRepLogo='Y' ") Then
    mRep.RHMain.UnderlaySection = True
'    mRep.wCoCd.Suppress = True
    If UCase(adc.MenuCd) = UCase("RepJtDet") Or UCase(adc.MenuCd) = UCase("RepJtAvg") Then
...
Dim wFormulaForRmRt As String, wFormulaForRmVal As String, wFormulaForSetVal As String, wFormulaForLabVal As String
      ...
      If wOdRow <= 285 Then
        ...
        If !OdSr <> wOdSr Then
          ...
          If adc("UoYn") = "Y" Then
            ...
            'indigo.164 UCase(ADC("UoTcTypFr")) = "OS" added
            wPictPath = GetPictPath(IIF(UCase(adc("UoTcTypFr")) = "QS" Or UCase(adc("UoTcTypFr")) = "OS", "SM", "DM"), IIF(UCase(adc("UoPMCdFr")) = "3D", False, True), !OdDmCd, !OdDmSz, !OmCoCd, !OmTc, !OmYy, !OmChr, !OmNo, !OdSr, !OdPicNm)
            If wPictPath = "" Or Dir(wPictPath) = "" Then
              'indigo.164 UCase(ADC("UoTcTypFr")) = "OS" added
              wPictPath = GetPictPath(IIF(UCase(adc("UoTcTypFr")) = "QS" Or UCase(adc("UoTcTypFr")) = "OS", "SM", "DM"), IIF(UCase(adc("UoPMCdFr")) = "3D", True, False), !OdDmCd, !OdDmSz, !OmCoCd, !OmTc, !OmYy, !OmChr, !OmNo, !OdSr, !OdPicNm)
            End If
          ...
          If !qTag = "1RM" Then
            ...
            Case Is = "G", "P", "S", "L", "M"
              ...
              'If wOrMRow <= 21 Then
                ...
                Dim wVchCur As String, wGldLsPer  As Single, wOrRmCd As String
                wVchCur = moCn.GetFldVal("Select OmCmCurCd from OrdMst where OmCoCd='" + !OmCoCd + "' and OmTc='" + !OmTc + "' and OmYy='" + !OmYy + "' and OmChr='" + !OmChr + "' and OmNo=" + CStr(!OmNo))
                
                'indigo.162- calling GetLsPer function and getting Ls % from there.
                'first Ls calculation was in GetGldRt function. now that part cut and added in a new function GetGldRtLsPer
                'sv.33 gs_CmCtg changed as OmCmCtg
                wMetLs = GetGldRtLsPer(!RmCtg, !OmCmCtg, !OmCmCd, !OdDmCd, !IdKt, !DmCtg, !DmLsCtg, "RrSalRt", wVchCur, !CmLkUpMetLs)
                ...
                End If
                'sv.33 gs_CmCtg changed as OmCmCtg
                wCmPurityRt = moCn.GetFldVal("Select RrSalRt from RmRt Where RrTcTyp='CRP' and RrCmCtg='" + !OmCmCtg + "' and RrCmCd='" + !OmCmCd + "' and RrCd='" + !OrRmCd + "' ")
                wCmPurityRt = IIF(wCmPurityRt = 0, !RmPurityRt, wCmPurityRt)
                
                If Not (!RmCtg = "M") Then
                  'mw.141 existing formula assigned to a variable.
                  'if show direct value is yes then getting sale rate directly else getting value from formula
                  'IF statement of ShowDirectValueYN added to show the entire formula in excel sheet
                  wFormulaForRmRt = "(H" + CStr(wCurrRow) + "/" + CStr(wGmFactor) + "*" + CStr(wCmPurityRt) + "*(1 + " + CStr(wMetLs) + "/100)) + " + _
                                                "((1-" + CStr(wCmPurityRt) + ")*" + CStr(!OrAlySalRt) + ")"
                  
                  oSheet.Cells(wCurrRow, 9).formula = "=IF(""" + adc("wShowDirectValYN") + """=""Y""," + CStr(!OrSalRt) + "," + wFormulaForRmRt + ")"
                Else
                ...
                If Not (!RmCtg = "M") Then
                  'mw.141 existing formula assigned to a variable.
                  'if show direct value is yes then getting sale value directly else getting value from formula
                  'IF statement of ShowDirectValueYN added to show the entire formula in excel sheet
                  wFormulaForRmVal = "$I" + CStr(wCurrRow) + "*(IF($G" + CStr(wCurrRow) + "=""Q"",$E" + CStr(wCurrRow) + ",(IF($G" + CStr(wCurrRow) + "=""W""," + wGldAsWt + ",0))))"
                  
                  oSheet.Cells(wCurrRow, 10).formula = "=IF(""" + adc("wShowDirectValYN") + """=""Y""," + CStr(!OrSalVal) + "," + wFormulaForRmVal + ")"
                Else
                  oSheet.Cells(wCurrRow, 10) = !OrSalVal
                End If
...
'              If wOrDCRow <= 40 Then
                ...
                oSheet.Cells(wCurrRow, 3) = !OrRmSCtg
                oSheet.Cells(wCurrRow, 4) = !OrRmCd
                oSheet.Cells(wCurrRow, 5) = CStr(!OrLn1) + "*" + CStr(!OrLn2) + "*" + CStr(!OrLn3)
                ...
                'if show direct value is yes then getting sale value directly else getting value from formula
                'IF statement of ShowDirectValueYN added to show the entire formula in excel sheet
                wFormulaForRmVal = "$J" + CStr(wCurrRow) + "*(IF($I" + CStr(wCurrRow) + "=""Q"",$G" + CStr(wCurrRow) + ",(IF($I" + CStr(wCurrRow) + "=""W"",$H" + CStr(wCurrRow) + ",0))))"
                oSheet.Cells(wCurrRow, 11).formula = "=IF(""" + adc("wShowDirectValYN") + """=""Y""," + CStr(!OrSalVal) + "," + wFormulaForRmVal + ")"
                oSheet.Cells(wCurrRow, 11).Font.Color = vbBlack
                oSheet.Cells(wCurrRow, 12) = !OrSetSCd
                oSheet.Cells(wCurrRow, 13) = !OrSetSalRt
                'mw.141 existing formula assigned to a variable.
                'if show direct value is yes then getting set value directly else getting value from formula
                'IF statement of ShowDirectValueYN added to show the entire formula in excel sheet
                wFormulaForSetVal = "$M" + CStr(wCurrRow) + "*$G" + CStr(wCurrRow) + ""
                oSheet.Cells(wCurrRow, 14).formula = "=IF(""" + adc("wShowDirectValYN") + """=""Y""," + CStr(!OrSetSalVal) + "," + wFormulaForSetVal + ")"
...
'              If wOrXRow <= 48 Then
                ...
                'if show direct value is yes then getting sale value directly else getting value from formula
                'IF statement of ShowDirectValueYN added to show the entire formula in excel sheet
                wFormulaForRmVal = "$H" + CStr(wCurrRow) + "*(IF($G" + CStr(wCurrRow) + "=""Q"",$E" + CStr(wCurrRow) + ",(IF($G" + CStr(wCurrRow) + "=""W"",$F" + CStr(wCurrRow) + ",0))))"
                oSheet.Cells(wCurrRow, 9).formula = "=IF(""" + adc("wShowDirectValYN") + """=""Y""," + CStr(!OrSalVal) + "," + wFormulaForRmVal + ")"
...
'              If wOlRow <= 57 Then
                ...
                'mw.141 existing formula assigned to a variable.
                'if show direct value is yes then getting Lab value directly else getting value from formula
                'IF statement of ShowDirectValueYN added to show the entire formula in excel sheet
                wFormulaForLabVal = "IF($F" + CStr(wCurrRow) + " * (IF($D" + CStr(wCurrRow) + "=""Q"",$E" + CStr(wCurrRow) + ",(IF($D" + CStr(wCurrRow) + "=""W"",$E$" + CStr(wOlFRow - 2) + ",0))))=" + IIF(!OlQw = "Q", CStr(!OlQty), CStr(!OdLabAsWt)) + "*" + CStr(!OlSalRt) + "," + _
                          CStr(!OlSalVal) + ", $F" + CStr(wCurrRow) + " * (IF($D" + CStr(wCurrRow) + "=""Q"",$E" + CStr(wCurrRow) + ",(IF($D" + CStr(wCurrRow) + "=""W"",$E$" + CStr(wOlFRow - 2) + ",0)))))"
                          
                oSheet.Cells(wCurrRow, 7).formula = "=IF(""" + adc("wShowDirectValYN") + """=""Y""," + CStr(!OlSalVal) + "," + wFormulaForLabVal + ")"
...
'              End If
  ...
  '6.1_27 if records exists then starts picture copy
  If (UCase(adc.MenuCd) = UCase("RepDetOrd") Or UCase(adc.MenuCd) = UCase("RepOrdCat")) And adc("UOYN35") = "Y" Then
    If pv_rsOrd.RecCount > 0 Then
      MWLib.BeginProcess Me, "Starting Picture Copy"
      Call PicCopy(pv_rsOrd, adc("wTarPicPath"), , adc("UoPMCdFr"))
      MWLib.EndProcess Me
      MsgBox "Picture Copy Completed"
    End If
  End If
...
'  End If
  ...
  MsgBox "Excel Report Generated Successfully !!"
          ...
          If !qTag = "1RM" Then
            ...
            Case Is = "D", "C"
              If wOrDCRow <= 40 Then
                ...
                oSheet.Cells(wOrDCRow, 3) = !OrRmSCtg
                oSheet.Cells(wOrDCRow, 4) = !OrRmCd
                oSheet.Cells(wOrDCRow, 5) = CStr(!OrLn1) + "*" + CStr(!OrLn2) + "*" + CStr(!OrLn3)
'                oSheet.Cells(wOrDCRow, 5) = !OrLn1
                oSheet.Cells(wOrDCRow, 6) = !OrRmPtr
                oSheet.Cells(wOrDCRow, 7) = !OrQty
                oSheet.Cells(wOrDCRow, 8) = !OrWt
...
errDeletingFile:
  ...
  End If
End Function
Private Sub AlterNull()
'sv.19 it alter datatype of TmpA table fields which are already having null value
  moCn.Execute ("Alter table TmpA alter column OrWt float Null")
  moCn.Execute ("Alter table TmpA alter column OrQty int Null")
  moCn.Execute ("Alter table TmpA alter column OrSrNo int Null")
  moCn.Execute ("Alter table TmpA alter column OrLn1 float Null")
  moCn.Execute ("Alter table TmpA alter column OrLn2 float Null")
  moCn.Execute ("Alter table TmpA alter column OrLn3 float Null")
  moCn.Execute ("Alter table TmpA alter column OrRmPtr float Null")
  moCn.Execute ("Alter table TmpA alter column OrLmeSal float Null")
  moCn.Execute ("Alter table TmpA alter column OrSalRt float Null")
  moCn.Execute ("Alter table TmpA alter column OrSetSalRt float Null")
  moCn.Execute ("Alter table TmpA alter column OrSetSalVal float Null")
  moCn.Execute ("Alter table TmpA alter column OrSalVal float Null")
  moCn.Execute ("Alter table TmpA alter column OrAlySalRt float Null")
  moCn.Execute ("Alter table TmpA alter column RmPurityRt float Null")
